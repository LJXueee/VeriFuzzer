// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1956\sampleModel1956_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1956_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_15_out3;  // uint8
  ...
  assign cfblk138_reg_next[0] = Mysubsystem_15_out3;
  ...
  DotProduct_block u_cfblk18_inst (.in1(cfblk118_out1),  // uint8
                                   .in2(cfblk23_out1),  // uint8
                                   .out1(cfblk18_out1)  // uint8
                                   );

  assign cfblk103_out1 = cfblk18_out1 - cfblk130_out1;
  ...
  assign cfblk134_reg_next[0] = cfblk103_out1;
  ...
  assign cfblk143_reg_next[0] = Mysubsystem_21_out1;
  assign cfblk143_reg_next[1] = cfblk143_reg[0];



  DotProduct u_cfblk113_inst (.in1(cfblk143_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk45_out1;



  assign cfblk38_out1 = dtc_out_10;
  ...
  assign cfblk81_out1 = dtc_out_11;



  assign dtc_out_12 = cfblk81_out1;



  assign cfblk121_out1 = dtc_out_12;
  ...
  assign cfblk133_reg_next[0] = Mysubsystem_15_out2;
  ...
  Mysubsystem_15 u_Mysubsystem_15 (.In1(cfblk10_out1),  // uint8
                                   .In2(cfblk105_out1),  // uint8
                                   .In3(cfblk25_out1),  // uint8
                                   .In4(cfblk109_out1),  // uint8
                                   .cfblk125(Mysubsystem_15_out1),  // uint8
                                   .Out2(Mysubsystem_15_out2),  // uint8
                                   .Out3(Mysubsystem_15_out3)  // uint8
                                   );

  assign cfblk125 = Mysubsystem_15_out1;
