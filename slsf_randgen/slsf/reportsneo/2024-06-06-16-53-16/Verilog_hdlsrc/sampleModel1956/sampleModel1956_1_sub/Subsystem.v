// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1956\sampleModel1956_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1956_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk9_out1 = cfblk127_out1[7:0];
  ...
  assign cfblk59_out1 = cfblk9_out1 + cfblk128_out1;
  ...
  cfblk1 u_cfblk1 (.u(Mysubsystem_12_out1),  // uint8
                   .y(cfblk1_out1)  // uint8
                   );
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk10_out1),  // uint8
                                   .In2(cfblk105_out1),  // uint8
                                   .In3(cfblk61_out1),  // uint8
                                   .In4(cfblk25_out1),  // uint8
  ...
  assign cfblk133_reg_next[0] = Mysubsystem_28_out1;
  ...
  assign dtc_out_11 = cfblk27_out1;



  assign cfblk105_out1 = dtc_out_11;



  assign dtc_out_12 = cfblk105_out1;
