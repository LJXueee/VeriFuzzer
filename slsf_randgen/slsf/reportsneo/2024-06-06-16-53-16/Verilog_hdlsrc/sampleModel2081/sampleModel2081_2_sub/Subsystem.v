// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2081\sampleModel2081_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2081_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_25_out1;  // ufix8_En7
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.In1(cfblk98_out1),  // uint8
  ...
  assign cfblk142_reg_next[0] = Mysubsystem_30_out1;
  ...
  Mysubsystem_38 u_Mysubsystem_38 (.In1(cfblk69_out1),  // uint8
  ...
  assign cfblk138_reg_next[0] = Mysubsystem_38_out1;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.u(cfblk76_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // ufix8_En7
                                   );

  Mysubsystem_39 u_Mysubsystem_39 (.In1(cfblk64_out1),  // uint8
                                   .Out1(Mysubsystem_39_out1)  // uint8
                                   );

  Mysubsystem_11 u_Mysubsystem_11 (.In1(Mysubsystem_25_out1),  // ufix8_En7
                                   .In2(Mysubsystem_39_out1),  // uint8
                                   .cfblk129(Mysubsystem_11_out1)  // uint8
                                   );

  assign cfblk129 = Mysubsystem_11_out1;
