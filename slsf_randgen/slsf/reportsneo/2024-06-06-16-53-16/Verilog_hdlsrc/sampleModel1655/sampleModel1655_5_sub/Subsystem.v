// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1655\sampleModel1655_5_sub\Subsystem.v
// Created: 2024-08-13 09:49:32
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1655_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_1_out1;  // ufix64
  real Mysubsystem_1_out1_double;  // double
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.clk(clk),
                                 .reset(reset),
                                 .enb(clk_enable),
                                 .In1(Mysubsystem_1_out1),  // double
                                 .Out1(Mysubsystem_1_out1)  // double
                                 );

  always @* Mysubsystem_1_out1_double = $bitstoreal(Mysubsystem_1_out1);

  assign switch_compare_1 = Mysubsystem_1_out1_double >= 0.0;
  ...
  assign cfblk95_add_cast_1 = {16'b0, Mysubsystem_31_out1};
  ...
  assign cfblk85_sub_cast_1 = {16'b0, Mysubsystem_31_out1};
