// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1655\sampleModel1655_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1655_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_30_out1;  // ufix64
  real Mysubsystem_30_out1_double;  // double
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_30_out1),  // double
                                   .Out1(Mysubsystem_30_out1)  // double
                                   );

  always @* Mysubsystem_30_out1_double = $bitstoreal(Mysubsystem_30_out1);

  assign switch_compare_1 = Mysubsystem_30_out1_double >= 0.0;
  ...
  assign cfblk85_sub_cast_1 = {16'b0, Mysubsystem_39_out1};
  ...
  assign cfblk95_add_cast_1 = {16'b0, Mysubsystem_39_out1};
