// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1655\sampleModel1655_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1655_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_32_out2;  // ufix64
  real Mysubsystem_32_out2_double;  // double
  ...
  wire [7:0] Mysubsystem_21_out2;  // uint8
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out2(Mysubsystem_32_out2)  // double
                                   );

  always @* Mysubsystem_32_out2_double = $bitstoreal(Mysubsystem_32_out2);

  assign switch_compare_1 = Mysubsystem_32_out2_double >= 0.0;
  ...
  assign dtc_out_1 = cfblk124_out1;
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.In1(cfblk55_out1),  // uint8
                                   ...
                                   .Out2(Mysubsystem_21_out2)  // uint8
                                   );
  ...
  assign cfblk161_reg_next[0] = Mysubsystem_21_out2;
