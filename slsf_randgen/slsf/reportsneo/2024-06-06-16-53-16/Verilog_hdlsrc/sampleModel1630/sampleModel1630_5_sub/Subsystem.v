// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1630\sampleModel1630_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1630_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk46_out1 = (Mysubsystem_40_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  Mysubsystem_43 u_Mysubsystem_43 (.In1(cfblk105_out1),  // uint8
                                   .Out1(Mysubsystem_43_out1)  // uint8
                                   );

  Mysubsystem_6 u_Mysubsystem_6 (.In1(Mysubsystem_43_out1),  // uint8
  ...
  assign cfblk152_reg_next[0] = Mysubsystem_6_out1;
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk104_out1),  // uint8
                                   .y(Mysubsystem_39_out1)
                                   );

  Mysubsystem_30 u_Mysubsystem_30 (.In1(Mysubsystem_39_out1),
                                   .Out1(Mysubsystem_30_out1)  // uint8
                                   );

  assign cfblk60_out1 = Mysubsystem_30_out1 + cfblk60_const_val_1;
