// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1590\sampleModel1590_5_sub\Subsystem.v
// Created: 2024-08-13 00:50:05
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1590_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk119_out1 = cfblk140_out1 - cfblk191_out1;
  ...
  assign cfblk79_out1 = cfblk191_out1 - cfblk168_out1;
  ...
  assign dtc_out_4 = cfblk191_out1;
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.clk(clk),
                                   ...
                                   .Y(Mysubsystem_19_out1)
                                   );

  assign cfblk191_out1 = {7'b0, Mysubsystem_19_out1};



  DotProduct_block u_cfblk126_inst (.in1(cfblk191_out1),  // uint8
  ...
  always @(Mysubsystem_38_out1, cfblk67_out1) begin
    ...
    if (Mysubsystem_38_out1 == 8'b00000000) begin
      ...
      cfblk140_div_temp = cfblk140_t_0_0 / Mysubsystem_38_out1;
