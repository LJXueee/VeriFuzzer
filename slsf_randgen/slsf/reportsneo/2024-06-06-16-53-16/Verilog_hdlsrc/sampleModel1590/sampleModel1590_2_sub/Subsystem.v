// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1590\sampleModel1590_2_sub\Subsystem.v
// Created: 2024-06-10 07:58:39
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1590_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg  [0:1] cfblk169_reg;  // ufix1 [2]
  wire [0:1] cfblk169_reg_next;  // ufix1 [2]
  wire cfblk169_out1;
  wire [31:0] cfblk36_add_temp;  // ufix32
  wire [31:0] cfblk36_1;  // ufix32
  wire [31:0] cfblk36_2;  // ufix32
  ...
  assign dtc_out_3 = Mysubsystem_22_out1;
  ...
  assign cfblk133_out1 = dtc_out_4;
  ...
  assign cfblk123_out1 = dtc_out_5;



  assign cfblk119_out1 = cfblk140_out1 - Mysubsystem_22_out1;
  ...
  assign cfblk79_out1 = Mysubsystem_22_out1 - cfblk168_out1;
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk60_out1),  // uint8
                                   .In2(cfblk66_out1),  // uint8
                                   .Y(Mysubsystem_41_out1)
                                   );
  ...
  assign cfblk169_reg_next[0] = Mysubsystem_41_out1;
  assign cfblk169_reg_next[1] = cfblk169_reg[0];



  assign cfblk36_1 = {31'b0, cfblk169_out1};
  assign cfblk36_2 = {24'b0, cfblk193_out1};
  assign cfblk36_add_temp = cfblk36_1 + cfblk36_2;
  assign cfblk36_out1 = cfblk36_add_temp[7:0];
  ...
  Mysubsystem_22 u_Mysubsystem_22 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk117_out1),  // uint8
                                   .Out1(Mysubsystem_22_out1)  // uint8
                                   );

  DotProduct_block u_cfblk126_inst (.in1(Mysubsystem_22_out1),  // uint8
  ...
  assign cfblk74_out1 = cfblk70_out1 + cfblk74_const_val_1;
