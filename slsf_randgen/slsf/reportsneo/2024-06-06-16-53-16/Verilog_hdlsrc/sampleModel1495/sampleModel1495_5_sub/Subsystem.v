// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1495\sampleModel1495_5_sub\Subsystem.v
// Created: 2024-06-10 05:01:47
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1495_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk118_out1),  // uint8
  ...
  assign cfblk168_reg_next[0] = Mysubsystem_33_out1;
  ...
  assign cfblk160_reg_next[0] = cfblk55_out1;
  assign cfblk160_reg_next[1] = cfblk160_reg[0];



  assign cfblk87_out1 = cfblk29_out1 + cfblk160_out1;
  ...
  assign cfblk120_out1 = dtc_out_6;
  ...
  always @(Mysubsystem_6_out1, cfblk32_out1) begin
    cfblk93_div_temp = 9'b000000000;
    cfblk93_t_0_0 = 9'b000000000;
    if (Mysubsystem_6_out1 == 8'b00000000) begin
      cfblk93_out1 = 8'b11111111;
    end
    else begin
      cfblk93_t_0_0 = {1'b0, cfblk32_out1};
      cfblk93_div_temp = cfblk93_t_0_0 / Mysubsystem_6_out1;
