// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1510\sampleModel1510_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1510_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_36_out2;  // uint8
  ...
  Mysubsystem_44 u_Mysubsystem_44 (.Out1(Mysubsystem_44_out1)  // uint8
                                   );
  ...
  Mysubsystem_24 u_Mysubsystem_24 (.In1(Mysubsystem_36_out2),  // uint8
  ...
  Mysubsystem_36 u_Mysubsystem_36 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_24_out1),  // uint8
                                   .Out1(Mysubsystem_36_out1),  // uint8
                                   .Out2(Mysubsystem_36_out2)  // uint8
                                   );
  ...
  assign cfblk1_relop1 = cfblk168_out1 <= Mysubsystem_41_out1;
  ...
  assign cfblk100_out1 = cfblk28_out1 + Mysubsystem_31_out1;
  ...
  assign cfblk59_out1 = cfblk77_out1 + Mysubsystem_31_out2;
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk108_out1),  // uint8
  ...
  assign cfblk162_reg_next[0] = Mysubsystem_28_out1;
