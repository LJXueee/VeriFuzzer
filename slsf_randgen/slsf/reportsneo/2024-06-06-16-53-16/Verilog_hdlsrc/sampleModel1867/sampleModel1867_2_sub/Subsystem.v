// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1867\sampleModel1867_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1867_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign dtc_out_1 = cfblk122_out1;
  ...
  assign cfblk125_out1 = dtc_out_2;
  ...
  assign cfblk76_out1 = cfblk140_out1 + Mysubsystem_31_out1;
  ...
  assign cfblk89_out1 = Mysubsystem_31_out1 - cfblk62_out1;
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.In1(cfblk15_out1),  // uint8
  ...
  Mysubsystem_44 u_Mysubsystem_44 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_16_out1),  // uint8
                                   .y(Mysubsystem_44_out1)  // uint8
                                   );

  assign cfblk12_out1 = (Mysubsystem_44_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk45_out1 = cfblk12_out1 - cfblk164_out1;



  cfblk143 u_cfblk143 (.In1(cfblk45_out1),  // uint8
  ...
  assign cfblk163_reg_next[0] = cfblk39_out1;
  assign cfblk163_reg_next[1] = cfblk163_reg[0];



  DotProduct_block7 u_cfblk90_inst (.in1(cfblk143_out1),  // uint8
  ...
  assign cfblk64_out1 = cfblk90_out1 + cfblk64_const_val_1;
