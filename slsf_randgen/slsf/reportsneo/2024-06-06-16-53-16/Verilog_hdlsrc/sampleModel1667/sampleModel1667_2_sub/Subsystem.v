// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1667\sampleModel1667_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1667_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_2_out1;  // ufix16_En7
  wire signed [15:0] Mysubsystem_37_out1;  // int16
  reg signed [15:0] cfblk137_reg [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk137_reg_next [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk137_out1;  // int16
  ...
  DotProduct_block2 u_cfblk58_inst (.in1(Mysubsystem_39_out1),  // uint8
  ...
  assign cfblk138_reg_next[0] = Mysubsystem_2_out2;
  ...
  Mysubsystem_2 u_Mysubsystem_2 (.In1(cfblk14_out1),  // uint8
                                 .In2(cfblk27_out1),  // uint8
                                 .Out1(Mysubsystem_2_out1),  // ufix16_En7
                                 .Out2(Mysubsystem_2_out2)  // uint8
                                 );

  Mysubsystem_37 u_Mysubsystem_37 (.In1(Mysubsystem_2_out1),  // ufix16_En7
                                   .Out1(Mysubsystem_37_out1)  // int16
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk137_process
      if (reset == 1'b1) begin
        cfblk137_reg[0] <= 16'sb0000000000000000;
        cfblk137_reg[1] <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk137_reg_next[0] = Mysubsystem_37_out1;
  assign cfblk137_reg_next[1] = cfblk137_reg[0];



  assign switch_compare_1 = cfblk137_out1 >= 16'sb0000000000000000;



  assign cfblk133_out1 = (switch_compare_1 == 1'b0 ? cfblk138_out1 :
              cfblk7_out1);



  assign cfblk16_out1 = cfblk133_out1 - cfblk155_out1;
