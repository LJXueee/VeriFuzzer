// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1831\sampleModel1831_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1831_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.In1(cfblk93_out1),  // uint8
  ...
  assign cfblk161_reg_next[0] = Mysubsystem_21_out1;
  ...
  always @(Mysubsystem_23_out1, cfblk140_out1) begin
    cfblk7_div_temp = 9'b000000000;
    cfblk7_t_0_0 = 9'b000000000;
    if (Mysubsystem_23_out1 == 8'b00000000) begin
      cfblk7_out1 = 8'b11111111;
    end
    else begin
      cfblk7_t_0_0 = {1'b0, cfblk140_out1};
      cfblk7_div_temp = cfblk7_t_0_0 / Mysubsystem_23_out1;
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.In1(cfblk106_out1),  // uint8
                                   .In2(cfblk128_out1),  // uint8
                                   .In3(cfblk139_out1),  // uint8
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.In1(cfblk59_out1),  // uint8
                                   .In2(cfblk63_out1),  // uint8
                                   .cfblk131(Mysubsystem_42_out1)  // uint8
                                   );

  assign cfblk131 = Mysubsystem_42_out1;
