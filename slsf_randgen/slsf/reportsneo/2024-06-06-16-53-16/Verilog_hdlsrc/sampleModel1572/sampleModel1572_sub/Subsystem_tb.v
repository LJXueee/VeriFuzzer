// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1572\sampleModel1572_sub\Subsystem_tb.v
// Created: 2024-08-12 20:33:58
// 
...
module Subsystem_tb;
  ...
  wire [7:0] cfblk128_expected_table_data [0:10];  // ufix8 [11]
  wire [7:0] cfblk128_expected_1;  // ufix8
  wire [7:0] cfblk128_expected_2;  // uint8
  ...
  assign Hdl_out_lastAddr = cfblk128_addr >= 4'b1010;
  ...
  assign cfblk128_expected_table_data[0] = 8'b11111101;
  assign cfblk128_expected_table_data[1] = 8'b00000000;
  assign cfblk128_expected_table_data[2] = 8'b11110101;
  assign cfblk128_expected_table_data[3] = 8'b11110001;
  assign cfblk128_expected_table_data[4] = 8'b11111100;
  assign cfblk128_expected_table_data[5] = 8'b11100111;
  assign cfblk128_expected_table_data[6] = 8'b10011111;
  assign cfblk128_expected_table_data[7] = 8'b00010110;
  assign cfblk128_expected_table_data[8] = 8'b11111110;
  assign cfblk128_expected_table_data[9] = 8'b00000000;
  assign cfblk128_expected_table_data[10] = 8'b01100100;
  assign cfblk128_expected_1 = cfblk128_expected_table_data[cfblk128_addr];



  assign cfblk128_expected_2 = cfblk128_expected_1;



  assign cfblk128_ref = cfblk128_expected_2;
  ...
  assign Hdl_out_expected_table_data[6] = 8'b11100110;
  assign Hdl_out_expected_table_data[7] = 8'b00100000;
  assign Hdl_out_expected_table_data[8] = 8'b00010000;
  assign Hdl_out_expected_table_data[9] = 8'b00100100;
  assign Hdl_out_expected_table_data[10] = 8'b01101110;
  assign Hdl_out_expected_1 = Hdl_out_expected_table_data[cfblk128_addr];
