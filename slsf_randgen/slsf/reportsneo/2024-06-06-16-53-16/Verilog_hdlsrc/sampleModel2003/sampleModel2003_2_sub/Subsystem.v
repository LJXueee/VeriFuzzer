// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2003\sampleModel2003_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2003_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire enb;
  wire [3:0] Mysubsystem_28_out1;  // ufix4_E4
  wire [7:0] cfblk156_out1;  // uint8
  wire [7:0] Mysubsystem_10_out1;  // ufix8_E8
  wire [31:0] Mysubsystem_10_out2;  // ufix32_En15
  ...
  wire [32:0] cfblk20_y;  // ufix33_En15
  ...
  wire [15:0] cfblk174_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk174_out1;  // uint16
  wire [7:0] cfblk89_out1;  // uint8
  wire [7:0] cfblk4_out1;  // uint8
  wire [7:0] cfblk79_out1;  // uint8
  wire [7:0] cfblk116_out1;  // uint8
  wire [31:0] cfblk100_add_cast;  // ufix32_En14
  wire [31:0] cfblk100_add_cast_1;  // ufix32_En14
  wire [31:0] cfblk100_add_temp;  // ufix32_En14
  ...
  reg [15:0] cfblk178_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk178_reg_next [0:1];  // ufix16 [2]
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_28_out1)  // ufix4_E4
                                   );
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_10_out1),  // ufix8_E8
                                   .Out2(Mysubsystem_10_out2)  // ufix32_En15
                                   );
  ...
  assign cfblk20_y = {1'b0, Mysubsystem_10_out2};
  assign cfblk20_out1 = cfblk20_y[22:15];
  ...
  DotProduct_block7 u_cfblk29_inst (.in1(cfblk35_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk146_inst (.in1(cfblk20_out1),  // uint8
  ...
  assign cfblk145_sub_cast = {16'b0, {Mysubsystem_10_out1, 8'b00000000}};
  ...
  assign dtc_out_1 = cfblk11_out1;



  assign cfblk126_out1 = dtc_out_1;
  ...
  DotProduct_block6 u_cfblk25_inst (.in1(cfblk81_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk113_inst (.in1(cfblk35_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk39_inst (.in1(cfblk175_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk24_inst (.in1(cfblk44_out1),  // uint8
                                    .in2(cfblk172_out1),  // uint8
                                    .out1(cfblk24_out1)  // uint8
                                    );

  assign dtc_out_2 = cfblk123_out1;
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.In1(cfblk121_out1),  // uint8
  ...
  assign cfblk174_reg_next[0] = Mysubsystem_1_out1;
  assign cfblk174_reg_next[1] = cfblk174_reg[0];



  cfblk1 u_cfblk1 (.u(cfblk174_out1),  // uint16
                   .y(cfblk1_out1)  // uint8
                   );
  ...
  DotProduct_block2 u_cfblk116_inst (.in1(cfblk18_out1),  // uint8
                                     .in2(cfblk190_out1),  // uint8
                                     .out1(cfblk116_out1)  // uint8
                                     );

  assign cfblk100_add_cast = {1'b0, Mysubsystem_10_out2[31:1]};
  assign cfblk100_add_cast_1 = {10'b0, {cfblk116_out1, 14'b00000000000000}};
  assign cfblk100_add_temp = cfblk100_add_cast + cfblk100_add_cast_1;
  assign cfblk100_out1 = cfblk100_add_temp[21:14];
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk123_out1),  // uint8
                                   .In2(cfblk21_out1),  // uint8
                                   .Out1(Mysubsystem_29_out1)  // uint8
                                   );

  Mysubsystem_41 u_Mysubsystem_41 (.In1(Mysubsystem_28_out1),  // ufix4_E4
                                   .In2(Mysubsystem_29_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk178_process
      if (reset == 1'b1) begin
        cfblk178_reg[0] <= 16'b0000000000000000;
        cfblk178_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk178_reg_next[0] = Mysubsystem_41_out1;
  assign cfblk178_reg_next[1] = cfblk178_reg[0];



  assign cfblk194_out1 = cfblk178_out1[7:0];



  assign cfblk6_relop1 = cfblk194_out1 <= cfblk45_out1;
