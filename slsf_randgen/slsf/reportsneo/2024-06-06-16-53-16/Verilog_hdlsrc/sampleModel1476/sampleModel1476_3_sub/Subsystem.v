// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1476\sampleModel1476_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1476_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [3:0] Mysubsystem_1_out1;  // ufix4_E4
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.In1(cfblk41_out1),  // uint8
                                   .Out1(Mysubsystem_40_out1)  // uint8
                                   );

  Mysubsystem_15 u_Mysubsystem_15 (.In1(Mysubsystem_40_out1),  // uint8
  ...
  Mysubsystem_4 u_Mysubsystem_4 (.In1(cfblk69_out1),  // uint8
  ...
  Mysubsystem_44 u_Mysubsystem_44 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk83_out1),  // uint8
                                   .Out1(Mysubsystem_44_out1)  // uint8
                                   );

  assign cfblk21_out1 = cfblk5_out1 + Mysubsystem_44_out1;
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.clk(clk),
                                 .reset(reset),
                                 .enb(clk_enable),
                                 .In1(cfblk138_out1),  // uint8
                                 .y(Mysubsystem_1_out1)  // ufix4_E4
                                 );

  assign cfblk7_out1 = {Mysubsystem_1_out1, 4'b0000};
  ...
  assign cfblk60_out1 = dtc_out_7;



  Mysubsystem_43 u_Mysubsystem_43 (.In1(cfblk60_out1),  // uint8
                                   .In2(Mysubsystem_15_out1),  // uint8
                                   .In3(cfblk122_out1),  // uint8
  ...
  assign cfblk145_reg_next[0] = Mysubsystem_43_out1;
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.In1(cfblk5_out1),  // uint8
                                   .cfblk130(Mysubsystem_45_out1)  // uint8
                                   );

  assign cfblk130 = Mysubsystem_45_out1;
