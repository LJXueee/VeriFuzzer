// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1626\sampleModel1626_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1626_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg signed [7:0] cfblk5_varargout_1;  // sfix8
  reg signed [9:0] cfblk5_div_temp;  // sfix10
  reg signed [9:0] cfblk5_t_0_0;  // sfix10
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_33_out2),  // uint8
                                   .Out1(Mysubsystem_33_out1),  // uint8
                                   .Out2(Mysubsystem_33_out2),  // uint8
                                   .Y(Mysubsystem_33_out3)
                                   );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_33_out1),  // uint8
  ...
  assign cfblk94_out1 = Mysubsystem_32_out2 + cfblk138_out1;
  ...
  assign cfblk84_out1 = Mysubsystem_20_out1 + cfblk84_const_val_1;
  ...
  assign cfblk126_out1 = (Mysubsystem_33_out3 > 1'b0 ? 8'sb00000001 :
              8'sb00000000);
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.In1(Mysubsystem_32_out1),  // ufix16_En7
                                   .Out1(Mysubsystem_39_out1)  // ufix16_En7
                                   );

  Mysubsystem_36 u_Mysubsystem_36 (.In1(Mysubsystem_39_out1),  // ufix16_En7
  ...
  DotProduct u_cfblk19_inst (.in1(Mysubsystem_36_out1),  // uint8
  ...
  assign cfblk53_out1 = cfblk79_out1 + Mysubsystem_33_out2;
  ...
  always @(cfblk126_out1, cfblk158_out1) begin
    cfblk5_div_temp = 10'sb0000000000;
    cfblk5_t_0_0 = 10'sb0000000000;
    if (cfblk126_out1 == 8'sb00000000) begin
      cfblk5_varargout_1 = 8'sb01111111;
    end
    else begin
      cfblk5_t_0_0 = {2'b0, cfblk158_out1};
      cfblk5_div_temp = cfblk5_t_0_0 / cfblk126_out1;
      if ((cfblk5_div_temp[9] == 1'b0) && (cfblk5_div_temp[8:7] != 2'b00)) begin
        cfblk5_varargout_1 = 8'sb01111111;
      end
      else if ((cfblk5_div_temp[9] == 1'b1) && (cfblk5_div_temp[8:7] != 2'b11)) begin
        cfblk5_varargout_1 = 8'sb10000000;
      end
      else begin
        cfblk5_varargout_1 = cfblk5_div_temp[7:0];
      end
    end
    if (cfblk5_varargout_1[7] == 1'b1) begin
      cfblk5_out1 = 8'b00000000;
    end
    else begin
      cfblk5_out1 = cfblk5_varargout_1;
    end
  end
