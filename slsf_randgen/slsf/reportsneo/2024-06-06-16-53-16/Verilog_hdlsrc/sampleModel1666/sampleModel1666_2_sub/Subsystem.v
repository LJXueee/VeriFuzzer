// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1666\sampleModel1666_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1666_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk125_out1 = $rtoi(Mysubsystem_31_out1_double);
  ...
  always @(cfblk125_out1, cfblk28_out1) begin
    ...
    if (cfblk28_out1 == 8'b00000000) begin
      ...
      cfblk115_t_0_0 = {1'b0, cfblk125_out1};
  ...
  assign cfblk59_1 = {16'b0, Mysubsystem_12_out1};
  assign cfblk59_2 = {24'b0, cfblk82_out1};
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.In1(cfblk118_out1),  // uint8
  ...
  assign cfblk156_reg_next[0] = Mysubsystem_30_out1;
  ...
  DotProduct_block4 u_cfblk15_inst (.in1(cfblk142_out1),  // uint8
                                    .in2(cfblk39_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk71_out1;



  assign cfblk7_out1 = dtc_out_10;
