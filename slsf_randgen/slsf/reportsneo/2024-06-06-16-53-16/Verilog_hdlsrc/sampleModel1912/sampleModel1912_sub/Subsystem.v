// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1912\sampleModel1912_sub\Subsystem.v
// Created: 2024-08-15 12:43:58
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1912_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk66_out1 = cfblk77_out1 + cfblk66_const_val_1;
  ...
  DotProduct_block3 u_cfblk21_inst (.in1(cfblk117_out1),  // uint8
  ...
  assign cfblk2_out1 = cfblk23_out1 & 8'b11111110;



  DotProduct_block12 u_cfblk96_inst (.in1(cfblk58_out1),  // uint8
  ...
  assign cfblk134_reg_next[0] = cfblk96_out1;
  assign cfblk134_reg_next[1] = cfblk134_reg[0];



  assign cfblk110_out1 = cfblk1_out1 + cfblk134_out1;
  ...
  DotProduct_block6 u_cfblk38_inst (.in1(cfblk11_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk37_inst (.in1(cfblk100_out1),  // uint8
                                    .in2(cfblk124_out1),  // uint8
                                    .out1(cfblk37_out1)  // uint8
                                    );

  assign dtc_out_4 = cfblk37_out1;



  assign cfblk82_out1 = dtc_out_4;
  ...
  assign cfblk104_out1 = cfblk62_out1 + cfblk104_const_val_1;



  always @(cfblk104_out1, cfblk82_out1) begin
    ...
    if (cfblk82_out1 == 8'b00000000) begin
      ...
      cfblk64_t_0_0 = {1'b0, cfblk104_out1};
  ...
  assign cfblk139_reg_next[0] = cfblk64_out1;
  ...
  assign cfblk90_out1 = cfblk1_out1 + cfblk90_const_val_1;
  ...
  DotProduct_block11 u_cfblk92_inst (.in1(cfblk135_out1),  // uint8
  ...
  DotProduct u_cfblk106_inst (.in1(cfblk114_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk41_inst (.in1(cfblk3_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk14_inst (.in1(cfblk13_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk12_inst (.in1(cfblk111_out1),  // uint8
  ...
  assign cfblk87_out1 = cfblk16_out1 - cfblk90_out1;
  ...
  DotProduct_block9 u_cfblk59_inst (.in1(cfblk53_out1),  // uint8
  ...
  DotProduct_block u_cfblk114_inst (.in1(cfblk79_out1),  // uint8
                                    .in2(cfblk121_out1),  // uint8
  ...
  DotProduct_block10 u_cfblk76_inst (.in1(cfblk146_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk24_inst (.in1(cfblk108_out1),  // uint8
  ...
  assign cfblk63_out1 = dtc_out_8;



  DotProduct_block8 u_cfblk46_inst (.in1(cfblk63_out1),  // uint8
