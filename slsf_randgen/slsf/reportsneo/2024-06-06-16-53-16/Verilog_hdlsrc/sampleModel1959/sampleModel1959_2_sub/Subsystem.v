// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1959\sampleModel1959_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1959_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .cfblk134(Mysubsystem_31_out1)  // uint8
                                   );

  assign cfblk134 = Mysubsystem_31_out1;
  ...
  Mysubsystem_15 u_Mysubsystem_15 (.In1(cfblk3_out1),  // uint8
  ...
  assign cfblk160_reg_next[0] = Mysubsystem_15_out1;
  ...
  always @(cfblk142_out1, cfblk97_out1) begin
    ...
    if (cfblk97_out1 == 8'b00000000) begin
      ...
      cfblk91_t_0_0 = {1'b0, cfblk142_out1};
  ...
  assign cfblk88_out1 = cfblk125_out1 - Mysubsystem_36_out1;
  ...
  assign cfblk129_out1 = cfblk62_out1 + cfblk10_out1;



  assign cfblk138 = cfblk129_out1;

  assign Hdl_out = cfblk72_out1;
