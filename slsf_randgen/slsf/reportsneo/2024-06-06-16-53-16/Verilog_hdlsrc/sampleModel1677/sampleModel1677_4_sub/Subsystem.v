// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1677\sampleModel1677_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1677_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [31:0] cfblk59_sub_cast;  // sfix32_En7
  wire signed [31:0] cfblk59_sub_cast_1;  // sfix32_En7
  wire signed [31:0] cfblk59_sub_temp;  // sfix32_En7
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk154_out1),  // uint8
                                   .y(Mysubsystem_16_out1)
                                   );

  assign cfblk173_out1 = {7'b0, Mysubsystem_16_out1};



  assign cfblk13_out1 = (cfblk173_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign dtc_out_3 = cfblk143_out1;
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.In1(cfblk117_out1),  // uint8
  ...
  assign cfblk157_reg_next[0] = Mysubsystem_26_out1;
  assign cfblk157_reg_next[1] = cfblk157_reg[0];



  assign cfblk59_sub_cast = {16'b0, cfblk157_out1};
  assign cfblk59_sub_cast_1 = {17'b0, {cfblk111_out1, 7'b0000000}};
  assign cfblk59_sub_temp = cfblk59_sub_cast - cfblk59_sub_cast_1;
  assign cfblk59_out1 = cfblk59_sub_temp[14:7];
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.In1(cfblk99_out1),  // uint8
                                   .cfblk135(Mysubsystem_35_out1)  // uint8
                                   );

  assign cfblk135 = Mysubsystem_35_out1;
