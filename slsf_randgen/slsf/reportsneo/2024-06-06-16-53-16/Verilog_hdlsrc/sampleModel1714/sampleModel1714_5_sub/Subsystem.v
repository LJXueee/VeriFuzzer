// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1714\sampleModel1714_5_sub\Subsystem.v
// Created: 2024-07-01 18:44:48
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1714_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_14_out3;  // uint8
  wire [7:0] Mysubsystem_23_out1;  // uint8
  wire [15:0] Mysubsystem_14_out1;  // ufix16_En7
  ...
  wire signed [31:0] cfblk15_sub_cast;  // sfix32_En7
  wire signed [31:0] cfblk15_sub_cast_1;  // sfix32_En7
  wire signed [31:0] cfblk15_sub_temp;  // sfix32_En7
  ...
  assign cfblk89_out1 = (cfblk9_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk43_out1 = (cfblk89_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  always @(cfblk165_out1, cfblk43_out1) begin
    ...
    if (cfblk43_out1 == 8'b00000000) begin
      ...
      cfblk37_div_temp = cfblk37_t_0_0 / cfblk43_out1;
  ...
  Mysubsystem_23 u_Mysubsystem_23 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_14_out3),  // uint8
                                   .Out1(Mysubsystem_23_out1)  // uint8
                                   );

  Mysubsystem_14 u_Mysubsystem_14 (.In1(Mysubsystem_23_out1),  // uint8
                                   .Out1(Mysubsystem_14_out1),  // ufix16_En7
                                   .Out2(Mysubsystem_14_out2),  // uint8
                                   .Out3(Mysubsystem_14_out3)  // uint8
                                   );
  ...
  assign cfblk70_out1 = cfblk164_out1 + Mysubsystem_14_out2;
  ...
  assign cfblk157_out1 = dtc_out_4;
  ...
  DotProduct_block u_cfblk113_inst (.in1(Mysubsystem_23_out1),  // uint8
                                    .in2(cfblk34_out1),  // uint8
                                    .out1(cfblk113_out1)  // uint8
                                    );

  DotProduct_block2 u_cfblk128_inst (.in1(cfblk113_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk126_inst (.in1(cfblk132_out1),  // uint8
                                     .in2(cfblk34_out1),  // uint8
  ...
  assign dtc_out_5 = cfblk147_out1;
  ...
  DotProduct_block4 u_cfblk85_inst (.in1(cfblk36_out1),  // uint8
  ...
  assign cfblk184_reg_next[0] = cfblk85_out1;
  ...
  assign cfblk120_out1 = cfblk42_out1 + cfblk184_out1;



  assign dtc_out_7 = cfblk120_out1;
  ...
  assign cfblk15_sub_cast = {17'b0, {cfblk36_out1, 7'b0000000}};
  assign cfblk15_sub_cast_1 = {16'b0, Mysubsystem_14_out1};
  assign cfblk15_sub_temp = cfblk15_sub_cast - cfblk15_sub_cast_1;
  assign cfblk15_out1 = cfblk15_sub_temp[14:7];
  ...
  DotProduct u_cfblk102_inst (.in1(cfblk53_out1),  // uint8
  ...
  assign dtc_out_11 = cfblk79_out1;



  assign cfblk151_out1 = dtc_out_11;
  ...
  assign dtc_out_12 = cfblk148_out1;



  assign cfblk95_out1 = dtc_out_12;



  assign cfblk2_relop1 = cfblk78_out1 <= cfblk95_out1;
  ...
  assign cfblk83_out1 = cfblk37_out1 - cfblk149_out1;
  ...
  always @(cfblk37_out1, cfblk97_out1) begin
    ...
    if (cfblk97_out1 == 8'b00000000) begin
      ...
      cfblk109_t_0_0 = {1'b0, cfblk37_out1};
  ...
  assign dtc_out_14 = cfblk33_out1;



  assign cfblk64_out1 = dtc_out_14;
  ...
  assign dtc_out_15 = cfblk141_out1;



  assign cfblk31_out1 = dtc_out_15;
  ...
  DotProduct_block3 u_cfblk18_inst (.in1(cfblk57_out1),  // uint8
  ...
  assign dtc_out_16 = cfblk52_out1;
