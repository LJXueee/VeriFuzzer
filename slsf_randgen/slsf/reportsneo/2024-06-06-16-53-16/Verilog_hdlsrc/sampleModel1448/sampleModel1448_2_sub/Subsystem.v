// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1448\sampleModel1448_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1448_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_13_out2;  // uint16
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_13_out1),  // uint16
                                   .Out2(Mysubsystem_13_out2)  // uint16
                                   );
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.In1(Mysubsystem_13_out2),  // uint16
  ...
  assign dtc_out_2 = {31'b0, cfblk5_relop1};



  assign cfblk39_out1 = dtc_out_2[7:0];
  ...
  assign cfblk141_out1 = dtc_out_6;
  ...
  assign cfblk92_2 = {16'b0, Mysubsystem_13_out1};
  ...
  assign dtc_out_10 = cfblk161_out1;
  ...
  assign cfblk30_out1 = dtc_out_13;
