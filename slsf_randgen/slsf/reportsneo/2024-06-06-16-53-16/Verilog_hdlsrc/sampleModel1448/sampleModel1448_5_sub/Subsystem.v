// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1448\sampleModel1448_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1448_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_48_out2;  // uint8
  ...
  Mysubsystem_48 u_Mysubsystem_48 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_48_out1),  // uint16
                                   .Out2(Mysubsystem_48_out2)  // uint8
                                   );
  ...
  assign cfblk25_out1 = cfblk141_out1 - Mysubsystem_29_out1;
  ...
  Mysubsystem_4 u_Mysubsystem_4 (.In2(cfblk64_out1),  // uint8
  ...
  assign cfblk162_reg_next[0] = Mysubsystem_4_out1;
  ...
  assign dtc_out_4 = {31'b0, cfblk5_relop1};



  assign cfblk39_out1 = dtc_out_4[7:0];
  ...
  assign cfblk92_2 = {16'b0, Mysubsystem_48_out1};
  ...
  assign cfblk141_out1 = dtc_out_7;
  ...
  assign cfblk103_out1 = dtc_out_9;
  ...
  assign dtc_out_10 = cfblk123_out1;



  assign cfblk127_out1 = dtc_out_10;
  ...
  assign dtc_out_11 = cfblk18_out1;



  assign cfblk24_out1 = dtc_out_11;



  assign dtc_out_12 = cfblk24_out1;
