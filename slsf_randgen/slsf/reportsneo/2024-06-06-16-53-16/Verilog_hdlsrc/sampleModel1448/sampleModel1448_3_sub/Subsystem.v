// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1448\sampleModel1448_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1448_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_3 u_Mysubsystem_3 (.Out1(Mysubsystem_3_out1)  // uint8
                                 );
  ...
  always @(Mysubsystem_38_out1, cfblk101_out1) begin
    cfblk74_div_temp = 9'b000000000;
    cfblk74_t_0_0 = 9'b000000000;
    if (Mysubsystem_38_out1 == 8'b00000000) begin
      cfblk74_out1 = 8'b11111111;
    end
    else begin
      cfblk74_t_0_0 = {1'b0, cfblk101_out1};
      cfblk74_div_temp = cfblk74_t_0_0 / Mysubsystem_38_out1;
  ...
  DotProduct_block8 u_cfblk66_inst (.in1(Mysubsystem_38_out2),  // uint8
  ...
  assign cfblk126_out1 = cfblk11_out1 + Mysubsystem_38_out1;
  ...
  Mysubsystem_38 u_Mysubsystem_38 (.clk(clk),
                                   ...
                                   .u(Mysubsystem_3_out1),  // uint8
                                   .In3(cfblk110_out1),  // uint8
                                   .Out1(Mysubsystem_38_out1),  // uint8
                                   .Out2(Mysubsystem_38_out2)  // uint8
                                   );

  assign cfblk46_out1 = Mysubsystem_38_out1 + cfblk166_out1;
  ...
  assign cfblk92_2 = {16'b0, cfblk150_out1};
