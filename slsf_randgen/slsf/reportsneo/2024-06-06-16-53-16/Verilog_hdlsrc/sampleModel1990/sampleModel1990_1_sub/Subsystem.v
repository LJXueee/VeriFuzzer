// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1990\sampleModel1990_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1990_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk133_out1 = cfblk25_out1 + cfblk112_out1;
  ...
  assign dtc_out_3 = cfblk154_out1;



  assign cfblk145_out1 = dtc_out_3;
  ...
  always @(cfblk112_out1, cfblk173_out1) begin
    ...
    if (cfblk112_out1 == 8'b00000000) begin
      ...
      cfblk68_div_temp = cfblk68_t_0_0 / cfblk112_out1;
  ...
  assign cfblk112_out1 = {7'b0, Mysubsystem_34_out1};
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk72_out1),  // uint8
                                   .In2(cfblk140_out1),  // uint8
  ...
  assign cfblk189_reg_next[0] = Mysubsystem_13_out1;
  ...
  assign dtc_out_8 = cfblk153_out1;



  assign cfblk146_out1 = dtc_out_8;
