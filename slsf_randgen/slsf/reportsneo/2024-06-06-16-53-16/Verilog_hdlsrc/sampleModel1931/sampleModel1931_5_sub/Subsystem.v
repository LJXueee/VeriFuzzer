// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1931\sampleModel1931_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1931_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.In1(cfblk104_out1),  // uint8
  ...
  assign cfblk163_reg_next[0] = Mysubsystem_26_out1;
  ...
  assign dtc_out_1 = cfblk121_out1;
  ...
  Mysubsystem_11 u_Mysubsystem_11 (.In1(cfblk46_out1),  // uint8
                                   .In2(cfblk121_out1),  // uint8
                                   .cfblk138(Mysubsystem_11_out1)  // uint8
                                   );

  assign cfblk138 = Mysubsystem_11_out1;

  assign cfblk91_out1 = cfblk145_out1 + cfblk74_out1;



  always @(cfblk55_out1, cfblk91_out1) begin
    ...
    if (cfblk55_out1 == 8'b00000000) begin
      ...
      cfblk26_t_0_0 = {1'b0, cfblk91_out1};
      cfblk26_div_temp = cfblk26_t_0_0 / cfblk55_out1;
