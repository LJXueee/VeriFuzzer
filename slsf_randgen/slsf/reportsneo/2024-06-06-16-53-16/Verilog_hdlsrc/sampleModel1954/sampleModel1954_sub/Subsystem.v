// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1954\sampleModel1954_sub\Subsystem.v
// Created: 2024-08-15 22:07:04
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1954_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign dtc_out_2 = cfblk151_out1;
  ...
  assign cfblk123_out1 = cfblk31_out1 - cfblk42_out1;
  ...
  assign cfblk159_reg_next[0] = cfblk123_out1;
  ...
  assign cfblk145_reg_next[0] = cfblk58_out1;
  ...
  assign cfblk161_reg_next[0] = cfblk64_out1;
  ...
  assign cfblk128_out1 = cfblk1_out1 + cfblk161_out1;



  always @(cfblk128_out1, cfblk163_out1) begin
    ...
    if (cfblk163_out1 == 8'b00000000) begin
      ...
      cfblk99_t_0_0 = {1'b0, cfblk128_out1};
  ...
  always @(cfblk129_out1, cfblk145_out1) begin
    ...
    if (cfblk145_out1 == 8'b00000000) begin
      ...
      cfblk5_div_temp = cfblk5_t_0_0 / cfblk145_out1;
  ...
  assign dtc_out_10 = cfblk92_out1;
  ...
  always @(cfblk105_out1, cfblk10_out1) begin
    ...
    if (cfblk105_out1 == 8'b00000000) begin
      ...
      cfblk55_div_temp = cfblk55_t_0_0 / cfblk105_out1;
  ...
  assign cfblk16_out1 = cfblk42_out1 - cfblk55_out1;
