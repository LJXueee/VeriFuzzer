// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1954\sampleModel1954_4_sub\Subsystem.v
// Created: 2024-07-02 17:04:08
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1954_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk103_out1 = dtc_out_6;
  ...
  assign dtc_out_9 = cfblk21_out1;



  assign cfblk15_out1 = dtc_out_9;
  ...
  assign dtc_out_10 = cfblk151_out1;



  assign cfblk18_out1 = dtc_out_10;
  ...
  always @(Mysubsystem_25_out1, cfblk129_out1) begin
    cfblk5_div_temp = 9'b000000000;
    cfblk5_t_0_0 = 9'b000000000;
    if (Mysubsystem_25_out1 == 8'b00000000) begin
      cfblk5_out1 = 8'b11111111;
    end
    else begin
      cfblk5_t_0_0 = {1'b0, cfblk129_out1};
      cfblk5_div_temp = cfblk5_t_0_0 / Mysubsystem_25_out1;
