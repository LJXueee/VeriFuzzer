// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1840\sampleModel1840_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1840_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_37_out1;  // ufix64
  real Mysubsystem_37_out1_double;  // double
  ...
  wire [31:0] cfblk55_add_temp;  // ufix32
  wire [31:0] cfblk55_1;  // ufix32
  wire [31:0] cfblk55_2;  // ufix32
  ...
  Mysubsystem_37 u_Mysubsystem_37 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_37_out1)  // double
                                   );

  always @* Mysubsystem_37_out1_double = $bitstoreal(Mysubsystem_37_out1);

  assign cfblk128_out1 = $rtoi(Mysubsystem_37_out1_double);
  ...
  assign cfblk55_1 = {24'b0, cfblk154_out1};
  assign cfblk55_2 = {31'b0, Mysubsystem_35_out1};
  assign cfblk55_add_temp = cfblk55_1 + cfblk55_2;
  assign cfblk55_out1 = cfblk55_add_temp[7:0];
  ...
  assign cfblk112_out1 = dtc_out_4;
