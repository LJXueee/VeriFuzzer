// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1420\sampleModel1420_4_sub\Subsystem.v
// Created: 2024-08-12 03:27:51
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1420_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_39_out1),  // uint8
                                   .Out2(Mysubsystem_39_out2)  // uint8
                                   );
  ...
  DotProduct_block u_cfblk114_inst (.in1(cfblk104_out1),  // uint8
  ...
  assign cfblk78_out1 = Mysubsystem_39_out2 + cfblk131_out1;
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.In1(cfblk67_out1),  // uint8
  ...
  assign cfblk192_reg_next[0] = Mysubsystem_10_out1;
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.clk(clk),
                                   ...
                                   .y(Mysubsystem_42_out1)
                                   );

  assign cfblk205_out1 = {7'b0, Mysubsystem_42_out1};



  always @(cfblk176_out1, cfblk205_out1) begin
    ...
    if (cfblk176_out1 == 8'b00000000) begin
      ...
      cfblk124_t_0_0 = {1'b0, cfblk205_out1};
  ...
  assign dtc_out_5 = cfblk161_out1;
  ...
  assign cfblk9_out1 = cfblk120_out1 + Mysubsystem_39_out1;
  ...
  assign dtc_out_9 = cfblk22_out1;



  assign cfblk118_out1 = dtc_out_9;
  ...
  DotProduct u_cfblk102_inst (.in1(cfblk147_out1),  // uint8
                              .in2(cfblk182_out1),  // uint8
                              .out1(cfblk102_out1)  // uint8
                              );

  assign cfblk145_out1 = cfblk102_out1 + cfblk145_const_val_1;



  DotProduct_block1 u_cfblk119_inst (.in1(cfblk145_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk112_out1;



  assign cfblk34_out1 = dtc_out_10;
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.In1(cfblk18_out1),  // uint8
                                   .cfblk154(Mysubsystem_40_out1)  // uint8
                                   );

  assign cfblk154 = Mysubsystem_40_out1;

  assign Hdl_out = Mysubsystem_40_out1;
