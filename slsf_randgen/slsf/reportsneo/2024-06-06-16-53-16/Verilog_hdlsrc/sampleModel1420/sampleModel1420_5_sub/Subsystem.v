// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1420\sampleModel1420_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1420_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] cfblk78_add_cast;  // ufix32_En7
  wire [31:0] cfblk78_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk78_add_temp;  // ufix32_En7
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_35_out2),  // uint8
                                   .Y(Mysubsystem_21_out1),
  ...
  assign cfblk78_add_cast = {16'b0, Mysubsystem_21_out2};
  assign cfblk78_add_cast_1 = {17'b0, {cfblk131_out1, 7'b0000000}};
  assign cfblk78_add_temp = cfblk78_add_cast + cfblk78_add_cast_1;
  assign cfblk78_out1 = cfblk78_add_temp[14:7];
  ...
  assign dtc_out_3 = cfblk97_out1;



  assign cfblk76_out1 = dtc_out_3;
  ...
  assign cfblk9_out1 = cfblk120_out1 + Mysubsystem_35_out1;



  assign dtc_out_7 = cfblk73_out1;
  ...
  assign cfblk170_reg_next[0] = Mysubsystem_25_out1;
  ...
  assign dtc_out_11 = cfblk112_out1;



  assign cfblk34_out1 = dtc_out_11;
