// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1598\sampleModel1598_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1598_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_11_out1;  // ufix16_En7
  reg [15:0] cfblk145_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk145_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk145_out1;  // ufix16_En7
  wire [7:0] cfblk76_out1;  // uint8
  wire [31:0] cfblk56_add_cast;  // ufix32_En7
  wire [31:0] cfblk56_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk56_add_temp;  // ufix32_En7
  ...
  Mysubsystem_11 u_Mysubsystem_11 (.In1(cfblk113_out1),  // uint8
                                   .Out1(Mysubsystem_11_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk56_add_cast = {16'b0, cfblk145_out1};
  assign cfblk56_add_cast_1 = {17'b0, {cfblk76_out1, 7'b0000000}};
  assign cfblk56_add_temp = cfblk56_add_cast + cfblk56_add_cast_1;
  assign cfblk56_out1 = cfblk56_add_temp[14:7];
