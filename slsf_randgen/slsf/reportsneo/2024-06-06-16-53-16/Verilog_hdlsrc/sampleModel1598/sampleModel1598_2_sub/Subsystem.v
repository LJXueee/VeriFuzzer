// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1598\sampleModel1598_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1598_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire Mysubsystem_31_out1;
  reg  [0:1] cfblk141_reg;  // ufix1 [2]
  wire [0:1] cfblk141_reg_next;  // ufix1 [2]
  wire cfblk141_out1;
  ...
  wire [31:0] cfblk37_add_temp;  // ufix32
  wire [31:0] cfblk37_1;  // ufix32
  wire [31:0] cfblk37_2;  // ufix32
  ...
  assign cfblk106_out1 = (cfblk123_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk141_reg_next[0] = Mysubsystem_31_out1;
  ...
  assign dtc_out_1 = cfblk104_out1;



  assign cfblk35_out1 = dtc_out_1;
  ...
  assign dtc_out_2 = cfblk34_out1;



  assign cfblk36_out1 = dtc_out_2;
  ...
  assign cfblk88_out1 = cfblk18_out1 + cfblk21_out1;
  ...
  assign cfblk135_reg_next[0] = cfblk93_out1;
  ...
  cfblk128 u_cfblk128 (.In1(cfblk113_out1),  // uint8
  ...
  assign cfblk56_out1 = cfblk145_out1 + cfblk76_out1;
  ...
  assign cfblk37_1 = {24'b0, cfblk126_out1};
  assign cfblk37_2 = {31'b0, cfblk141_out1};
  assign cfblk37_add_temp = cfblk37_1 + cfblk37_2;
  assign cfblk37_out1 = cfblk37_add_temp[7:0];
  ...
  assign cfblk101_out1 = cfblk39_out1 + cfblk101_const_val_1;
  ...
  assign cfblk134_reg_next[0] = cfblk101_out1;
  ...
  assign cfblk109_out1 = cfblk140_out1 + cfblk1_out1;
  ...
  assign cfblk75_out1 = cfblk99_out1 + cfblk151_out1;



  assign cfblk41_out1 = cfblk134_out1 + cfblk75_out1;
  ...
  assign cfblk15_out1 = cfblk41_out1 - cfblk149_out1;
