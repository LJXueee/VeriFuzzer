// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1492\sampleModel1492_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1492_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.In1(cfblk112_out1),  // uint8
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk45_out1),  // uint8
                                   .In2(Mysubsystem_19_out2),
                                   .Out1(Mysubsystem_27_out1)  // uint8
                                   );

  assign cfblk53_out1 = Mysubsystem_27_out1 + cfblk147_out1;
  ...
  assign cfblk126_out1 = dtc_out_4;
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.In1(cfblk35_out1),  // uint8
                                   .Out1(Mysubsystem_19_out1),  // uint8
                                   .Out2(Mysubsystem_19_out2)
                                   );
  ...
  assign cfblk154_reg_next[0] = Mysubsystem_19_out1;
  ...
  assign dtc_out_8 = cfblk69_out1;



  assign cfblk66_out1 = dtc_out_8;
  ...
  assign dtc_out_9 = cfblk47_out1;



  assign cfblk63_out1 = dtc_out_9;
