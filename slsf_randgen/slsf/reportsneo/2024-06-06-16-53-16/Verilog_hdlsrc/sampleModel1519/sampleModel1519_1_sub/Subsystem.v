// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1519\sampleModel1519_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1519_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk92_out1),  // uint8
  ...
  assign cfblk183_reg_next[0] = Mysubsystem_29_out1;
  ...
  assign dtc_out_3 = cfblk118_out1;
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.In1(cfblk108_out1),  // uint8
                                   .In2(cfblk103_out1),  // uint8
                                   .Out1(Mysubsystem_27_out1)  // uint8
                                   );

  Mysubsystem_3 u_Mysubsystem_3 (.clk(clk),
                                 .reset(reset),
                                 .enb(clk_enable),
  ...
  always @(Mysubsystem_3_out1, cfblk131_out1) begin
    ...
    if (cfblk131_out1 == 8'b00000000) begin
      ...
      cfblk63_t_0_0 = {1'b0, Mysubsystem_3_out1};
  ...
  assign dtc_out_10 = cfblk81_out1;
