// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1519\sampleModel1519_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1519_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_34_out2;  // uint8
  ...
  wire [7:0] Mysubsystem_34_out3;  // uint8
  ...
  wire [15:0] Mysubsystem_13_out2;  // ufix16_En7
  reg [15:0] cfblk184_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk184_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk184_out1;  // ufix16_En7
  wire [7:0] cfblk32_out1;  // uint8
  wire [31:0] cfblk39_add_cast;  // ufix32_En7
  wire [31:0] cfblk39_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk39_add_temp;  // ufix32_En7
  ...
  assign cfblk153_out1 = dtc_out_1;
  ...
  assign cfblk189_reg_next[0] = Mysubsystem_34_out2;
  assign cfblk189_reg_next[1] = cfblk189_reg[0];



  Mysubsystem_36 u_Mysubsystem_36 (.u(Mysubsystem_13_out1),
  ...
  assign cfblk190_reg_next[0] = Mysubsystem_34_out3;
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk92_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1),
                                   .Out2(Mysubsystem_13_out2)  // ufix16_En7
                                   );
  ...
  assign cfblk184_reg_next[0] = Mysubsystem_13_out2;
  assign cfblk184_reg_next[1] = cfblk184_reg[0];



  assign cfblk39_add_cast = {17'b0, {cfblk32_out1, 7'b0000000}};
  assign cfblk39_add_cast_1 = {16'b0, cfblk184_out1};
  assign cfblk39_add_temp = cfblk39_add_cast + cfblk39_add_cast_1;
  assign cfblk39_out1 = cfblk39_add_temp[14:7];
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.In1(cfblk126_out1),  // uint8
                                   .Out1(Mysubsystem_34_out1),  // uint8
                                   .Out2(Mysubsystem_34_out2),  // uint8
                                   .Out3(Mysubsystem_34_out3)  // uint8
                                   );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_34_out1),  // uint8
  ...
  assign cfblk191_reg_next[0] = Mysubsystem_32_out1;
  ...
  assign dtc_out_6 = cfblk81_out1;



  assign cfblk107_out1 = dtc_out_6;
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.In1(cfblk84_out1),  // uint8
                                 .In2(cfblk151_out1),  // uint8
  ...
  Mysubsystem_22 u_Mysubsystem_22 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_9_out1),  // uint8
                                   .Out1(Mysubsystem_22_out1)  // uint8
                                   );

  DotProduct_block8 u_cfblk34_inst (.in1(Mysubsystem_22_out1),  // uint8
  ...
  assign dtc_out_9 = cfblk55_out1;



  assign cfblk9_out1 = dtc_out_9;
