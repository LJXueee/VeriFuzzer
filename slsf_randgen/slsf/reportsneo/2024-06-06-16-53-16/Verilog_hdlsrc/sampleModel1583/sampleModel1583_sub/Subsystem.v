// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1583\sampleModel1583_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1583_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  cfblk4 u_cfblk4 (.u(cfblk186_out1),  // uint8
                   .y(cfblk4_out1)  // uint8
                   );
  ...
  always @(cfblk16_out1, cfblk4_out1) begin
    ...
    if (cfblk16_out1 == 8'b00000000) begin
      ...
      cfblk104_t_0_0 = {1'b0, cfblk4_out1};
  ...
  assign cfblk78_out1 = cfblk17_out1 - cfblk4_out1;
  ...
  assign cfblk21_out1 = cfblk112_out1 + cfblk45_out1;
  ...
  assign cfblk180_reg_next[0] = cfblk21_out1;
  ...
  assign cfblk95_out1 = cfblk111_out1 + cfblk95_const_val_1;
