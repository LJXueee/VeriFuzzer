// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1972\sampleModel1972_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1972_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [31:0] cfblk23_sub_temp;  // sfix32
  wire signed [31:0] cfblk23_1;  // sfix32
  wire signed [31:0] cfblk23_2;  // sfix32
  ...
  reg [15:0] cfblk150_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk150_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk150_out1;  // uint16
  wire signed [31:0] cfblk14_sub_temp;  // sfix32
  wire signed [31:0] cfblk14_1;  // sfix32
  wire signed [31:0] cfblk14_2;  // sfix32
  ...
  reg [15:0] cfblk151_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk151_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk151_out1;  // uint16
  wire [31:0] cfblk124_add_temp;  // ufix32
  wire [31:0] cfblk124_1;  // ufix32
  wire [31:0] cfblk124_2;  // ufix32
  ...
  assign cfblk19_out1 = Mysubsystem_27_out1 + cfblk76_out1;
  ...
  always @(Mysubsystem_27_out1, cfblk164_out1) begin
    ...
    if (cfblk164_out1 == 8'b00000000) begin
      ...
      cfblk11_t_0_0 = {1'b0, Mysubsystem_27_out1};
  ...
  assign cfblk76_out1 = cfblk82_out1 + Mysubsystem_27_out1;
  ...
  DotProduct_block5 u_cfblk3_inst (.in1(cfblk16_out1),  // uint8
  ...
  assign cfblk149_reg_next[0] = Mysubsystem_36_out1;
  assign cfblk149_reg_next[1] = cfblk149_reg[0];



  assign cfblk23_1 = {16'b0, cfblk149_out1};
  assign cfblk23_2 = {24'b0, cfblk3_out1};
  assign cfblk23_sub_temp = cfblk23_1 - cfblk23_2;
  assign cfblk23_out1 = cfblk23_sub_temp[7:0];
  ...
  DotProduct_block u_cfblk113_inst (.in1(cfblk118_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk116_inst (.in1(cfblk70_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk150_process
      if (reset == 1'b1) begin
        cfblk150_reg[0] <= 16'b0000000000000000;
        cfblk150_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk150_reg_next[0] = Mysubsystem_36_out1;
  assign cfblk150_reg_next[1] = cfblk150_reg[0];



  assign cfblk14_1 = {24'b0, cfblk45_out1};
  assign cfblk14_2 = {16'b0, cfblk150_out1};
  assign cfblk14_sub_temp = cfblk14_1 - cfblk14_2;
  assign cfblk14_out1 = cfblk14_sub_temp[7:0];



  DotProduct_block6 u_cfblk35_inst (.in1(cfblk14_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk122_inst (.in1(cfblk95_out1),  // uint8
  ...
  Mysubsystem_36 u_Mysubsystem_36 (.In1(cfblk119_out1),  // uint8
                                   .In2(cfblk7_out1),  // uint8
                                   .In3(cfblk18_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk151_process
      if (reset == 1'b1) begin
        cfblk151_reg[0] <= 16'b0000000000000000;
        cfblk151_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk151_reg_next[0] = Mysubsystem_36_out1;
  assign cfblk151_reg_next[1] = cfblk151_reg[0];



  assign cfblk124_1 = {16'b0, cfblk151_out1};
  assign cfblk124_2 = {24'b0, cfblk123_out1};
  assign cfblk124_add_temp = cfblk124_1 + cfblk124_2;
  assign cfblk124_out1 = cfblk124_add_temp[7:0];
  ...
  assign dtc_out_6 = cfblk54_out1;



  assign cfblk26_out1 = dtc_out_6;
  ...
  DotProduct_block2 u_cfblk120_inst (.in1(cfblk90_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk12_out1;
  ...
  assign dtc_out_11 = cfblk118_out1;



  assign cfblk37_out1 = dtc_out_11;
  ...
  DotProduct_block4 u_cfblk20_inst (.in1(cfblk143_out1),  // uint8
