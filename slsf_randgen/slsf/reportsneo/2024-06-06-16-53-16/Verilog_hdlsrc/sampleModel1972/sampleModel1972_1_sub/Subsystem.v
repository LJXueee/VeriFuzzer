// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1972\sampleModel1972_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1972_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] Mysubsystem_28_out1;  // ufix32_En15
  ...
  wire [31:0] cfblk87_add_cast;  // ufix32_En14
  wire [31:0] cfblk87_add_cast_1;  // ufix32_En14
  wire [31:0] cfblk87_add_temp;  // ufix32_En14
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_28_out1)  // ufix32_En15
                                   );

  Mysubsystem_37 u_Mysubsystem_37 (.Out1(Mysubsystem_37_out1)  // uint8
                                   );
  ...
  assign cfblk19_out1 = Mysubsystem_37_out1 + cfblk76_out1;
  ...
  always @(Mysubsystem_37_out1, cfblk164_out1) begin
    ...
    if (cfblk164_out1 == 8'b00000000) begin
      ...
      cfblk11_t_0_0 = {1'b0, Mysubsystem_37_out1};
  ...
  assign cfblk87_add_cast = {1'b0, Mysubsystem_28_out1[31:1]};
  assign cfblk87_add_cast_1 = {10'b0, {cfblk45_out1, 14'b00000000000000}};
  assign cfblk87_add_temp = cfblk87_add_cast + cfblk87_add_cast_1;
  assign cfblk87_out1 = cfblk87_add_temp[21:14];
  ...
  assign cfblk76_out1 = cfblk82_out1 + Mysubsystem_37_out1;
  ...
  assign dtc_out_5 = cfblk119_out1;
  ...
  assign dtc_out_10 = cfblk107_out1;
