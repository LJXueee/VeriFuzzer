// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1762\sampleModel1762_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1762_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_9_out2;  // uint8
  wire [7:0] Mysubsystem_9_out3;  // uint8
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.In1(cfblk50_out1),  // uint8
  ...
  assign cfblk152_reg_next[0] = Mysubsystem_14_out1;
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.clk(clk),
                                 ...
                                 .Out2(Mysubsystem_9_out2),  // uint8
                                 .Out3(Mysubsystem_9_out3)  // uint8
                                 );

  assign cfblk59_out1 = cfblk146_out1 + Mysubsystem_9_out2;
  ...
  assign dtc_out_1 = cfblk119_out1;
  ...
  assign dtc_out_3 = cfblk34_out1;



  assign cfblk2_out1 = dtc_out_3;
  ...
  assign cfblk45_out1 = cfblk3_out1 + Mysubsystem_9_out1;
  ...
  always @(Mysubsystem_9_out3, cfblk23_out1) begin
    cfblk4_div_temp = 9'b000000000;
    cfblk4_t_0_0 = 9'b000000000;
    if (Mysubsystem_9_out3 == 8'b00000000) begin
      cfblk4_out1 = 8'b11111111;
    end
    else begin
      cfblk4_t_0_0 = {1'b0, cfblk23_out1};
      cfblk4_div_temp = cfblk4_t_0_0 / Mysubsystem_9_out3;
  ...
  DotProduct_block3 u_cfblk21_inst (.in1(Mysubsystem_9_out3),  // uint8
