// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1884\sampleModel1884_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1884_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_20_out1;  // uint16
  wire [15:0] Mysubsystem_11_out2;  // uint16
  ...
  wire [15:0] Mysubsystem_14_out1;  // uint16
  ...
  assign cfblk59_out1 = cfblk108_out1 + cfblk59_const_val_1;



  assign cfblk28_out1 = cfblk59_out1 + cfblk136_out1;



  Mysubsystem_24 u_Mysubsystem_24 (.In1(cfblk28_out1),  // uint8
  ...
  assign cfblk163_reg_next[0] = Mysubsystem_24_out1;
  assign cfblk163_reg_next[1] = cfblk163_reg[0];



  DotProduct_block3 u_cfblk136_inst (.in1(cfblk44_out1),  // uint8
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk124_out1),  // uint8
                                   .Out2(Mysubsystem_28_out2)  // uint8
                                   );
  ...
  assign cfblk158_reg_next[0] = Mysubsystem_28_out2;
  ...
  DotProduct_block5 u_cfblk52_inst (.in1(cfblk165_out1),  // uint8
                                    .in2(cfblk70_out1),  // uint8
                                    .out1(cfblk52_out1)  // uint8
                                    );

  assign cfblk80_out1 = (cfblk42_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk80_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1)  // uint8
                                   );

  Mysubsystem_40 u_Mysubsystem_40 (.In1(cfblk57_out1),  // uint8
  ...
  assign dtc_out_1 = cfblk144_out1;
  ...
  Mysubsystem_20 u_Mysubsystem_20 (.In1(cfblk9_out1),  // uint8
                                   .In2(cfblk132_out1),  // uint8
                                   .Out1(Mysubsystem_20_out1)  // uint16
                                   );

  Mysubsystem_11 u_Mysubsystem_11 (.In1(Mysubsystem_20_out1),  // uint16
                                   .In2(Mysubsystem_40_out1),  // uint8
                                   .Out2(Mysubsystem_11_out2)  // uint16
                                   );

  Mysubsystem_25 u_Mysubsystem_25 (.In1(Mysubsystem_11_out2),  // uint16
                                   .In2(Mysubsystem_13_out1),  // uint8
  ...
  assign cfblk131_out1 = dtc_out_2;
  ...
  DotProduct_block6 u_cfblk77_inst (.in1(cfblk135_out1),  // uint8
  ...
  Mysubsystem_18 u_Mysubsystem_18 (.In2(cfblk42_out1),  // uint8
                                   .In3(cfblk117_out1),  // uint8
                                   .In5(Mysubsystem_25_out1),  // uint8
                                   .Out1(Mysubsystem_18_out1)  // uint16
                                   );

  Mysubsystem_14 u_Mysubsystem_14 (.In1(Mysubsystem_18_out1),  // uint16
                                   .Out1(Mysubsystem_14_out1)  // uint16
                                   );
  ...
  assign cfblk160_reg_next[0] = Mysubsystem_14_out1;
  ...
  assign cfblk132_out1 = dtc_out_6;
  ...
  assign cfblk137_out1 = dtc_out_7;
  ...
  DotProduct_block4 u_cfblk49_inst (.in1(cfblk122_out1),  // uint8
