// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1884\sampleModel1884_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1884_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk141_1 = {24'b0, cfblk134_out1};
  assign cfblk141_2 = {31'b0, Mysubsystem_33_out2};
  ...
  DotProduct_block2 u_cfblk52_inst (.in1(cfblk165_out1),  // uint8
  ...
  DotProduct_block u_cfblk25_inst (.in1(cfblk138_out1),  // uint8
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.clk(clk),
                                   ...
                                   .Y(Mysubsystem_33_out2)
                                   );

  assign cfblk61_out1 = Mysubsystem_33_out1 + cfblk61_const_val_1;
  ...
  assign cfblk50_out1 = (cfblk49_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  Mysubsystem_20 u_Mysubsystem_20 (.In1(cfblk50_out1),  // uint8
                                   .In2(cfblk136_out1),  // uint8
                                   .In3(cfblk108_out1),  // uint8
  ...
  DotProduct u_cfblk136_inst (.in1(cfblk44_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk49_inst (.in1(cfblk122_out1),  // uint8
  ...
  assign cfblk90_out1 = cfblk42_out1 + cfblk90_const_val_1;



  DotProduct_block3 u_cfblk56_inst (.in1(cfblk90_out1),  // uint8
                                    .in2(cfblk117_out1),  // uint8
                                    .out1(cfblk56_out1)  // uint8
                                    );

  assign cfblk75_out1 = cfblk56_out1 + cfblk25_out1;



  assign cfblk100_out1 = Mysubsystem_27_out1 + cfblk75_out1;
  ...
  assign cfblk84_out1 = cfblk160_out1 - cfblk52_out1;
