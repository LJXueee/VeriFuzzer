// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2001\sampleModel2001_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2001_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_1_out1;  // ufix16_En7
  reg [15:0] cfblk171_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk171_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk171_out1;  // ufix16_En7
  ...
  assign cfblk179_reg_next[0] = Mysubsystem_25_out2;
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.In1(cfblk71_out1),  // uint8
                                 .Out1(Mysubsystem_1_out1)  // ufix16_En7
                                 );
  ...
  assign cfblk171_reg_next[0] = Mysubsystem_1_out1;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk11_out1),  // uint8
  ...
  assign cfblk178_reg_next[0] = Mysubsystem_25_out1;
  ...
  assign dtc_out_6 = cfblk150_out1;
  ...
  assign dtc_out_8 = cfblk102_out1;
  ...
  assign dtc_out_10 = cfblk53_out1;



  assign cfblk54_out1 = dtc_out_10;
  ...
  assign dtc_out_11 = cfblk4_out1;



  assign cfblk143_out1 = dtc_out_11;
  ...
  assign dtc_out_13 = cfblk49_out1;



  assign cfblk35_out1 = dtc_out_13;
  ...
  assign dtc_out_14 = cfblk99_out1;



  assign cfblk117_out1 = dtc_out_14;
  ...
  assign dtc_out_15 = cfblk163_out1;



  assign cfblk129_out1 = dtc_out_15;
  ...
  assign dtc_out_16 = cfblk48_out1;



  assign cfblk145_out1 = dtc_out_16;
  ...
  assign dtc_out_17 = cfblk147_out1;



  assign cfblk84_out1 = dtc_out_17;
