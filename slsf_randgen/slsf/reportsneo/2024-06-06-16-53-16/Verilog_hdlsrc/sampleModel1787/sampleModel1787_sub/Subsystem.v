// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1787\sampleModel1787_sub\Subsystem.v
// Created: 2024-08-14 09:00:10
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1787_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk16_out1 = cfblk153_out1[7:0];
  ...
  assign cfblk98_out1 = cfblk152_out1 + cfblk98_const_val_1;
  ...
  assign cfblk101_out1 = cfblk14_out1 + cfblk16_out1;
  ...
  assign cfblk51_out1 = cfblk98_out1 - cfblk47_out1;
  ...
  assign cfblk89_out1 = cfblk35_out1 - cfblk98_out1;
  ...
  assign cfblk178_reg_next[0] = cfblk61_out1;
  assign cfblk178_reg_next[1] = cfblk178_reg[0];



  always @(cfblk178_out1, cfblk8_out1) begin
    ...
    if (cfblk8_out1 == 8'b00000000) begin
      ...
      cfblk29_t_0_0 = {1'b0, cfblk178_out1};
  ...
  assign cfblk31_out1 = cfblk16_out1 + cfblk96_out1;
