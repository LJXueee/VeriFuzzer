// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1580\sampleModel1580_2_sub\Subsystem.v
// Created: 2024-08-12 22:34:04
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1580_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire Mysubsystem_35_out1;
  wire [7:0] Mysubsystem_26_out1;  // uint8
  wire [7:0] cfblk67_out1;  // uint8
  wire [7:0] cfblk111_out1;  // uint8
  wire [7:0] cfblk120_out1;  // uint8
  wire [15:0] Mysubsystem_11_out1;  // uint16
  reg [15:0] cfblk142_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk142_reg_next [0:1];  // ufix16 [2]
  ...
  Mysubsystem_17 u_Mysubsystem_17 (.Out2(Mysubsystem_17_out2)  // uint8
                                   );
  ...
  DotProduct_block7 u_cfblk81_inst (.in1(cfblk9_out1),  // uint8
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk7_out1),  // uint8
                                   .Y(Mysubsystem_35_out1)
                                   );

  Mysubsystem_26 u_Mysubsystem_26 (.In1(Mysubsystem_35_out1),
                                   .Out1(Mysubsystem_26_out1)  // uint8
                                   );

  Mysubsystem_11 u_Mysubsystem_11 (.In1(cfblk67_out1),  // uint8
                                   .In2(Mysubsystem_26_out1),  // uint8
                                   .In3(cfblk111_out1),  // uint8
                                   .In4(cfblk120_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk142_process
      if (reset == 1'b1) begin
        cfblk142_reg[0] <= 16'b0000000000000000;
        cfblk142_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk142_reg_next[0] = Mysubsystem_11_out1;
  ...
  DotProduct_block1 u_cfblk46_inst (.in1(cfblk149_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk77_inst (.in1(cfblk153_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk82_inst (.in1(cfblk12_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk63_inst (.in1(cfblk86_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk71_inst (.in1(cfblk84_out1),  // uint8
  ...
  assign cfblk90_1 = {24'b0, cfblk11_out1};
  assign cfblk90_2 = {16'b0, cfblk142_out1};
  ...
  DotProduct_block3 u_cfblk53_inst (.in1(cfblk27_out1),  // uint8
                                    .in2(cfblk151_out1),  // uint8
                                    .out1(cfblk53_out1)  // uint8
                                    );

  assign cfblk88_out1 = Mysubsystem_17_out2 + cfblk53_out1;
  ...
  DotProduct_block2 u_cfblk50_inst (.in1(cfblk132_out1),  // uint8
  ...
  DotProduct_block u_cfblk120_inst (.in1(cfblk156_out1),  // uint8
