// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1879\sampleModel1879_1_sub_sub\Subsystem_block.v
...
// Source Path: sampleModel1879_1_sub_sub/Subsystem/Subsystem
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Subsystem_block
  ...
  wire [7:0] Mysubsystem_10_out2;  // uint8
  ...
  reg [15:0] cfblk176_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk176_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk176_out1;  // uint16
  ...
  wire signed [31:0] cfblk55_sub_temp;  // sfix32
  wire signed [31:0] cfblk55_1;  // sfix32
  wire signed [31:0] cfblk55_2;  // sfix32
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.Out2(Mysubsystem_10_out2)  // uint8
                                   );
  ...
  DotProduct_block7 u_cfblk21_inst (.in1(cfblk44_out1),  // uint8
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.In1(Mysubsystem_45_out1),
  ...
  Mysubsystem_51 u_Mysubsystem_51 (.In1(cfblk64_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk176_process
      if (reset == 1'b1) begin
        cfblk176_reg[0] <= 16'b0000000000000000;
        cfblk176_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk176_reg_next[0] = Mysubsystem_28_out1;
  ...
  assign cfblk58_1 = {24'b0, cfblk134_out1};
  assign cfblk58_2 = {16'b0, cfblk176_out1};
  ...
  DotProduct_block u_cfblk101_inst (.in1(cfblk19_out1),  // uint8
  ...
  assign dtc_out_2 = cfblk148_out1;
  ...
  assign dtc_out_3 = cfblk109_out1;
  ...
  DotProduct_block2 u_cfblk116_inst (.in1(cfblk146_out1),  // uint8
                                     .in2(cfblk83_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk142_inst (.in1(cfblk87_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk121_inst (.in1(cfblk93_out1),  // uint8
  ...
  assign dtc_out_5 = cfblk43_out1;



  assign cfblk139_out1 = dtc_out_5;



  assign dtc_out_6 = cfblk139_out1;
  ...
  assign dtc_out_8 = cfblk109_out1;



  assign cfblk31_out1 = dtc_out_8;
  ...
  assign cfblk100_out1 = Mysubsystem_10_out2 - cfblk35_out1;
  ...
  assign dtc_out_9 = cfblk28_out1;



  assign cfblk27_out1 = dtc_out_9;



  DotProduct_block1 u_cfblk114_inst (.in1(cfblk27_out1),  // uint8
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .In1(cfblk114_out1),  // uint8
                                   .y(Mysubsystem_45_out1)
                                   );

  assign cfblk55_1 = {31'b0, Mysubsystem_45_out1};
  assign cfblk55_2 = {24'b0, cfblk195_out1};
  assign cfblk55_sub_temp = cfblk55_1 - cfblk55_2;
  assign cfblk55_out1 = cfblk55_sub_temp[7:0];
  ...
  assign dtc_out_10 = cfblk149_out1;
  ...
  assign dtc_out_11 = cfblk13_out1;
  ...
  DotProduct_block5 u_cfblk138_inst (.in1(cfblk123_out1),  // uint8
