// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1406\sampleModel1406_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1406_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  always @(cfblk137_out1, cfblk97_out1) begin
    ...
    if (cfblk97_out1 == 8'b00000000) begin
      ...
      cfblk81_t_0_0 = {1'b0, cfblk137_out1};
  ...
  assign cfblk74_out1 = cfblk119_out1 + cfblk81_out1;



  Mysubsystem_33 u_Mysubsystem_33 (.In2(cfblk74_out1),  // uint8
                                   .Out1(Mysubsystem_33_out1)  // uint8
                                   );

  assign Hdl_out = Mysubsystem_33_out1;
