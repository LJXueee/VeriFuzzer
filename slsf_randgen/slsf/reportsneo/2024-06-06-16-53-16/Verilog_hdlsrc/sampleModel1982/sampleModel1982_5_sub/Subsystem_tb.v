// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1982\sampleModel1982_5_sub\Subsystem_tb.v
// Created: 2024-08-16 08:10:54
// 
...
module Subsystem_tb;
  ...
  reg [3:0] cfblk123_addr;  // ufix4
  wire Hdl_out_lastAddr;  // ufix1
  wire resetn;
  reg  check2_done;  // ufix1
  wire cfblk123_done;  // ufix1
  wire cfblk123_done_enb;  // ufix1
  wire cfblk123_active;  // ufix1
  wire snkDone;
  wire snkDonen;
  wire tb_enb;
  reg  tb_enb_delay;
  wire ce_out;
  wire [7:0] cfblk123;  // uint8
  wire [7:0] Hdl_out;  // uint8
  wire cfblk123_enb;  // ufix1
  wire cfblk123_lastAddr;  // ufix1
  reg  check1_done;  // ufix1
  wire [7:0] cfblk123_expected_1;  // uint8
  wire [7:0] cfblk123_ref;  // uint8
  reg  cfblk123_testFailure;  // ufix1
  ...
  assign Hdl_out_lastAddr = cfblk123_addr >= 4'b1010;
  ...
  assign cfblk123_done_enb = cfblk123_done & rdEnb;



  assign cfblk123_active = cfblk123_addr != 4'b1010;
  ...
  Subsystem u_Subsystem (.clk(clk),
                         ...
                         .ce_out(ce_out),
                         .cfblk123(cfblk123),  // uint8
                         .Hdl_out(Hdl_out)  // uint8
                         );

  assign cfblk123_enb = ce_out & cfblk123_active;
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        cfblk123_addr <= 4'b0000;
      end
      else begin
        if (cfblk123_enb) begin
          if (cfblk123_addr >= 4'b1010) begin
            cfblk123_addr <= 4'b0000;
          end
          else begin
            cfblk123_addr <= cfblk123_addr + 4'b0001;
          end
        end
      end
    end
  ...
  assign cfblk123_lastAddr = cfblk123_addr >= 4'b1010;



  assign cfblk123_done = cfblk123_lastAddr & resetn;
  ...
  always @(posedge clk or posedge reset)
    begin : checkDone_1
      if (reset) begin
        ...
        if (cfblk123_done_enb) begin
          check1_done <= cfblk123_done;
        end
      end
    end
  ...
  // Data source for cfblk123_expected
  assign cfblk123_expected_1 = 8'b00000000;



  assign cfblk123_ref = cfblk123_expected_1;

  always @(posedge clk or posedge reset)
    begin : cfblk123_checker
      if (reset == 1'b1) begin
        cfblk123_testFailure <= 1'b0;
      end
      else begin
        if (ce_out == 1'b1 && cfblk123 !== cfblk123_ref) begin
          cfblk123_testFailure <= 1'b1;
          $display("ERROR in cfblk123 at time %t : Expected '%h' Actual '%h'", $time, cfblk123_ref, cfblk123);
        end
      end
    end
  ...
  assign Hdl_out_expected_1 = Hdl_out_expected_table_data[cfblk123_addr];
  ...
  assign testFailure = cfblk123_testFailure | Hdl_out_testFailure;
