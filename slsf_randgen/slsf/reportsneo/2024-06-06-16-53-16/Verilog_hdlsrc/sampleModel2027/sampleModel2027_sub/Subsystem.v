// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2027\sampleModel2027_sub\Subsystem.v
// Created: 2024-08-16 18:04:52
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel2027_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk167_reg_next[0] = cfblk103_out1;
  assign cfblk167_reg_next[1] = cfblk167_reg[0];



  always @(cfblk167_out1, cfblk22_out1) begin
    ...
    if (cfblk22_out1 == 8'b00000000) begin
      ...
      cfblk129_t_0_0 = {1'b0, cfblk167_out1};
  ...
  always @(cfblk4_out1, cfblk67_out1) begin
    ...
    if (cfblk4_out1 == 8'b00000000) begin
      ...
      cfblk63_t_0_0 = {1'b0, cfblk67_out1};
      cfblk63_div_temp = cfblk63_t_0_0 / cfblk4_out1;
  ...
  assign cfblk21_out1 = (cfblk63_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk175_reg_next[0] = cfblk21_out1;
  ...
  assign cfblk140_out1 = cfblk154_out1 + cfblk203_out1;
  ...
  assign cfblk39_out1 = cfblk93_out1 - cfblk27_out1;



  assign cfblk76_out1 = cfblk39_out1 + cfblk111_out1;
  ...
  assign cfblk183_reg_next[0] = cfblk76_out1;
  ...
  assign cfblk135_out1 = cfblk146_out1 + cfblk175_out1;
