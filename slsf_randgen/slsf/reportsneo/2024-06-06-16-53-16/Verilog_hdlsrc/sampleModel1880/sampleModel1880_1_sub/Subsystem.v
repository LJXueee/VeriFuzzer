// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1880\sampleModel1880_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1880_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg [15:0] cfblk135_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk135_reg_next [0:1];  // ufix16 [2]
  ...
  wire [31:0] Mysubsystem_12_out1;  // ufix32_En22
  wire signed [7:0] Mysubsystem_27_out1;  // int8
  wire signed [31:0] cfblk20_add_temp;  // sfix32
  ...
  wire signed [31:0] cfblk73_sub_temp;  // sfix32
  ...
  assign cfblk38_out1 = cfblk130_out1 + cfblk38_const_val_1;



  assign cfblk60_out1 = (cfblk38_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk152_reg_next[0] = cfblk87_out1;
  ...
  assign cfblk27_out1 = cfblk68_out1 + cfblk38_out1;
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.In1(cfblk69_out1),  // uint8
                                 .In2(cfblk131_out1),  // uint8
                                 .In3(cfblk9_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk135_process
      if (reset == 1'b1) begin
        cfblk135_reg[0] <= 16'b0000000000000000;
        cfblk135_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk135_reg_next[0] = Mysubsystem_1_out1;
  ...
  DotProduct_block1 u_cfblk103_inst (.in1(cfblk69_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk111_inst (.in1(cfblk138_out1),  // uint8
  ...
  Mysubsystem_12 u_Mysubsystem_12 (.In1(cfblk41_out1),  // uint8
                                   .Out1(Mysubsystem_12_out1)  // ufix32_En22
                                   );

  Mysubsystem_27 u_Mysubsystem_27 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_12_out1),  // ufix32_En22
                                   .Out1(Mysubsystem_27_out1)  // int8
                                   );

  assign cfblk20_1 = {{24{Mysubsystem_27_out1[7]}}, Mysubsystem_27_out1};
  assign cfblk20_2 = {24'b0, cfblk23_out1};
  assign cfblk20_add_temp = cfblk20_1 + cfblk20_2;
  assign cfblk20_out1 = cfblk20_add_temp[7:0];
  ...
  DotProduct_block2 u_cfblk106_inst (.in1(cfblk6_out1),  // uint8
  ...
  assign cfblk14_out1 = cfblk108_out1 - cfblk119_out1;



  assign cfblk30_out1 = cfblk14_out1 + cfblk152_out1;
  ...
  assign cfblk141_reg_next[0] = cfblk30_out1;
  ...
  assign cfblk73_1 = {24'b0, cfblk25_out1};
  assign cfblk73_2 = {16'b0, cfblk135_out1};
  assign cfblk73_sub_temp = cfblk73_1 - cfblk73_2;
  assign cfblk73_out1 = cfblk73_sub_temp[7:0];
  ...
  DotProduct_block u_cfblk100_inst (.in1(cfblk109_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk34_inst (.in1(cfblk5_out1),  // uint8
                                    .in2(cfblk124_out1),  // uint8
                                    .out1(cfblk34_out1)  // uint8
                                    );

  assign dtc_out_6 = cfblk75_out1;
  ...
  assign dtc_out_7 = cfblk77_out1;



  assign cfblk35_out1 = dtc_out_7;



  assign cfblk126 = cfblk35_out1;

  assign Hdl_out = cfblk22_out1;
