// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1995\sampleModel1995_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1995_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_44_out2;  // uint8
  ...
  assign cfblk62_out1 = Mysubsystem_15_out1 + cfblk161_out1;
  ...
  assign cfblk76_out1 = Mysubsystem_15_out1 + cfblk78_out1;
  ...
  assign cfblk75_out1 = cfblk3_out1 - Mysubsystem_15_out1;
  ...
  assign cfblk137_out1 = dtc_out_6;
  ...
  assign cfblk165_reg_next[0] = Mysubsystem_44_out1;
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.u(cfblk145_out1),  // uint8
                                   .y(Mysubsystem_27_out1)
                                   );

  Mysubsystem_44 u_Mysubsystem_44 (.In1(Mysubsystem_27_out1),
                                   .In2(cfblk47_out1),  // uint8
                                   .In3(cfblk52_out1),  // uint8
                                   .Out1(Mysubsystem_44_out1),  // uint16
                                   .Out2(Mysubsystem_44_out2)  // uint8
                                   );
  ...
  assign cfblk167_reg_next[0] = Mysubsystem_44_out2;
  ...
  assign dtc_out_11 = cfblk43_out1;
