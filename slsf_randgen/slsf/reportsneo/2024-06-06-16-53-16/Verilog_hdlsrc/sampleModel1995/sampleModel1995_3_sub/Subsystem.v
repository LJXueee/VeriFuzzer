// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1995\sampleModel1995_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1995_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_7_out1;  // uint16
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.Out1(Mysubsystem_16_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk121_inst (.in1(cfblk128_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk57_inst (.in1(cfblk179_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk25_inst (.in1(cfblk120_out1),  // uint8
                                    .in2(cfblk100_out1),  // uint8
                                    .out1(cfblk25_out1)  // uint8
                                    );

  assign cfblk47_out1 = Mysubsystem_16_out1 + cfblk25_out1;



  DotProduct_block u_cfblk102_inst (.in1(cfblk6_out1),  // uint8
  ...
  Mysubsystem_7 u_Mysubsystem_7 (.In1(cfblk11_out1),  // uint8
                                 .In3(cfblk63_out1),  // uint8
                                 .Out1(Mysubsystem_7_out1)  // uint16
                                 );

  Mysubsystem_49 u_Mysubsystem_49 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_7_out1),  // uint16
                                   .Out1(Mysubsystem_49_out1)  // uint8
                                   );

  assign cfblk23_out1 = Mysubsystem_49_out1 + cfblk12_out1;
  ...
  assign dtc_out_9 = cfblk138_out1;
  ...
  always @(Mysubsystem_16_out2, cfblk115_out1) begin
    cfblk128_div_temp = 9'b000000000;
    cfblk128_t_0_0 = 9'b000000000;
    if (Mysubsystem_16_out2 == 8'b00000000) begin
      cfblk128_out1 = 8'b11111111;
    end
    else begin
      cfblk128_t_0_0 = {1'b0, cfblk115_out1};
      cfblk128_div_temp = cfblk128_t_0_0 / Mysubsystem_16_out2;
