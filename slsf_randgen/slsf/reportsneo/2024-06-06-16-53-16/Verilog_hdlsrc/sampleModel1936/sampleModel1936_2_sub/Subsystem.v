// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1936\sampleModel1936_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1936_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] cfblk5_add_cast;  // ufix32_En7
  wire [31:0] cfblk5_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk5_add_temp;  // ufix32_En7
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.clk(clk),
                                   ...
                                   .Out2(Mysubsystem_13_out2)  // uint8
                                   );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_13_out2),  // uint8
                                   .Out3(Mysubsystem_32_out3)
                                   );

  Mysubsystem_37 u_Mysubsystem_37 (.In1(Mysubsystem_32_out3),
  ...
  Mysubsystem_20 u_Mysubsystem_20 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_20_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk5_add_cast = {16'b0, Mysubsystem_20_out1};
  assign cfblk5_add_cast_1 = {17'b0, {cfblk4_out1, 7'b0000000}};
  assign cfblk5_add_temp = cfblk5_add_cast + cfblk5_add_cast_1;
  assign cfblk5_out1 = cfblk5_add_temp[14:7];
  ...
  assign cfblk45_out1 = cfblk111_out1 + Mysubsystem_13_out1;
  ...
  assign dtc_out_7 = cfblk19_out1;



  assign cfblk27_out1 = dtc_out_7;
