// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1432\sampleModel1432_2_sub_sub\Subsystem_block.v
...
// Source Path: sampleModel1432_2_sub_sub/Subsystem/Subsystem
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Subsystem_block
  ...
  wire [15:0] Mysubsystem_44_out2;  // uint16
  ...
  Mysubsystem_44 u_Mysubsystem_44 (.clk(clk),
                                   ...
                                   .Out2(Mysubsystem_44_out2)  // uint16
                                   );

  Mysubsystem_45 u_Mysubsystem_45 (.In1(Mysubsystem_44_out2),  // uint16
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.In1(cfblk30_out1),  // uint8
  ...
  assign cfblk173_reg_next[0] = Mysubsystem_14_out1;
  ...
  always @(Mysubsystem_44_out1, cfblk27_out1) begin
    cfblk82_div_temp = 9'b000000000;
    cfblk82_t_0_0 = 9'b000000000;
    if (Mysubsystem_44_out1 == 8'b00000000) begin
      cfblk82_out1 = 8'b11111111;
    end
    else begin
      cfblk82_t_0_0 = {1'b0, cfblk27_out1};
      cfblk82_div_temp = cfblk82_t_0_0 / Mysubsystem_44_out1;
  ...
  cfblk151 u_cfblk151 (.In1(cfblk93_out1),  // uint8
