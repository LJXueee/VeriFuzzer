// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1432\sampleModel1432_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1432_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg  [0:1] cfblk177_reg;  // ufix1 [2]
  wire [0:1] cfblk177_reg_next;  // ufix1 [2]
  wire cfblk177_out1;
  ...
  reg [7:0] cfblk132_div_temp;  // ufix8
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_14_out2),  // uint8
                                   .In2(Mysubsystem_14_out3),  // uint8
  ...
  assign cfblk165_reg_next[0] = Mysubsystem_31_out2;
  ...
  Mysubsystem_3 u_Mysubsystem_3 (.In1(cfblk25_out1),  // uint8
  ...
  assign cfblk173_reg_next[0] = Mysubsystem_3_out1;
  ...
  DotProduct_block u_cfblk107_inst (.in1(cfblk31_out1),  // uint8
  ...
  assign cfblk177_reg_next[0] = Mysubsystem_33_out1;
  assign cfblk177_reg_next[1] = cfblk177_reg[0];



  always @(cfblk177_out1, cfblk78_out1) begin
    cfblk132_div_temp = 8'b00000000;
    if (cfblk78_out1 == 8'b00000000) begin
      cfblk132_out1 = 8'b11111111;
    end
    else begin
      cfblk132_div_temp = cfblk177_out1 / cfblk78_out1;
      cfblk132_out1 = cfblk132_div_temp;
    end
  end
  ...
  always @(Mysubsystem_14_out1, cfblk27_out1) begin
    cfblk82_div_temp = 9'b000000000;
    cfblk82_t_0_0 = 9'b000000000;
    if (Mysubsystem_14_out1 == 8'b00000000) begin
      cfblk82_out1 = 8'b11111111;
    end
    else begin
      cfblk82_t_0_0 = {1'b0, cfblk27_out1};
      cfblk82_div_temp = cfblk82_t_0_0 / Mysubsystem_14_out1;
  ...
  DotProduct_block1 u_cfblk108_inst (.in1(cfblk48_out1),  // uint8
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.In1(cfblk13_out1),  // uint8
                                   .In2(cfblk98_out1),  // uint8
                                   .Out1(Mysubsystem_31_out1),  // uint8
                                   .Out2(Mysubsystem_31_out2)  // uint8
                                   );

  Mysubsystem_4 u_Mysubsystem_4 (.In1(Mysubsystem_31_out1),  // uint8
  ...
  assign cfblk174_reg_next[0] = Mysubsystem_4_out1;
