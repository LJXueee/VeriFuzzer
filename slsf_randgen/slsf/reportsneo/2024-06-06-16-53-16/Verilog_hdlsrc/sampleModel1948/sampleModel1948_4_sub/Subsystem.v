// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1948\sampleModel1948_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1948_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  DotProduct_block u_cfblk10_inst (.in1(cfblk51_out1),  // uint8
                                   .in2(cfblk48_out1),  // uint8
  ...
  Mysubsystem_17 u_Mysubsystem_17 (.In1(cfblk139_out1),  // uint8
                                   .In2(cfblk33_out1),  // uint8
                                   .In3(cfblk141_out1),  // uint8
                                   .Out1(Mysubsystem_17_out1)  // ufix32_En15
                                   );

  Mysubsystem_1 u_Mysubsystem_1 (.In1(Mysubsystem_17_out1),  // ufix32_En15
  ...
  assign cfblk149_reg_next[0] = Mysubsystem_1_out1;
  ...
  DotProduct_block9 u_cfblk32_inst (.in1(cfblk71_out1),  // uint8
  ...
  assign cfblk118_out1 = dtc_out_3;



  DotProduct_block2 u_cfblk111_inst (.in1(cfblk118_out1),  // uint8
                                     .in2(cfblk150_out1),  // uint8
                                     .out1(cfblk111_out1)  // uint8
                                     );

  DotProduct_block6 u_cfblk139_inst (.in1(cfblk111_out1),  // uint8
  ...
  DotProduct_block10 u_cfblk47_inst (.in1(cfblk55_out1),  // uint8
                                     .in2(cfblk81_out1),  // uint8
                                     .out1(cfblk47_out1)  // uint8
                                     );

  DotProduct_block1 u_cfblk102_inst (.in1(cfblk85_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk128_inst (.in1(cfblk72_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk12_inst (.in1(cfblk121_out1),  // uint8
                                    .in2(cfblk168_out1),  // uint8
                                    .out1(cfblk12_out1)  // uint8
                                    );

  assign dtc_out_6 = cfblk12_out1;
  ...
  DotProduct_block12 u_cfblk60_inst (.in1(cfblk161_out1),  // uint8
                                     .in2(cfblk93_out1),  // uint8
                                     .out1(cfblk60_out1)  // uint8
                                     );

  DotProduct_block8 u_cfblk30_inst (.in1(cfblk62_out1),  // uint8
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk25_out1),  // uint8
  ...
  assign cfblk169_reg_next[0] = Mysubsystem_33_out1;
  ...
  DotProduct_block13 u_cfblk62_inst (.in1(cfblk119_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk28_inst (.in1(cfblk7_out1),  // uint8
  ...
  DotProduct_block11 u_cfblk58_inst (.in1(cfblk64_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk125_inst (.in1(cfblk26_out1),  // uint8
