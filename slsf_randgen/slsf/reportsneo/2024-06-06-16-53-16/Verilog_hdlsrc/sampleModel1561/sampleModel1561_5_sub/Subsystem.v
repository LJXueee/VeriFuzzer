// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1561\sampleModel1561_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1561_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [1:0] Mysubsystem_34_out1;  // sfix2
  ...
  Mysubsystem_18 u_Mysubsystem_18 (.In1(cfblk29_out1),  // uint8
                                   .Out1(Mysubsystem_18_out1)  // uint8
                                   );

  Mysubsystem_35 u_Mysubsystem_35 (.In1(Mysubsystem_18_out1),  // uint8
  ...
  assign cfblk143_reg_next[0] = Mysubsystem_35_out1;
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.u(cfblk32_out1),  // uint8
                                   .Out1(Mysubsystem_34_out1)  // sfix2
                                   );
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.In2(Mysubsystem_34_out1),  // sfix2
  ...
  assign cfblk137_reg_next[0] = Mysubsystem_21_out1;
  ...
  assign dtc_out_8 = cfblk37_out1;



  assign cfblk49_out1 = dtc_out_8;
