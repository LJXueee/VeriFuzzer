// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1652\sampleModel1652_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1652_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] dtc_out_10;  // ufix32_E4
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.y(Mysubsystem_13_out1)  // uint8
                                   );
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk138_out1),  // uint8
                                   .In2(cfblk19_out1),  // uint8
                                   .Out1(Mysubsystem_29_out1)  // uint8
                                   );

  Mysubsystem_41 u_Mysubsystem_41 (.In1(cfblk25_out1),  // uint8
                                   .In2(cfblk101_out1),  // uint8
                                   .Out1(Mysubsystem_41_out1)  // uint8
                                   );

  Mysubsystem_40 u_Mysubsystem_40 (.In1(Mysubsystem_41_out1),  // uint8
  ...
  assign cfblk150_reg_next[0] = Mysubsystem_40_out1;
  ...
  DotProduct_block u_cfblk104_inst (.in1(Mysubsystem_13_out1),  // uint8
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk99_out1),  // uint8
                                   .Out1(Mysubsystem_14_out1)  // uint8
                                   );

  assign cfblk19_out1 = Mysubsystem_14_out1 - cfblk100_out1;
  ...
  assign dtc_out_8 = cfblk99_out1;



  assign cfblk74_out1 = dtc_out_8;
  ...
  assign dtc_out_10 = {28'b0, cfblk2_out1};



  assign cfblk82_out1 = {dtc_out_10[3:0], 4'b0000};
  ...
  assign cfblk33_out1 = dtc_out_11;
  ...
  assign dtc_out_12 = cfblk125_out1;
  ...
  assign cfblk55_out1 = dtc_out_13;
  ...
  cfblk147 u_cfblk147 (.In1(Mysubsystem_12_out1),  // uint8
  ...
  assign dtc_out_14 = cfblk146_out1;



  assign cfblk123_out1 = dtc_out_14;
  ...
  assign cfblk24_out1 = (cfblk132_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
