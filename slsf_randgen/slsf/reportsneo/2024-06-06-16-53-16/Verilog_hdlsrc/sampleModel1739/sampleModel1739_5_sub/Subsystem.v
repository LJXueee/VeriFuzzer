// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1739\sampleModel1739_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1739_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_15_out1;  // ufix16_En7
  ...
  wire signed [15:0] Mysubsystem_19_out1;  // int16
  ...
  Mysubsystem_15 u_Mysubsystem_15 (.In1(cfblk43_out1),  // uint8
                                   .In2(cfblk9_out1),  // uint8
                                   .Out1(Mysubsystem_15_out1)  // ufix16_En7
                                   );
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.In1(cfblk46_out1),  // uint8
                                   .In2(cfblk73_out1),  // uint8
                                   .In3(Mysubsystem_15_out1),  // ufix16_En7
                                   .In4(cfblk6_out1),  // uint8
                                   .Out1(Mysubsystem_19_out1)  // int16
                                   );

  assign cfblk76_out1 = Mysubsystem_19_out1[7:0];
  ...
  always @(Mysubsystem_17_out1, cfblk88_out1) begin
    ...
    if (cfblk88_out1 == 8'b00000000) begin
      ...
      cfblk139_t_0_0 = {1'b0, Mysubsystem_17_out1};
  ...
  assign dtc_out_6 = cfblk116_out1;



  assign cfblk115_out1 = dtc_out_6;
  ...
  always @(cfblk117_out1, cfblk15_out1) begin
    ...
    if (cfblk15_out1 == 8'b00000000) begin
      ...
      cfblk20_div_temp = cfblk20_t_0_0 / cfblk15_out1;
