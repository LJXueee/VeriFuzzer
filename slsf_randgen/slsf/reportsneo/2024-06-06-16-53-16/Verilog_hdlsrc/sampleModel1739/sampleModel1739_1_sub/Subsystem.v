// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1739\sampleModel1739_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1739_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_37_out2;  // uint8
  ...
  assign cfblk156_reg_next[0] = Mysubsystem_38_out1;
  ...
  Mysubsystem_38 u_Mysubsystem_38 (.In1(cfblk33_out1),  // uint8
  ...
  Mysubsystem_37 u_Mysubsystem_37 (.In1(cfblk61_out1),  // uint8
                                   .In2(Mysubsystem_38_out1),  // uint8
                                   .In3(cfblk105_out1),  // uint8
                                   .Out2(Mysubsystem_37_out2)  // uint8
                                   );
  ...
  assign cfblk155_reg_next[0] = Mysubsystem_37_out2;
  ...
  always @(Mysubsystem_42_out1, cfblk88_out1) begin
    ...
    if (cfblk88_out1 == 8'b00000000) begin
      ...
      cfblk139_t_0_0 = {1'b0, Mysubsystem_42_out1};
