// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2052\sampleModel2052_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2052_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_25_out1;  // ufix16_En7
  reg [15:0] cfblk166_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk166_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk166_out1;  // ufix16_En7
  wire [31:0] cfblk136_add_cast;  // ufix32_En7
  wire [31:0] cfblk136_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk136_add_temp;  // ufix32_En7
  ...
  assign cfblk107_out1 = cfblk43_out1 - Mysubsystem_14_out1;
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.In1(Mysubsystem_36_out1),  // uint8
  ...
  assign cfblk161_reg_next[0] = Mysubsystem_4_out1;
  ...
  assign cfblk33_out1 = cfblk16_out1 - Mysubsystem_38_out1;
  ...
  always @(Mysubsystem_27_out1, cfblk46_out1) begin
    cfblk36_div_temp = 16'b0000000000000000;
    if (Mysubsystem_27_out1 == 16'b0000000000000000) begin
      cfblk36_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk36_div_temp = cfblk46_out1 / Mysubsystem_27_out1;
  ...
  assign cfblk72_out1 = cfblk171_out1 + Mysubsystem_14_out1;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk48_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk136_add_cast = {16'b0, cfblk166_out1};
  assign cfblk136_add_cast_1 = {17'b0, {cfblk100_out1, 7'b0000000}};
  assign cfblk136_add_temp = cfblk136_add_cast + cfblk136_add_cast_1;
  assign cfblk136_out1 = cfblk136_add_temp[14:7];
