// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1924\sampleModel1924_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1924_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_31_out1;  // uint16
  ...
  assign cfblk130_out1 = cfblk143_out1 + Mysubsystem_40_out1;
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.In1(cfblk35_out1),  // uint8
  ...
  assign cfblk106_out1 = dtc_out_3;



  assign dtc_out_4 = cfblk106_out1;
  ...
  assign dtc_out_7 = {28'b0, cfblk144_out1};



  assign cfblk13_out1 = {dtc_out_7[3:0], 4'b0000};
  ...
  Mysubsystem_43 u_Mysubsystem_43 (.In1(cfblk134_out1),  // uint8
  ...
  assign cfblk155_reg_next[0] = Mysubsystem_43_out1;
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.In1(cfblk70_out1),  // uint8
                                   .In2(cfblk3_out1),  // uint8
                                   .In3(Mysubsystem_9_out1),  // uint8
                                   .Out1(Mysubsystem_31_out1)  // uint16
                                   );

  Mysubsystem_41 u_Mysubsystem_41 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_31_out1),  // uint16
                                   .Out1(Mysubsystem_41_out1)  // uint8
                                   );

  DotProduct_block1 u_cfblk121_inst (.in1(Mysubsystem_41_out1),  // uint8
                                     .in2(cfblk100_out1),  // uint8
                                     .out1(cfblk121_out1)  // uint8
                                     );

  assign cfblk93_out1 = cfblk121_out1 + cfblk61_out1;



  assign Hdl_out = cfblk93_out1;
