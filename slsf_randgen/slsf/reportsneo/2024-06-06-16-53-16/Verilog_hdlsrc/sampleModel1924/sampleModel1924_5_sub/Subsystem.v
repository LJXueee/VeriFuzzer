// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1924\sampleModel1924_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1924_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk130_out1 = cfblk143_out1 + Mysubsystem_39_out1;
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.In1(cfblk1_out1),  // uint8
                                   .In2(cfblk58_out1),  // uint8
                                   .Out1(Mysubsystem_42_out1)  // uint8
                                   );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_42_out1),  // uint8
  ...
  assign cfblk155_reg_next[0] = Mysubsystem_32_out1;
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.In1(cfblk58_out1),  // uint8
  ...
  assign cfblk154_reg_next[0] = Mysubsystem_40_out1;
  ...
  DotProduct_block2 u_cfblk30_inst (.in1(cfblk38_out1),  // uint8
                                    .in2(cfblk78_out1),  // uint8
                                    .out1(cfblk30_out1)  // uint8
                                    );

  DotProduct_block3 u_cfblk35_inst (.in1(cfblk30_out1),  // uint8
                                    .in2(cfblk62_out1),  // uint8
                                    .out1(cfblk35_out1)  // uint8
                                    );

  assign cfblk48_out1 = cfblk87_out1 + cfblk35_out1;
  ...
  assign cfblk91_out1 = cfblk70_out1 + cfblk48_out1;



  DotProduct_block6 u_cfblk90_inst (.in1(cfblk91_out1),  // uint8
                                    .in2(cfblk3_out1),  // uint8
                                    .out1(cfblk90_out1)  // uint8
                                    );

  Mysubsystem_25 u_Mysubsystem_25 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk90_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // uint8
                                   );

  DotProduct_block u_cfblk121_inst (.in1(Mysubsystem_25_out1),  // uint8
  ...
  DotProduct u_cfblk109_inst (.in1(cfblk32_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk62_inst (.in1(cfblk33_out1),  // uint8
                                    .in2(cfblk26_out1),  // uint8
                                    .out1(cfblk62_out1)  // uint8
                                    );

  assign dtc_out_4 = cfblk62_out1;



  assign cfblk106_out1 = dtc_out_4;



  assign dtc_out_5 = cfblk106_out1;
  ...
  DotProduct_block1 u_cfblk27_inst (.in1(cfblk57_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk86_inst (.in1(cfblk52_out1),  // uint8
                                    .in2(cfblk159_out1),  // uint8
                                    .out1(cfblk86_out1)  // uint8
                                    );

  assign cfblk104_1 = {16'b0, Mysubsystem_41_out1};
