// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2011\sampleModel2011_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2011_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] cfblk157_reg_next [0:1];  // ufix16 [2]
  ...
  DotProduct_block5 u_cfblk26_inst (.in1(cfblk105_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk16_inst (.in1(cfblk143_out1),  // uint8
  ...
  DotProduct_block u_cfblk117_inst (.in1(cfblk73_out1),  // uint8
  ...
  assign dtc_out_5 = cfblk134_out1;
  ...
  DotProduct_block4 u_cfblk20_inst (.in1(cfblk45_out1),  // uint8
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk14_out1),  // uint8
  ...
  assign cfblk157_reg_next[0] = Mysubsystem_13_out1;
  ...
  always @(cfblk109_out1, cfblk157_out1) begin
    ...
    if (cfblk157_out1 == 16'b0000000000000000) begin
      ...
      cfblk36_div_temp = cfblk109_out1 / cfblk157_out1;
  ...
  DotProduct_block6 u_cfblk27_inst (.in1(cfblk50_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk123_inst (.in1(cfblk162_out1),  // uint8
                                     .in2(cfblk99_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk132_inst (.in1(cfblk74_out1),  // uint8
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.In1(cfblk29_out1),  // uint8
                                   .Out1(Mysubsystem_39_out1)  // uint8
                                   );

  assign Hdl_out = Mysubsystem_39_out1;
