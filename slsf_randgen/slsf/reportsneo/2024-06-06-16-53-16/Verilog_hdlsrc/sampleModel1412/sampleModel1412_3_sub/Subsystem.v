// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1412\sampleModel1412_3_sub\Subsystem.v
// Created: 2024-06-10 02:22:29
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1412_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk181_reg_next[0] = cfblk181_out1;
  ...
  assign cfblk125_out1 = cfblk116_out1 + cfblk181_out1;
  ...
  always @(cfblk181_out1, cfblk92_out1) begin
    ...
    if (cfblk92_out1 == 8'b00000000) begin
      ...
      cfblk48_t_0_0 = {1'b0, cfblk181_out1};
  ...
  DotProduct_block14 u_cfblk99_inst (.in1(cfblk53_out1),  // uint8
  ...
  assign cfblk157_reg_next[0] = cfblk91_out1;
  assign cfblk157_reg_next[1] = cfblk157_reg[0];



  always @(cfblk134_out1, cfblk157_out1) begin
    ...
    if (cfblk134_out1 == 8'b00000000) begin
      ...
      cfblk90_t_0_0 = {1'b0, cfblk157_out1};
      cfblk90_div_temp = cfblk90_t_0_0 / cfblk134_out1;
  ...
  DotProduct_block13 u_cfblk91_inst (.in1(cfblk99_out1),  // uint8
