// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1500\sampleModel1500_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1500_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_16_out2;  // uint8
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.clk(clk),
                                   ...
                                   .Out2(Mysubsystem_16_out2)  // uint8
                                   );

  cfblk7 u_cfblk7 (.clk(clk),
                   .reset(reset),
                   .enb(clk_enable),
                   .U(Mysubsystem_16_out1),  // uint8
                   .Y(cfblk7_out1)  // uint8
                   );
  ...
  DotProduct_block5 u_cfblk42_inst (.in1(cfblk155_out1),  // uint8
  ...
  DotProduct_block u_cfblk105_inst (.in1(cfblk160_out1),  // uint8
  ...
  DotProduct_block9 u_cfblk71_inst (.in1(cfblk156_out1),  // uint8
  ...
  assign cfblk32_out1 = cfblk135_out1 + cfblk32_const_val_1;
  ...
  assign cfblk17_out1 = cfblk122_out1 - cfblk32_out1;



  DotProduct_block10 u_cfblk72_inst (.in1(cfblk45_out1),  // uint8
  ...
  assign dtc_out_1 = cfblk137_out1;



  assign cfblk73_out1 = dtc_out_1;
  ...
  assign cfblk139_out1 = dtc_out_3;
  ...
  DotProduct_block8 u_cfblk62_inst (.in1(cfblk145_out1),  // uint8
  ...
  assign cfblk127_out1 = dtc_out_5;
  ...
  DotProduct_block3 u_cfblk135_inst (.in1(cfblk195_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk57_inst (.in1(cfblk82_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk44_inst (.in1(cfblk116_out1),  // uint8
  ...
  assign cfblk96_out1 = Mysubsystem_16_out2 + cfblk100_out1;
  ...
  Mysubsystem_22 u_Mysubsystem_22 (.clk(clk),
                                   ...
                                   .y(Mysubsystem_22_out1)
                                   );

  Mysubsystem_12 u_Mysubsystem_12 (.In1(Mysubsystem_22_out1),
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_12_out1),  // uint8
                                   .In2(cfblk17_out1),  // uint8
                                   .Out1(Mysubsystem_26_out1)  // uint16
                                   );

  assign cfblk195_out1 = Mysubsystem_26_out1[7:0];



  DotProduct_block2 u_cfblk129_inst (.in1(cfblk195_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk123_inst (.in1(cfblk27_out1),  // uint8
                                     .in2(cfblk6_out1),  // uint8
                                     .out1(cfblk123_out1)  // uint8
                                     );

  DotProduct_block11 u_cfblk84_inst (.in1(cfblk123_out1),  // uint8
                                     .in2(cfblk6_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk24_inst (.in1(cfblk67_out1),  // uint8
