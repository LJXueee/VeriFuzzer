// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1668\sampleModel1668_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1668_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] cfblk155_reg_next [0:1];  // ufix16 [2]
  ...
  reg [15:0] cfblk40_varargout_1;  // ufix16
  reg [15:0] cfblk40_div_temp;  // ufix16
  ...
  assign cfblk125_out1 = cfblk133_out1[7:0];
  ...
  Mysubsystem_1 u_Mysubsystem_1 (.In1(cfblk53_out1),  // uint8
                                 .In2(cfblk62_out1),  // uint8
                                 .In3(cfblk109_out1),  // uint8
                                 .In4(cfblk106_out1),  // uint8
                                 .In5(cfblk132_out1),  // uint8
  ...
  assign cfblk155_reg_next[0] = Mysubsystem_1_out1;
  ...
  assign cfblk69_out1 = cfblk101_out1 + cfblk28_out1;
  ...
  DotProduct_block1 u_cfblk14_inst (.in1(cfblk143_out1),  // uint8
  ...
  DotProduct_block u_cfblk120_inst (.in1(cfblk91_out1),  // uint8
                                    .in2(cfblk149_out1),  // uint8
                                    .out1(cfblk120_out1)  // uint8
                                    );

  always @(cfblk120_out1, cfblk155_out1) begin
    cfblk40_div_temp = 16'b0000000000000000;
    if (cfblk155_out1 == 16'b0000000000000000) begin
      cfblk40_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk40_div_temp = cfblk120_out1 / cfblk155_out1;
      cfblk40_varargout_1 = cfblk40_div_temp;
    end
    if (cfblk40_varargout_1[15:8] != 8'b00000000) begin
      cfblk40_out1 = 8'b11111111;
    end
    else begin
      cfblk40_out1 = cfblk40_varargout_1[7:0];
    end
  end
  ...
  assign dtc_out_7 = cfblk131_out1;
  ...
  assign cfblk1_out1 = cfblk163_out1 | 8'b00000001;



  assign cfblk130_out1 = cfblk1_out1 + cfblk130_const_val_1;
