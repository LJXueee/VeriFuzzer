// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1668\sampleModel1668_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1668_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg [15:0] cfblk132_div_temp;  // ufix16
  ...
  assign cfblk160_reg_next[0] = Mysubsystem_10_out1;
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk35_out1),  // uint8
                                   .u(cfblk65_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1)  // uint8
                                   );

  Mysubsystem_39 u_Mysubsystem_39 (.In1(Mysubsystem_13_out1),  // uint8
  ...
  assign cfblk164_reg_next[0] = Mysubsystem_39_out1;
  ...
  always @(cfblk116_out1, cfblk160_out1) begin
    cfblk132_div_temp = 16'b0000000000000000;
    if (cfblk160_out1 == 16'b0000000000000000) begin
      cfblk132_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk132_div_temp = cfblk116_out1 / cfblk160_out1;
      cfblk132_varargout_1 = cfblk132_div_temp;
    end
