// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1616\sampleModel1616_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1616_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_13_out1;  // ufix16_En7
  reg [15:0] cfblk169_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk169_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk169_out1;  // ufix16_En7
  ...
  wire signed [31:0] cfblk53_sub_cast;  // sfix32_En7
  wire signed [31:0] cfblk53_sub_cast_1;  // sfix32_En7
  wire signed [31:0] cfblk53_sub_temp;  // sfix32_En7
  ...
  Mysubsystem_6 u_Mysubsystem_6 (.In1(cfblk97_out1),  // uint8
  ...
  assign cfblk150_reg_next[0] = Mysubsystem_6_out1;
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk28_out1),  // uint8
                                   .In2(cfblk78_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1)  // ufix16_En7
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk169_process
      if (reset == 1'b1) begin
        cfblk169_reg[0] <= 16'b0000000000000000;
        cfblk169_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk169_reg_next[0] = Mysubsystem_13_out1;
  ...
  assign cfblk30_out1 = cfblk46_out1 + cfblk30_const_val_1;
  ...
  assign cfblk53_sub_cast = {17'b0, {cfblk115_out1, 7'b0000000}};
  assign cfblk53_sub_cast_1 = {16'b0, cfblk169_out1};
  assign cfblk53_sub_temp = cfblk53_sub_cast - cfblk53_sub_cast_1;
  assign cfblk53_out1 = cfblk53_sub_temp[14:7];
  ...
  assign dtc_out_6 = cfblk103_out1;



  assign cfblk82_out1 = dtc_out_6;
  ...
  assign dtc_out_9 = cfblk122_out1;
