// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1777\sampleModel1777_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1777_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [7:0] Mysubsystem_46_out1;  // int8
  ...
  wire signed [15:0] Mysubsystem_29_out1;  // int16
  reg signed [15:0] cfblk156_reg [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk156_reg_next [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk156_out1;  // int16
  ...
  Mysubsystem_15 u_Mysubsystem_15 (.Out1(Mysubsystem_15_out1)  // uint8
                                   );
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk110_out1),  // uint8
                                   .Y(Mysubsystem_42_out1)
                                   );

  Mysubsystem_46 u_Mysubsystem_46 (.In1(Mysubsystem_42_out1),
                                   .Out1(Mysubsystem_46_out1)  // int8
                                   );
  ...
  assign cfblk12_2 = {{24{Mysubsystem_46_out1[7]}}, Mysubsystem_46_out1};
  assign cfblk12_sub_temp = cfblk12_1 - cfblk12_2;
  assign cfblk12_out1 = cfblk12_sub_temp[7:0];
  ...
  DotProduct_block5 u_cfblk64_inst (.in1(Mysubsystem_18_out1),  // uint8
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk37_out1),  // uint8
                                   .In2(cfblk126_out1),  // uint8
                                   .Out1(Mysubsystem_29_out1)  // int16
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk156_process
      if (reset == 1'b1) begin
        cfblk156_reg[0] <= 16'sb0000000000000000;
        cfblk156_reg[1] <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk156_reg_next[0] = Mysubsystem_29_out1;
  assign cfblk156_reg_next[1] = cfblk156_reg[0];



  assign switch_compare_1 = cfblk156_out1 >= 16'sb0000000000000000;



  assign cfblk146_out1 = (switch_compare_1 == 1'b0 ? cfblk88_out1 :
              cfblk55_out1);
  ...
  assign cfblk127_out1 = dtc_out_6;
  ...
  assign cfblk35_out1 = cfblk155_out1 + cfblk146_out1;
  ...
  assign cfblk128_out1 = dtc_out_8;
