// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1811\sampleModel1811_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1811_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire cfblk3_relop1;
  wire signed [7:0] Mysubsystem_24_out2;  // sfix8_E1
  wire signed [31:0] cfblk65_add_cast;  // sfix32
  wire signed [31:0] cfblk65_add_temp;  // sfix32
  wire signed [31:0] cfblk65_1;  // sfix32
  ...
  wire [7:0] Mysubsystem_25_out2;  // uint8
  ...
  wire signed [7:0] Mysubsystem_24_out1;  // sfix8_E1
  wire signed [31:0] cfblk14_sub_cast;  // sfix32
  ...
  always @(Mysubsystem_24_out3, cfblk24_out1) begin
    cfblk89_div_temp = 9'b000000000;
    cfblk89_t_0_0 = 9'b000000000;
    if (Mysubsystem_24_out3 == 1'b0) begin
      cfblk89_out1 = 8'b11111111;
    end
    else begin
      cfblk89_t_0_0 = {1'b0, cfblk24_out1};
      cfblk89_div_temp = cfblk89_t_0_0 / Mysubsystem_24_out3;
  ...
  assign cfblk65_add_cast = {{23{Mysubsystem_24_out2[7]}}, {Mysubsystem_24_out2, 1'b0}};
  assign cfblk65_1 = {31'b0, cfblk3_relop1};
  assign cfblk65_add_temp = cfblk65_1 + cfblk65_add_cast;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk16_out1),  // uint8
                                   .In2(cfblk91_out1),  // uint8
                                   .Out2(Mysubsystem_25_out2)  // uint8
                                   );
  ...
  assign cfblk141_reg_next[0] = Mysubsystem_25_out2;
  ...
  DotProduct_block3 u_cfblk26_inst (.in1(Mysubsystem_28_out1),  // uint8
  ...
  Mysubsystem_24 u_Mysubsystem_24 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk42_out1),  // uint8
                                   .In2(cfblk83_out1),  // uint8
                                   .In3(cfblk76_out1),  // uint8
                                   .Out1(Mysubsystem_24_out1),  // sfix8_E1
                                   .Out2(Mysubsystem_24_out2),  // sfix8_E1
                                   .Y(Mysubsystem_24_out3)
                                   );

  assign cfblk14_sub_cast = {{23{Mysubsystem_24_out1[7]}}, {Mysubsystem_24_out1, 1'b0}};
  assign cfblk14_1 = {24'b0, cfblk150_out1};
  assign cfblk14_sub_temp = cfblk14_sub_cast - cfblk14_1;
