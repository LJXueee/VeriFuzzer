// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1401\sampleModel1401_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1401_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_40_out2;  // ufix16_En7
  wire [31:0] cfblk62_add_cast;  // ufix32_En7
  wire [31:0] cfblk62_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk62_add_temp;  // ufix32_En7
  ...
  wire [15:0] Mysubsystem_40_out1;  // ufix16_En7
  wire [16:0] cfblk49_y;  // ufix17_En7
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.In1(Mysubsystem_42_out1),  // uint8
  ...
  assign cfblk145_out1 = Mysubsystem_19_out1 + cfblk145_const_val_1;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk31_out1),  // uint8
  ...
  assign cfblk164_reg_next[0] = Mysubsystem_25_out1;
  ...
  assign cfblk109_out1 = cfblk49_out1 - cfblk149_out1;
  ...
  Mysubsystem_7 u_Mysubsystem_7 (.In1(cfblk151_out1),  // uint8
  ...
  assign cfblk181_reg_next[0] = Mysubsystem_7_out1;
  ...
  assign cfblk62_add_cast = {17'b0, {cfblk171_out1, 7'b0000000}};
  assign cfblk62_add_cast_1 = {16'b0, Mysubsystem_40_out2};
  assign cfblk62_add_temp = cfblk62_add_cast + cfblk62_add_cast_1;
  assign cfblk62_out1 = cfblk62_add_temp[14:7];
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.clk(clk),
                                   ...
                                   .Out1(Mysubsystem_40_out1),  // ufix16_En7
                                   .Out2(Mysubsystem_40_out2)  // ufix16_En7
                                   );

  assign cfblk49_y = {1'b0, Mysubsystem_40_out1};
  assign cfblk49_out1 = cfblk49_y[14:7];



  assign cfblk87_out1 = cfblk49_out1 - cfblk79_out1;
  ...
  assign cfblk121_out1 = dtc_out_5;
  ...
  always @(Mysubsystem_19_out1, cfblk115_out1) begin
    cfblk53_div_temp = 9'b000000000;
    cfblk53_t_0_0 = 9'b000000000;
    if (Mysubsystem_19_out1 == 8'b00000000) begin
      cfblk53_out1 = 8'b11111111;
    end
    else begin
      cfblk53_t_0_0 = {1'b0, cfblk115_out1};
      cfblk53_div_temp = cfblk53_t_0_0 / Mysubsystem_19_out1;
  ...
  assign dtc_out_8 = cfblk53_out1;



  assign cfblk68_out1 = dtc_out_8;
