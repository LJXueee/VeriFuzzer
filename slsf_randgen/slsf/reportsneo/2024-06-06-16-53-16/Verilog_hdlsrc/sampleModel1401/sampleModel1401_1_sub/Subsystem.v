// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1401\sampleModel1401_1_sub\Subsystem.v
// Created: 2024-08-12 00:52:05
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1401_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk145_out1 = Mysubsystem_22_out1 + cfblk145_const_val_1;
  ...
  always @(Mysubsystem_22_out1, cfblk115_out1) begin
    cfblk53_div_temp = 9'b000000000;
    cfblk53_t_0_0 = 9'b000000000;
    if (Mysubsystem_22_out1 == 8'b00000000) begin
      cfblk53_out1 = 8'b11111111;
    end
    else begin
      cfblk53_t_0_0 = {1'b0, cfblk115_out1};
      cfblk53_div_temp = cfblk53_t_0_0 / Mysubsystem_22_out1;
  ...
  Mysubsystem_3 u_Mysubsystem_3 (.In1(cfblk10_out1),  // uint8
                                 .cfblk154(Mysubsystem_3_out1)  // uint8
                                 );

  assign cfblk154 = Mysubsystem_3_out1;
