// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1401\sampleModel1401_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1401_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk145_out1 = Mysubsystem_38_out1 + cfblk145_const_val_1;
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk25_out1),  // uint8
  ...
  assign cfblk180_reg_next[0] = Mysubsystem_29_out1;
  ...
  assign cfblk28_2 = {31'b0, Mysubsystem_40_out1};
  ...
  always @(Mysubsystem_38_out1, cfblk115_out1) begin
    ...
    if (Mysubsystem_38_out1 == 8'b00000000) begin
      ...
      cfblk53_div_temp = cfblk53_t_0_0 / Mysubsystem_38_out1;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk10_out1),  // uint8
                                   .cfblk154(Mysubsystem_25_out1)  // uint8
                                   );

  assign cfblk154 = Mysubsystem_25_out1;
