// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1504\sampleModel1504_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1504_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_39_out2;  // uint8
  ...
  wire [15:0] Mysubsystem_48_out1;  // uint16
  reg [15:0] cfblk172_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk172_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk172_out1;  // uint16
  wire [31:0] cfblk98_add_temp;  // ufix32
  wire [31:0] cfblk98_1;  // ufix32
  wire [31:0] cfblk98_2;  // ufix32
  ...
  wire signed [7:0] cfblk23_out1;  // int8
  ...
  reg signed [7:0] cfblk128_varargout_1;  // sfix8
  reg signed [8:0] cfblk128_div_temp;  // sfix9
  reg signed [8:0] cfblk128_t_0_0;  // sfix9
  reg signed [8:0] cfblk128_t_1;  // sfix9
  ...
  assign cfblk82_out1 = Mysubsystem_39_out2 + cfblk65_out1;
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.In1(cfblk121_out1),  // uint8
                                   .Out1(Mysubsystem_19_out1)  // uint8
                                   );

  Mysubsystem_48 u_Mysubsystem_48 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_19_out1),  // uint8
                                   .Out1(Mysubsystem_48_out1)  // uint16
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk172_process
      if (reset == 1'b1) begin
        cfblk172_reg[0] <= 16'b0000000000000000;
        cfblk172_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk172_reg_next[0] = Mysubsystem_48_out1;
  assign cfblk172_reg_next[1] = cfblk172_reg[0];



  assign cfblk98_1 = {16'b0, cfblk172_out1};
  assign cfblk98_2 = {24'b0, cfblk21_out1};
  assign cfblk98_add_temp = cfblk98_1 + cfblk98_2;
  assign cfblk98_out1 = cfblk98_add_temp[7:0];
  ...
  assign cfblk121_out1 = cfblk113_out1 + Mysubsystem_39_out1;
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk6_out1),  // uint8
                                   .Y(Mysubsystem_13_out1)
                                   );

  assign cfblk23_out1 = (Mysubsystem_13_out1 > 1'b0 ? 8'sb00000001 :
              8'sb00000000);



  always @(cfblk184_out1, cfblk23_out1) begin
    cfblk128_div_temp = 9'sb000000000;
    cfblk128_t_0_0 = 9'sb000000000;
    cfblk128_t_1 = 9'sb000000000;
    if (cfblk184_out1 == 8'b00000000) begin
      if (cfblk23_out1 < 8'sb00000000) begin
        cfblk128_varargout_1 = 8'sb10000000;
      end
      else begin
        cfblk128_varargout_1 = 8'sb01111111;
      end
    end
    else begin
      cfblk128_t_0_0 = {cfblk23_out1[7], cfblk23_out1};
      cfblk128_t_1 = {1'b0, cfblk184_out1};
      cfblk128_div_temp = cfblk128_t_0_0 / cfblk128_t_1;
      if ((cfblk128_div_temp[8] == 1'b0) && (cfblk128_div_temp[7] != 1'b0)) begin
        cfblk128_varargout_1 = 8'sb01111111;
      end
      else if ((cfblk128_div_temp[8] == 1'b1) && (cfblk128_div_temp[7] != 1'b1)) begin
        cfblk128_varargout_1 = 8'sb10000000;
      end
      else begin
        cfblk128_varargout_1 = cfblk128_div_temp[7:0];
      end
    end
    if (cfblk128_varargout_1[7] == 1'b1) begin
      cfblk128_out1 = 8'b00000000;
    end
    else begin
      cfblk128_out1 = cfblk128_varargout_1;
    end
  end
  ...
  Mysubsystem_44 u_Mysubsystem_44 (.In1(cfblk123_out1),  // uint8
                                   .cfblk158(Mysubsystem_44_out1)  // uint8
                                   );

  assign cfblk158 = Mysubsystem_44_out1;
