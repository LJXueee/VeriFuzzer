// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1933\sampleModel1933_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1933_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_9_out1;  // uint16
  ...
  wire [15:0] Mysubsystem_13_out1;  // uint16
  reg [15:0] cfblk150_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk150_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk150_out1;  // uint16
  wire signed [31:0] cfblk9_sub_temp;  // sfix32
  wire signed [31:0] cfblk9_1;  // sfix32
  wire signed [31:0] cfblk9_2;  // sfix32
  ...
  wire Mysubsystem_39_out1;
  wire [31:0] cfblk57_add_temp;  // ufix32
  wire [31:0] cfblk57_1;  // ufix32
  wire [31:0] cfblk57_2;  // ufix32
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.Out1(Mysubsystem_45_out1)  // uint8
                                   );
  ...
  Mysubsystem_24 u_Mysubsystem_24 (.In1(cfblk86_out1),  // uint8
  ...
  assign cfblk162_reg_next[0] = Mysubsystem_24_out1;
  ...
  DotProduct_block1 u_cfblk113_inst (.in1(cfblk44_out1),  // uint8
  ...
  assign cfblk128_out1 = cfblk107_out1 + cfblk104_out1;
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.In1(cfblk2_out1),  // uint8
                                   .In2(cfblk8_out1),  // uint8
                                   .Out1(Mysubsystem_34_out1)  // uint8
                                   );

  Mysubsystem_9 u_Mysubsystem_9 (.In1(Mysubsystem_34_out1),  // uint8
                                 .In2(cfblk110_out1),  // uint8
                                 .Out1(Mysubsystem_9_out1)  // uint16
                                 );

  Mysubsystem_33 u_Mysubsystem_33 (.In1(Mysubsystem_9_out1),  // uint16
  ...
  assign cfblk158_reg_next[0] = Mysubsystem_33_out1;
  ...
  DotProduct_block3 u_cfblk16_inst (.in1(cfblk105_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk119_inst (.in1(cfblk60_out1),  // uint8
                                     .in2(cfblk31_out1),  // uint8
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.In1(cfblk65_out1),  // uint8
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk79_out1),  // uint8
                                   .In2(Mysubsystem_30_out1),  // uint8
                                   .In3(cfblk41_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1)  // uint16
                                   );
  ...
  assign cfblk150_reg_next[0] = Mysubsystem_13_out1;
  assign cfblk150_reg_next[1] = cfblk150_reg[0];



  assign cfblk9_1 = {16'b0, cfblk150_out1};
  assign cfblk9_2 = {24'b0, cfblk10_out1};
  assign cfblk9_sub_temp = cfblk9_1 - cfblk9_2;
  assign cfblk9_out1 = cfblk9_sub_temp[7:0];
  ...
  always @(cfblk53_out1, cfblk83_out1) begin
    ...
    if (cfblk53_out1 == 8'b00000000) begin
      ...
      cfblk25_t_0_0 = {1'b0, cfblk83_out1};
      cfblk25_div_temp = cfblk25_t_0_0 / cfblk53_out1;
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.clk(clk),
                                   ...
                                   .Y(Mysubsystem_39_out1)
                                   );

  assign cfblk57_1 = {31'b0, Mysubsystem_39_out1};
  assign cfblk57_2 = {24'b0, cfblk159_out1};
  assign cfblk57_add_temp = cfblk57_1 + cfblk57_2;
  assign cfblk57_out1 = cfblk57_add_temp[7:0];
  ...
  assign cfblk103_out1 = Mysubsystem_45_out1 + cfblk117_out1;
  ...
  assign dtc_out_2 = cfblk134_out1;
