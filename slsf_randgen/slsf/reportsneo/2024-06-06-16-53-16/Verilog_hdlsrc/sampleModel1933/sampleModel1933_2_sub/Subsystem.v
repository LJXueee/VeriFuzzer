// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1933\sampleModel1933_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1933_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  DotProduct_block u_cfblk113_inst (.in1(cfblk44_out1),  // uint8
  ...
  Mysubsystem_20 u_Mysubsystem_20 (.In1(cfblk8_out1),  // uint8
                                   .In2(cfblk2_out1),  // uint8
                                   .In3(cfblk23_out1),  // uint8
                                   .Out1(Mysubsystem_20_out1)  // uint16
                                   );

  Mysubsystem_35 u_Mysubsystem_35 (.In1(Mysubsystem_20_out1),  // uint16
  ...
  DotProduct_block2 u_cfblk120_inst (.in1(cfblk79_out1),  // uint8
  ...
  Mysubsystem_38 u_Mysubsystem_38 (.clk(clk),
                                   ...
                                   .Y(Mysubsystem_38_out1)
                                   );

  assign cfblk57_1 = {31'b0, Mysubsystem_38_out1};
  ...
  assign cfblk103_out1 = cfblk141_out1 + cfblk117_out1;
  ...
  assign dtc_out_3 = cfblk134_out1;
  ...
  DotProduct_block1 u_cfblk119_inst (.in1(cfblk60_out1),  // uint8
                                     .in2(cfblk31_out1),  // uint8
