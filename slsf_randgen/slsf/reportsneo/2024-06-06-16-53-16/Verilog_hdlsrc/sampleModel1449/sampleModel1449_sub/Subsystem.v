// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1449\sampleModel1449_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1449_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  always @(cfblk139_out1, cfblk74_out1) begin
    cfblk120_div_temp = 16'b0000000000000000;
    if (cfblk139_out1 == 16'b0000000000000000) begin
      cfblk120_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk120_div_temp = cfblk74_out1 / cfblk139_out1;
  ...
  assign cfblk132_out1 = cfblk72_out1 + cfblk132_const_val_1;
  ...
  assign cfblk163_reg_next[0] = cfblk132_out1;
  ...
  assign cfblk91_out1 = cfblk54_out1 + cfblk163_out1;
  ...
  assign cfblk127_out1 = cfblk141_out1 + cfblk167_out1;
