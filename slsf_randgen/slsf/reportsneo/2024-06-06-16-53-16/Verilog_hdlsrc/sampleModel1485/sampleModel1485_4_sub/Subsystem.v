// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1485\sampleModel1485_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1485_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_19_out3;  // uint8
  ...
  Mysubsystem_18 u_Mysubsystem_18 (.In3(cfblk50_out1),  // uint8
                                   .In5(cfblk33_out1),  // uint8
  ...
  assign cfblk171_reg_next[0] = Mysubsystem_18_out1;
  ...
  assign cfblk29_out1 = cfblk22_out1 + Mysubsystem_19_out2;
  ...
  assign cfblk43_out1 = Mysubsystem_19_out1 + cfblk69_out1;
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk41_out1),  // uint8
                                   .In2(Mysubsystem_13_out1),  // uint8
                                   .Out1(Mysubsystem_14_out1)  // uint8
                                   );

  assign cfblk107_out1 = Mysubsystem_14_out1 + cfblk107_const_val_1;
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.clk(clk),
                                   ...
                                   .y(Mysubsystem_40_out1)  // uint8
                                   );

  Mysubsystem_19 u_Mysubsystem_19 (.In1(Mysubsystem_40_out1),  // uint8
                                   .Out1(Mysubsystem_19_out1),  // uint8
                                   .Out2(Mysubsystem_19_out2),  // uint8
                                   .Out3(Mysubsystem_19_out3)  // uint8
                                   );

  assign cfblk66_out1 = Mysubsystem_19_out1 + cfblk15_out1;
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.In1(cfblk32_out1),  // uint8
                                   .In2(cfblk52_out1),  // uint8
                                   .cfblk152(Mysubsystem_45_out1)  // uint8
                                   );

  assign cfblk152 = Mysubsystem_45_out1;
