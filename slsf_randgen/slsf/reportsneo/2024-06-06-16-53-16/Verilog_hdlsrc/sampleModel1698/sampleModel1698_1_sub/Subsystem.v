// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1698\sampleModel1698_1_sub\Subsystem.v
// Created: 2024-08-13 17:34:52
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1698_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  DotProduct_block6 u_cfblk57_inst (.in1(cfblk153_out1),  // uint8
  ...
  assign cfblk154_reg_next[0] = cfblk72_out1;
  ...
  assign cfblk18_out1 = cfblk1_out1 + cfblk155_out1;
  ...
  DotProduct_block10 u_cfblk77_inst (.in1(cfblk123_out1),  // uint8
  ...
  DotProduct_block12 u_cfblk95_inst (.in1(cfblk13_out1),  // uint8
  ...
  DotProduct_block9 u_cfblk76_inst (.in1(cfblk31_out1),  // uint8
  ...
  DotProduct_block11 u_cfblk80_inst (.in1(cfblk50_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk59_inst (.in1(cfblk62_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk75_inst (.in1(cfblk2_out1),  // uint8
                                    .in2(cfblk1_out1),  // uint8
                                    .out1(cfblk75_out1)  // uint8
                                    );

  assign cfblk103_out1 = cfblk49_out1 + cfblk75_out1;



  assign cfblk107_out1 = cfblk103_out1 + cfblk85_out1;
  ...
  assign cfblk139_reg_next[0] = cfblk4_out1;
  ...
  assign cfblk136_reg_next[0] = cfblk107_out1;
  assign cfblk136_reg_next[1] = cfblk136_reg[0];



  assign cfblk106_out1 = cfblk139_out1 + cfblk82_out1;
  ...
  always @(cfblk136_out1, cfblk46_out1) begin
    ...
    if (cfblk46_out1 == 8'b00000000) begin
      ...
      cfblk34_t_0_0 = {1'b0, cfblk136_out1};
      cfblk34_div_temp = cfblk34_t_0_0 / cfblk46_out1;
  ...
  DotProduct_block5 u_cfblk56_inst (.in1(cfblk34_out1),  // uint8
