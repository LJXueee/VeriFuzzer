// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1468\sampleModel1468_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1468_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_27_out2;  // uint8
  ...
  wire [15:0] cfblk153_reg_next [0:1];  // ufix16 [2]
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.clk(clk),
                                   ...
                                   .Out2(Mysubsystem_27_out2)  // uint8
                                   );
  ...
  assign cfblk14_out1 = Mysubsystem_27_out2 - cfblk133_out1;
  ...
  always @(Mysubsystem_27_out2, cfblk70_out1) begin
    cfblk123_div_temp = 9'b000000000;
    cfblk123_t_0_0 = 9'b000000000;
    if (Mysubsystem_27_out2 == 8'b00000000) begin
      cfblk123_out1 = 8'b11111111;
    end
    else begin
      cfblk123_t_0_0 = {1'b0, cfblk70_out1};
      cfblk123_div_temp = cfblk123_t_0_0 / Mysubsystem_27_out2;
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk11_out1),  // uint8
                                   .In2(Mysubsystem_34_out1),  // uint16
                                   .In3(cfblk24_out1),  // uint8
  ...
  assign cfblk153_reg_next[0] = Mysubsystem_33_out1;
  ...
  assign cfblk77_out1 = cfblk93_out1 + Mysubsystem_27_out2;
  ...
  DotProduct_block3 u_cfblk79_inst (.in1(cfblk12_out1),  // uint8
                                    .in2(cfblk78_out1),  // uint8
  ...
  assign cfblk51_out1 = Mysubsystem_27_out1 + cfblk145_out1;
  ...
  DotProduct_block1 u_cfblk63_inst (.in1(cfblk122_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk66_inst (.in1(cfblk91_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk82_inst (.in1(cfblk58_out1),  // uint8
  ...
  DotProduct_block u_cfblk120_inst (.in1(cfblk159_out1),  // uint8
  ...
  assign cfblk42_1 = {24'b0, cfblk88_out1};
  assign cfblk42_2 = {16'b0, cfblk153_out1};
