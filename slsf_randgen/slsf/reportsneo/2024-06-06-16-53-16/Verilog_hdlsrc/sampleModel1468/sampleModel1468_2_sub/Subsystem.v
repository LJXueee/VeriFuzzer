// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1468\sampleModel1468_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1468_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg [15:0] cfblk109_varargout_1;  // ufix16
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(Mysubsystem_18_out1),
  ...
  assign cfblk14_out1 = Mysubsystem_29_out2 - cfblk133_out1;
  ...
  always @(Mysubsystem_29_out2, cfblk70_out1) begin
    cfblk123_div_temp = 9'b000000000;
    cfblk123_t_0_0 = 9'b000000000;
    if (Mysubsystem_29_out2 == 8'b00000000) begin
      cfblk123_out1 = 8'b11111111;
    end
    else begin
      cfblk123_t_0_0 = {1'b0, cfblk70_out1};
      cfblk123_div_temp = cfblk123_t_0_0 / Mysubsystem_29_out2;
  ...
  assign cfblk77_out1 = cfblk93_out1 + Mysubsystem_29_out2;
  ...
  always @(Mysubsystem_36_out1, cfblk90_out1) begin
    cfblk109_div_temp = 17'b00000000000000000;
    cfblk109_t_0_0 = 17'b00000000000000000;
    if (cfblk90_out1 == 8'b00000000) begin
      cfblk109_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk109_t_0_0 = {1'b0, Mysubsystem_36_out1};
      cfblk109_div_temp = cfblk109_t_0_0 / cfblk90_out1;
      if (cfblk109_div_temp[16] != 1'b0) begin
        cfblk109_varargout_1 = 16'b1111111111111111;
      end
      else begin
        cfblk109_varargout_1 = cfblk109_div_temp[15:0];
      end
    end
    if (cfblk109_varargout_1[15:8] != 8'b00000000) begin
      cfblk109_out1 = 8'b11111111;
    end
    else begin
      cfblk109_out1 = cfblk109_varargout_1[7:0];
    end
  end
  ...
  assign cfblk51_out1 = Mysubsystem_29_out1 + cfblk145_out1;
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk49_out1),  // uint8
                                   .Out1(Mysubsystem_41_out1)  // uint8
                                   );

  assign cfblk58_out1 = Mysubsystem_41_out1 + cfblk13_out1;
