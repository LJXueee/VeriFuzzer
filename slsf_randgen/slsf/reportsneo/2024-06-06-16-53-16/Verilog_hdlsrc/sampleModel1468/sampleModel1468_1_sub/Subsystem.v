// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1468\sampleModel1468_1_sub\Subsystem.v
// Created: 2024-08-12 07:45:43
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1468_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_29_out1;  // uint16
  ...
  assign cfblk171_out1 = {7'b0, Mysubsystem_11_out1};
  ...
  assign cfblk14_out1 = cfblk171_out1 - cfblk133_out1;
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_29_out1)  // uint16
                                   );

  assign cfblk115_out1 = Mysubsystem_29_out1[7:0];
  ...
  always @(cfblk171_out1, cfblk70_out1) begin
    ...
    if (cfblk171_out1 == 8'b00000000) begin
      ...
      cfblk123_div_temp = cfblk123_t_0_0 / cfblk171_out1;
  ...
  assign cfblk77_out1 = cfblk93_out1 + cfblk171_out1;
  ...
  assign cfblk11_out1 = Mysubsystem_21_out1 + cfblk128_out1;
  ...
  assign cfblk51_out1 = cfblk171_out1 + cfblk145_out1;
