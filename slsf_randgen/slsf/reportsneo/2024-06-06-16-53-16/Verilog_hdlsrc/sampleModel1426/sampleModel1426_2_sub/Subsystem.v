// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1426\sampleModel1426_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1426_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .y(Mysubsystem_34_out1)
                                   );

  assign cfblk15_out1 = {7'b0, Mysubsystem_34_out1};
  ...
  assign cfblk94_out1 = cfblk64_out1 - Mysubsystem_41_out1;
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.In1(cfblk89_out1),  // uint8
  ...
  assign cfblk154_reg_next[0] = Mysubsystem_39_out1;
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.In1(cfblk55_out1),  // uint8
  ...
  assign cfblk151_reg_next[0] = Mysubsystem_16_out1;
  ...
  assign cfblk134_out1 = dtc_out_5;
