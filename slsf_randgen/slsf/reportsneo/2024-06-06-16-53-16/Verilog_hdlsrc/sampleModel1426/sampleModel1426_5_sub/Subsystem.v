// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1426\sampleModel1426_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1426_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire cfblk1_relop1;
  wire signed [7:0] cfblk38_out1;  // int8
  wire signed [31:0] cfblk110_add_temp;  // sfix32
  wire signed [31:0] cfblk110_1;  // sfix32
  wire signed [31:0] cfblk110_2;  // sfix32
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_13_out1)
                                   );

  assign cfblk15_out1 = {7'b0, Mysubsystem_13_out1};
  ...
  DotProduct_block5 u_cfblk87_inst (.in1(cfblk118_out1),  // uint8
  ...
  assign cfblk109_out1 = cfblk44_out1[7:0];
  ...
  DotProduct_block u_cfblk111_inst (.in1(cfblk142_out1),  // uint8
  ...
  assign dtc_out_4 = cfblk143_out1;



  assign cfblk49_out1 = dtc_out_4;
  ...
  DotProduct_block3 u_cfblk64_inst (.in1(cfblk56_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk27_inst (.in1(cfblk155_out1),  // uint8
                                    .in2(cfblk93_out1),  // uint8
                                    .out1(cfblk27_out1)  // uint8
                                    );

  DotProduct_block4 u_cfblk65_inst (.in1(cfblk85_out1),  // uint8
  ...
  DotProduct_block1 u_cfblk119_inst (.in1(cfblk117_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk59_out1;
  ...
  assign dtc_out_11 = cfblk46_out1;
  ...
  assign cfblk71_out1 = cfblk86_out1 + cfblk96_out1;
  ...
  assign cfblk33_out1 = cfblk64_out1 + cfblk33_const_val_1;
  ...
  assign cfblk14_out1 = cfblk7_out1 + cfblk14_const_val_1;



  assign cfblk57_out1 = cfblk14_out1 - cfblk64_out1;



  assign dtc_out_12 = cfblk109_out1;
  ...
  always @(cfblk138_out1, cfblk71_out1) begin
    ...
    if (cfblk71_out1 == 8'b00000000) begin
      ...
      cfblk68_t_0_0 = {1'b0, cfblk138_out1};
      cfblk68_div_temp = cfblk68_t_0_0 / cfblk71_out1;
  ...
  assign cfblk18_out1 = cfblk54_out1 - cfblk57_out1;
  ...
  assign cfblk147_reg_next[0] = cfblk18_out1;
  assign cfblk147_reg_next[1] = cfblk147_reg[0];



  assign cfblk1_relop1 = cfblk147_out1 <= cfblk60_out1;



  assign cfblk38_out1 = (cfblk1_relop1 > 1'b0 ? 8'sb00000001 :
              8'sb00000000);



  assign cfblk110_1 = {24'b0, cfblk80_out1};
  assign cfblk110_2 = {{24{cfblk38_out1[7]}}, cfblk38_out1};
  assign cfblk110_add_temp = cfblk110_1 + cfblk110_2;
  assign cfblk110_out1 = cfblk110_add_temp[7:0];



  DotProduct u_cfblk104_inst (.in1(cfblk110_out1),  // uint8
                              .in2(cfblk100_out1),  // uint8
                              .out1(cfblk104_out1)  // uint8
                              );

  assign dtc_out_13 = cfblk104_out1;



  assign cfblk125_out1 = dtc_out_13;



  assign dtc_out_14 = cfblk125_out1;



  assign cfblk73_out1 = dtc_out_14;



  assign cfblk81_out1 = cfblk73_out1 + cfblk81_const_val_1;



  assign cfblk92_out1 = (cfblk81_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk20_out1 = cfblk92_out1 + cfblk87_out1;



  assign cfblk128_out1 = cfblk2_out1 + cfblk20_out1;



  assign cfblk54_out1 = cfblk68_out1 + cfblk128_out1;
