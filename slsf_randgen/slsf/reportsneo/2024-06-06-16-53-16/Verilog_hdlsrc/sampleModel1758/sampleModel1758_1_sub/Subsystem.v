// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1758\sampleModel1758_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1758_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.Out1(Mysubsystem_39_out1)  // uint8
                                   );
  ...
  always @(Mysubsystem_10_out2, cfblk127_out1) begin
    cfblk73_div_temp = 9'b000000000;
    cfblk73_t_0_0 = 9'b000000000;
    if (Mysubsystem_10_out2 == 8'b00000000) begin
      cfblk73_out1 = 8'b11111111;
    end
    else begin
      cfblk73_t_0_0 = {1'b0, cfblk127_out1};
      cfblk73_div_temp = cfblk73_t_0_0 / Mysubsystem_10_out2;
  ...
  assign dtc_out_6 = cfblk148_out1;
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk97_out1),  // uint8
                                   .In2(cfblk100_out1),  // uint8
                                   .In3(Mysubsystem_39_out1),  // uint8
                                   .In4(Mysubsystem_21_out1),  // uint8
                                   .Out1(Mysubsystem_10_out1),  // uint8
                                   .Out2(Mysubsystem_10_out2)  // uint8
                                   );

  DotProduct_block14 u_cfblk94_inst (.in1(Mysubsystem_10_out2),  // uint8
