// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1758\sampleModel1758_5_sub\Subsystem.v
// Created: 2024-08-14 04:18:59
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1758_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire Mysubsystem_38_out1_is_not0;
  ...
  wire [15:0] Mysubsystem_45_out1;  // ufix16_En7
  reg [15:0] cfblk177_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk177_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk177_out1;  // ufix16_En7
  wire [7:0] cfblk164_out1;  // uint8
  wire [31:0] cfblk88_add_cast;  // ufix32_En7
  wire [31:0] cfblk88_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk88_add_temp;  // ufix32_En7
  ...
  assign Mysubsystem_38_out1_is_not0 = Mysubsystem_38_out1 != 8'b00000000;
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.In1(cfblk50_out1),  // uint8
                                   .In2(cfblk85_out1),  // uint8
                                   .Out1(Mysubsystem_45_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk177_reg_next[0] = Mysubsystem_45_out1;
  assign cfblk177_reg_next[1] = cfblk177_reg[0];



  assign cfblk88_add_cast = {16'b0, cfblk177_out1};
  assign cfblk88_add_cast_1 = {17'b0, {cfblk164_out1, 7'b0000000}};
  assign cfblk88_add_temp = cfblk88_add_cast + cfblk88_add_cast_1;
  assign cfblk88_out1 = cfblk88_add_temp[14:7];
  ...
  always @(cfblk160_out1, cfblk89_out1) begin
    ...
    if (cfblk89_out1 == 8'b00000000) begin
      ...
      cfblk70_t_0_0 = {1'b0, cfblk160_out1};
      cfblk70_div_temp = cfblk70_t_0_0 / cfblk89_out1;
  ...
  assign cfblk149_out1 = cfblk70_out1 + cfblk33_out1;
  ...
  assign cfblk180_reg_next[0] = cfblk149_out1;
  ...
  assign cfblk1_out1 = cfblk191_out1_is_not0 & Mysubsystem_38_out1_is_not0;
