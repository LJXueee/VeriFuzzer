// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1775\sampleModel1775_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1775_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk83_1 = {24'b0, cfblk68_out1};
  assign cfblk83_2 = {31'b0, Mysubsystem_21_out1};
  assign cfblk83_add_temp = cfblk83_1 + cfblk83_2;
  ...
  assign cfblk138_out1 = (cfblk65_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  DotProduct_block u_cfblk11_inst (.in1(cfblk77_out1),  // uint8
  ...
  always @(Mysubsystem_1_out1, cfblk171_out1) begin
    ...
    if (cfblk171_out1 == 8'b00000000) begin
      ...
      cfblk42_t_0_0 = {1'b0, Mysubsystem_1_out1};
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk130_out1),  // uint8
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_25_out1),  // uint16
                                   .Y(Mysubsystem_21_out1)
                                   );

  Mysubsystem_29 u_Mysubsystem_29 (.In1(Mysubsystem_21_out1),
                                   .Out1(Mysubsystem_29_out1)  // uint8
                                   );

  always @(Mysubsystem_29_out1, cfblk57_out1) begin
    ...
    if (cfblk57_out1 == 8'b00000000) begin
      ...
      cfblk72_t_0_0 = {1'b0, Mysubsystem_29_out1};
