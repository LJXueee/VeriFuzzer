// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1782\sampleModel1782_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1782_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_22_out2;  // ufix16_En7
  reg [15:0] cfblk157_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk157_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk157_out1;  // ufix16_En7
  ...
  assign dtc_out_1 = cfblk139_out1;
  ...
  assign cfblk156_reg_next[0] = Mysubsystem_22_out1;
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk95_out1),  // uint8
                                   .Out1(Mysubsystem_33_out1)  // uint8
                                   );

  Mysubsystem_22 u_Mysubsystem_22 (.In1(Mysubsystem_33_out1),  // uint8
                                   .Out1(Mysubsystem_22_out1),  // uint8
                                   .Out2(Mysubsystem_22_out2)  // ufix16_En7
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk157_process
      if (reset == 1'b1) begin
        cfblk157_reg[0] <= 16'b0000000000000000;
        cfblk157_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk157_reg_next[0] = Mysubsystem_22_out2;
  assign cfblk157_reg_next[1] = cfblk157_reg[0];



  assign cfblk58_add_cast = {16'b0, cfblk157_out1};
  assign cfblk58_add_cast_1 = {17'b0, {cfblk21_out1, 7'b0000000}};
  ...
  assign dtc_out_5 = cfblk80_out1;



  assign cfblk17_out1 = dtc_out_5;
  ...
  assign dtc_out_6 = {31'b0, cfblk2_out1};



  assign cfblk41_out1 = dtc_out_6[7:0];
  ...
  assign dtc_out_9 = cfblk18_out1;



  assign cfblk143_out1 = dtc_out_9;
  ...
  assign dtc_out_10 = cfblk135_out1;



  assign cfblk93_out1 = dtc_out_10;
  ...
  assign dtc_out_11 = cfblk84_out1;



  assign cfblk129_out1 = dtc_out_11;
  ...
  assign dtc_out_12 = cfblk138_out1;



  assign cfblk4_out1 = dtc_out_12;
  ...
  assign dtc_out_13 = cfblk23_out1;



  assign cfblk69_out1 = dtc_out_13;
