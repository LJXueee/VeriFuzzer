// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1965\sampleModel1965_2_sub\Subsystem.v
// Created: 2024-08-16 03:12:06
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1965_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [3:0] cfblk133_out1;  // sfix4
  ...
  reg signed [7:0] cfblk30_varargout_1;  // sfix8
  reg signed [8:0] cfblk30_div_temp;  // sfix9
  reg signed [8:0] cfblk30_t_0_0;  // sfix9
  ...
  assign cfblk165_reg_next[0] = cfblk184_out1;
  assign cfblk165_reg_next[1] = cfblk165_reg[0];



  assign cfblk22_out1 = cfblk86_out1 + cfblk22_const_val_1;
  ...
  assign cfblk122_out1 = cfblk66_out1 - cfblk129_out1;
  ...
  assign cfblk179_reg_next[0] = cfblk21_out1;
  ...
  assign cfblk178_reg_next[0] = cfblk9_out1;
  assign cfblk178_reg_next[1] = cfblk178_reg[0];



  assign cfblk17_out1 = cfblk59_out1 + cfblk17_const_val_1;



  assign cfblk98_out1 = cfblk67_out1 + cfblk17_out1;
  ...
  always @(cfblk103_out1, cfblk98_out1) begin
    ...
    if (cfblk103_out1 == 8'b00000000) begin
      ...
      cfblk132_t_0_0 = {1'b0, cfblk98_out1};
  ...
  always @(cfblk119_out1, cfblk132_out1) begin
    ...
    if (cfblk119_out1 == 8'b00000000) begin
      ...
      cfblk97_t_0_0 = {1'b0, cfblk132_out1};
      cfblk97_div_temp = cfblk97_t_0_0 / cfblk119_out1;
  ...
  assign cfblk170_reg_next[0] = cfblk97_out1;
  assign cfblk170_reg_next[1] = cfblk170_reg[0];



  assign cfblk67_out1 = cfblk114_out1 + cfblk67_const_val_1;



  DotProduct_block u_cfblk107_inst (.in1(cfblk69_out1),  // uint8
  ...
  assign cfblk169_reg_next[0] = cfblk150_out1;
  ...
  assign cfblk166_reg_next[0] = cfblk184_out1;
  assign cfblk166_reg_next[1] = cfblk166_reg[0];



  assign cfblk29_out1 = (cfblk140_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk174_reg_next[0] = cfblk29_out1;
  assign cfblk174_reg_next[1] = cfblk174_reg[0];



  assign cfblk10_out1 = cfblk135_out1 + cfblk174_out1;



  assign cfblk145_out1 = cfblk10_out1 + cfblk145_const_val_1;



  assign cfblk20_out1 = cfblk136_out1 + cfblk113_out1;
  ...
  assign cfblk180_reg_next[0] = cfblk20_out1;
  assign cfblk180_reg_next[1] = cfblk180_reg[0];



  assign cfblk55_out1 = cfblk180_out1 - cfblk145_out1;
  ...
  assign cfblk109_out1 = cfblk120_out1 + cfblk92_out1;



  assign dtc_out = cfblk109_out1;
  ...
  cfblk157 u_cfblk157 (.In1(cfblk141_out1),  // uint8
                       .Out1(cfblk157_out1)  // uint8
                       );

  assign cfblk150_out1 = cfblk184_out1 - cfblk157_out1;



  assign cfblk129_out1 = cfblk150_out1 + cfblk14_out1;
  ...
  always @(cfblk158_out1, cfblk24_out1) begin
    ...
    if (cfblk158_out1 == 8'b00000000) begin
      ...
      cfblk43_t_0_0 = {1'b0, cfblk24_out1};
  ...
  assign cfblk25_out1 = cfblk135_out1 + cfblk25_const_val_1;



  assign cfblk40_out1 = (cfblk37_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk125_out1 = cfblk40_out1 - cfblk25_out1;
  ...
  assign cfblk182_reg_next[0] = cfblk125_out1;
  ...
  assign cfblk1_out1 = cfblk164_out1[7:4];



  assign cfblk133_out1 = (cfblk1_out1 > 4'b0000 ? 4'sb0001 :
              4'sb0000);



  always @(cfblk133_out1, cfblk182_out1) begin
    cfblk30_div_temp = 9'sb000000000;
    cfblk30_t_0_0 = 9'sb000000000;
    if (cfblk182_out1 == 8'b00000000) begin
      if (cfblk133_out1 < 4'sb0000) begin
        cfblk30_varargout_1 = 8'sb10000000;
      end
      else begin
        cfblk30_varargout_1 = 8'sb01111111;
      end
    end
    else begin
      cfblk30_t_0_0 = {1'b0, cfblk182_out1};
      cfblk30_div_temp = cfblk133_out1 / cfblk30_t_0_0;
      if ((cfblk30_div_temp[8] == 1'b0) && (cfblk30_div_temp[7] != 1'b0)) begin
        cfblk30_varargout_1 = 8'sb01111111;
      end
      else if ((cfblk30_div_temp[8] == 1'b1) && (cfblk30_div_temp[7] != 1'b1)) begin
        cfblk30_varargout_1 = 8'sb10000000;
      end
      else begin
        cfblk30_varargout_1 = cfblk30_div_temp[7:0];
      end
    end
    if (cfblk30_varargout_1[7] == 1'b1) begin
      cfblk30_out1 = 8'b00000000;
    end
    else begin
      cfblk30_out1 = cfblk30_varargout_1;
    end
  end



  assign cfblk37_out1 = cfblk30_out1 - cfblk167_out1;



  assign cfblk48_out1 = cfblk37_out1 + cfblk177_out1;
  ...
  assign cfblk151_out1 = (cfblk119_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign dtc_out_3 = cfblk151_out1;
  ...
  assign cfblk51_out1 = (cfblk91_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  always @(cfblk51_out1, cfblk55_out1) begin
    ...
    if (cfblk55_out1 == 8'b00000000) begin
      ...
      cfblk123_t_0_0 = {1'b0, cfblk51_out1};
      cfblk123_div_temp = cfblk123_t_0_0 / cfblk55_out1;
  ...
  assign cfblk80_out1 = (cfblk86_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk114_out1 = (cfblk80_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk19_out1 = cfblk114_out1 - cfblk123_out1;



  assign dtc_out_4 = cfblk19_out1;
  ...
  assign cfblk38_out1 = (cfblk144_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk3_out1 = {cfblk112_out1, cfblk38_out1};
  ...
  assign cfblk128_out1 = cfblk92_out1 + cfblk92_out1;



  always @(cfblk136_out1, cfblk92_out1) begin
    ...
    if (cfblk92_out1 == 8'b00000000) begin
      ...
      cfblk21_t_0_0 = {1'b0, cfblk136_out1};
      cfblk21_div_temp = cfblk21_t_0_0 / cfblk92_out1;
  ...
  assign cfblk113_out1 = cfblk155_out1 + cfblk21_out1;



  assign cfblk58_out1 = cfblk156_out1 + cfblk69_out1;



  assign cfblk9_out1 = cfblk58_out1 - cfblk113_out1;



  assign cfblk13_out1 = cfblk9_out1 - cfblk102_out1;
  ...
  assign cfblk35_out1 = cfblk15_out1 + cfblk141_out1;



  assign cfblk96_out1 = cfblk35_out1 + cfblk128_out1;



  DotProduct_block3 u_cfblk59_inst (.in1(cfblk96_out1),  // uint8
                                    .in2(cfblk131_out1),  // uint8
                                    .out1(cfblk59_out1)  // uint8
                                    );

  assign cfblk89_out1 = cfblk59_out1 + cfblk184_out1;



  DotProduct_block1 u_cfblk127_inst (.in1(cfblk89_out1),  // uint8
                                     .in2(cfblk120_out1),  // uint8
                                     .out1(cfblk127_out1)  // uint8
                                     );

  assign cfblk103_out1 = cfblk127_out1 + cfblk103_const_val_1;
  ...
  assign cfblk172_reg_next[0] = cfblk103_out1;
  assign cfblk172_reg_next[1] = cfblk172_reg[0];



  assign cfblk134_out1 = cfblk23_out1 + cfblk134_const_val_1;



  assign cfblk65_out1 = (cfblk134_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk27_out1 = cfblk18_out1 - cfblk154_out1;



  assign cfblk111_out1 = (cfblk27_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk85_out1 = (cfblk111_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  always @(cfblk18_out1, cfblk85_out1) begin
    ...
    if (cfblk18_out1 == 8'b00000000) begin
      ...
      cfblk121_t_0_0 = {1'b0, cfblk85_out1};
      cfblk121_div_temp = cfblk121_t_0_0 / cfblk18_out1;
  ...
  assign cfblk41_out1 = cfblk121_out1 + cfblk65_out1;



  assign cfblk136_out1 = cfblk41_out1 + cfblk136_const_val_1;



  always @(cfblk136_out1, cfblk172_out1) begin
    ...
    if (cfblk172_out1 == 8'b00000000) begin
      ...
      cfblk144_t_0_0 = {1'b0, cfblk136_out1};
      cfblk144_div_temp = cfblk144_t_0_0 / cfblk172_out1;
  ...
  always @(cfblk144_out1, cfblk51_out1) begin
    ...
    if (cfblk51_out1 == 8'b00000000) begin
      ...
      cfblk46_t_0_0 = {1'b0, cfblk144_out1};
      cfblk46_div_temp = cfblk46_t_0_0 / cfblk51_out1;
  ...
  assign cfblk87_out1 = cfblk46_out1 + cfblk116_out1;
  ...
  assign cfblk69_out1 = (cfblk92_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk131_out1 = (cfblk69_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  DotProduct u_cfblk102_inst (.in1(cfblk141_out1),  // uint8
                              .in2(cfblk175_out1),  // uint8
                              .out1(cfblk102_out1)  // uint8
                              );

  always @(cfblk102_out1, cfblk166_out1) begin
    ...
    if (cfblk166_out1 == 8'b00000000) begin
      ...
      cfblk93_t_0_0 = {1'b0, cfblk102_out1};
      cfblk93_div_temp = cfblk93_t_0_0 / cfblk166_out1;
  ...
  assign cfblk18_out1 = cfblk93_out1 - cfblk169_out1;



  assign cfblk140_out1 = cfblk18_out1 + cfblk92_out1;



  assign cfblk74_out1 = (cfblk140_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  always @(cfblk27_out1, cfblk74_out1) begin
    ...
    if (cfblk27_out1 == 8'b00000000) begin
      ...
      cfblk75_div_temp = cfblk75_t_0_0 / cfblk27_out1;
  ...
  assign cfblk110_out1 = cfblk75_out1 + cfblk141_out1;



  assign cfblk94_out1 = cfblk110_out1 - cfblk107_out1;



  assign cfblk14_out1 = cfblk94_out1 + cfblk138_out1;
  ...
  assign cfblk173_reg_next[0] = cfblk14_out1;
  ...
  always @(cfblk120_out1, cfblk173_out1) begin
    ...
    if (cfblk120_out1 == 8'b00000000) begin
      ...
      cfblk8_t_0_0 = {1'b0, cfblk173_out1};
      cfblk8_div_temp = cfblk8_t_0_0 / cfblk120_out1;
  ...
  always @(cfblk170_out1, cfblk8_out1) begin
    ...
    if (cfblk170_out1 == 8'b00000000) begin
      ...
      cfblk124_t_0_0 = {1'b0, cfblk8_out1};
      cfblk124_div_temp = cfblk124_t_0_0 / cfblk170_out1;
  ...
  DotProduct_block2 u_cfblk33_inst (.in1(cfblk124_out1),  // uint8
                                    .in2(cfblk178_out1),  // uint8
                                    .out1(cfblk33_out1)  // uint8
                                    );

  assign cfblk141_out1 = cfblk33_out1 - cfblk179_out1;



  assign cfblk108_out1 = cfblk141_out1 + cfblk8_out1;
  ...
  assign cfblk138_out1 = dtc_out_8;
  ...
  assign cfblk181_reg_next[0] = cfblk138_out1;
  assign cfblk181_reg_next[1] = cfblk181_reg[0];



  assign cfblk86_out1 = cfblk181_out1 + cfblk168_out1;



  assign cfblk73_out1 = (cfblk86_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk135_out1 = cfblk73_out1 + cfblk165_out1;



  assign cfblk31_out1 = cfblk135_out1 + cfblk30_out1;
  ...
  assign cfblk23_out1 = (cfblk116_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  Mysubsystem_35 u_Mysubsystem_35 (.In1(cfblk23_out1),  // uint8
                                   .cfblk152(Mysubsystem_35_out1)  // uint8
                                   );

  assign cfblk152 = Mysubsystem_35_out1;
  ...
  assign cfblk183_reg_next[0] = cfblk65_out1;
