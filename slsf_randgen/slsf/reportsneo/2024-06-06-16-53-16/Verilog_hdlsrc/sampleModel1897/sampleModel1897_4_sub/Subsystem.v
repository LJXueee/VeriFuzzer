// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1897\sampleModel1897_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1897_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_36_out1;  // uint16
  wire [15:0] Mysubsystem_36_out2;  // uint16
  wire [7:0] Mysubsystem_36_out3;  // uint8
  wire [31:0] Mysubsystem_26_out1;  // ufix32_En15
  wire [15:0] Mysubsystem_26_out2;  // uint16
  ...
  wire cfblk4_relop1;
  wire [31:0] cfblk82_add_temp;  // ufix32
  wire [31:0] cfblk82_1;  // ufix32
  wire [31:0] cfblk82_2;  // ufix32
  ...
  wire [31:0] cfblk75_add_cast;  // ufix32_En14
  wire [31:0] cfblk75_add_cast_1;  // ufix32_En14
  wire [31:0] cfblk75_add_temp;  // ufix32_En14
  ...
  wire [15:0] Mysubsystem_10_out1;  // uint16
  reg [15:0] cfblk139_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk139_reg_next [0:1];  // ufix16 [2]
  wire [15:0] cfblk139_out1;  // uint16
  wire [31:0] cfblk54_add_temp;  // ufix32
  wire [31:0] cfblk54_1;  // ufix32
  wire [31:0] cfblk54_2;  // ufix32
  ...
  assign cfblk35_out1 = cfblk94_out1 + cfblk128_out1;
  ...
  Mysubsystem_36 u_Mysubsystem_36 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_36_out1),  // uint16
                                   .y(Mysubsystem_36_out2),  // uint16
                                   .Out3(Mysubsystem_36_out3)  // uint8
                                   );

  assign enb = clk_enable;

  Mysubsystem_26 u_Mysubsystem_26 (.In1(Mysubsystem_36_out1),  // uint16
                                   .Out1(Mysubsystem_26_out1),  // ufix32_En15
                                   .Out2(Mysubsystem_26_out2)  // uint16
                                   );

  assign cfblk97_out1 = Mysubsystem_26_out2[7:0];
  ...
  assign cfblk30_out1 = cfblk13_out1 + cfblk36_out1;
  ...
  assign cfblk144_reg_next[0] = cfblk61_out1;
  ...
  assign cfblk137_reg_next[0] = cfblk102_out1;
  ...
  assign cfblk148_reg_next[0] = cfblk76_out1;
  ...
  assign cfblk146_reg_next[0] = cfblk8_out1;
  ...
  assign cfblk142_reg_next[0] = cfblk34_out1;
  assign cfblk142_reg_next[1] = cfblk142_reg[0];



  always @(cfblk142_out1, cfblk2_out1) begin
    ...
    if (cfblk2_out1 == 8'b00000000) begin
      ...
      cfblk57_t_0_0 = {1'b0, cfblk142_out1};
      cfblk57_div_temp = cfblk57_t_0_0 / cfblk2_out1;
  ...
  assign cfblk64_out1 = cfblk57_out1 + cfblk146_out1;



  assign cfblk4_relop1 = cfblk64_out1 <= cfblk151_out1;



  assign cfblk82_1 = {31'b0, cfblk4_relop1};
  assign cfblk82_2 = {24'b0, cfblk148_out1};
  assign cfblk82_add_temp = cfblk82_1 + cfblk82_2;
  assign cfblk82_out1 = cfblk82_add_temp[7:0];



  assign cfblk87_out1 = cfblk82_out1 + cfblk87_const_val_1;
  ...
  assign cfblk149_reg_next[0] = cfblk76_out1;
  ...
  cfblk131 u_cfblk131 (.In1(cfblk96_out1),  // uint8
                       .Out1(cfblk131_out1)  // uint8
                       );

  assign dtc_out_2 = cfblk131_out1;
  ...
  assign cfblk103_out1 = (cfblk11_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk5_out1 = cfblk103_out1 & 8'b11111110;
  ...
  assign cfblk138_reg_next[0] = cfblk5_out1;
  assign cfblk138_reg_next[1] = cfblk138_reg[0];



  assign cfblk11_out1 = cfblk138_out1 + cfblk95_out1;



  always @(cfblk119_out1, cfblk11_out1) begin
    ...
    if (cfblk11_out1 == 8'b00000000) begin
      ...
      cfblk100_t_0_0 = {1'b0, cfblk119_out1};
      cfblk100_div_temp = cfblk100_t_0_0 / cfblk11_out1;
  ...
  assign cfblk51_out1 = cfblk100_out1 + cfblk51_const_val_1;



  assign cfblk23_out1 = cfblk51_out1 + cfblk149_out1;



  assign dtc_out_3 = cfblk111_out1;



  assign cfblk8_out1 = dtc_out_3;



  DotProduct_block4 u_cfblk50_inst (.in1(cfblk15_out1),  // uint8
                                    .in2(cfblk8_out1),  // uint8
                                    .out1(cfblk50_out1)  // uint8
                                    );

  assign cfblk41_out1 = cfblk50_out1 + cfblk41_const_val_1;



  assign cfblk106_out1 = (cfblk41_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk98_out1 = (cfblk106_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  DotProduct_block2 u_cfblk116_inst (.in1(cfblk141_out1),  // uint8
  ...
  assign cfblk75_add_cast = {1'b0, Mysubsystem_26_out1[31:1]};
  assign cfblk75_add_cast_1 = {10'b0, {cfblk73_out1, 14'b00000000000000}};
  assign cfblk75_add_temp = cfblk75_add_cast + cfblk75_add_cast_1;
  assign cfblk75_out1 = cfblk75_add_temp[21:14];



  DotProduct_block6 u_cfblk76_inst (.in1(cfblk75_out1),  // uint8
                                    .in2(Mysubsystem_36_out3),  // uint8
                                    .out1(cfblk76_out1)  // uint8
                                    );

  assign cfblk29_out1 = cfblk76_out1 + cfblk11_out1;



  assign cfblk78_out1 = cfblk29_out1 + cfblk125_out1;



  assign cfblk34_out1 = cfblk10_out1 + cfblk78_out1;



  assign cfblk81_out1 = (cfblk34_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk102_out1 = cfblk97_out1 + cfblk81_out1;
  ...
  assign cfblk136_reg_next[0] = cfblk102_out1;
  assign cfblk136_reg_next[1] = cfblk136_reg[0];



  assign cfblk71_out1 = cfblk136_out1 - cfblk87_out1;



  assign cfblk48_out1 = cfblk71_out1 + cfblk48_const_val_1;



  assign cfblk46_out1 = cfblk48_out1 + cfblk46_const_val_1;



  Mysubsystem_4 u_Mysubsystem_4 (.In1(Mysubsystem_17_out1),  // uint8
                                 .Out1(Mysubsystem_4_out1)  // uint8
                                 );

  Mysubsystem_16 u_Mysubsystem_16 (.In1(Mysubsystem_4_out1),  // uint8
                                   .In2(Mysubsystem_36_out2),  // uint16
                                   .Out1(Mysubsystem_16_out1)  // uint8
                                   );

  Mysubsystem_10 u_Mysubsystem_10 (.In1(Mysubsystem_36_out3),  // uint8
                                   .In2(Mysubsystem_16_out1),  // uint8
                                   .Out1(Mysubsystem_10_out1)  // uint16
                                   );
  ...
  assign cfblk139_reg_next[0] = Mysubsystem_10_out1;
  assign cfblk139_reg_next[1] = cfblk139_reg[0];



  assign cfblk54_1 = {16'b0, cfblk139_out1};
  assign cfblk54_2 = {24'b0, cfblk46_out1};
  assign cfblk54_add_temp = cfblk54_1 + cfblk54_2;
  assign cfblk54_out1 = cfblk54_add_temp[7:0];
  ...
  assign cfblk74_out1 = cfblk3_out1 + cfblk137_out1;



  assign cfblk109_out1 = cfblk74_out1 + cfblk144_out1;
  ...
  assign cfblk36_out1 = dtc_out_5;



  DotProduct_block3 u_cfblk26_inst (.in1(cfblk35_out1),  // uint8
                                    .in2(cfblk36_out1),  // uint8
                                    .out1(cfblk26_out1)  // uint8
                                    );

  assign cfblk119_out1 = cfblk26_out1 + cfblk119_const_val_1;



  always @(cfblk119_out1, cfblk30_out1) begin
    ...
    if (cfblk30_out1 == 8'b00000000) begin
      ...
      cfblk115_t_0_0 = {1'b0, cfblk119_out1};
      cfblk115_div_temp = cfblk115_t_0_0 / cfblk30_out1;
  ...
  assign cfblk63_out1 = dtc_out_6;



  assign cfblk86_out1 = cfblk63_out1 + cfblk47_out1;



  Mysubsystem_17 u_Mysubsystem_17 (.In1(cfblk86_out1),  // uint8
  ...
  Mysubsystem_14 u_Mysubsystem_14 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_17_out1),  // uint8
                                   .Out1(Mysubsystem_14_out1)  // uint8
                                   );

  assign cfblk47_out1 = Mysubsystem_14_out1 - cfblk115_out1;
  ...
  assign cfblk90_out1 = (cfblk45_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk15_out1 = (cfblk90_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk111_out1 = cfblk15_out1 + cfblk111_const_val_1;



  assign cfblk61_out1 = (cfblk111_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk59_out1 = (cfblk61_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk10_out1 = cfblk59_out1 + cfblk10_const_val_1;



  assign cfblk53_out1 = cfblk35_out1 + cfblk10_out1;
  ...
  assign cfblk143_reg_next[0] = cfblk53_out1;
  assign cfblk143_reg_next[1] = cfblk143_reg[0];



  assign cfblk13_out1 = cfblk143_out1 + cfblk116_out1;



  assign cfblk68_out1 = cfblk13_out1 + cfblk41_out1;



  assign cfblk122 = cfblk68_out1;

  cfblk130 u_cfblk130 (.In1(cfblk47_out1),  // uint8
  ...
  assign cfblk22_out1 = cfblk61_out1 + cfblk22_const_val_1;



  assign cfblk114_out1 = (cfblk22_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  DotProduct_block u_cfblk104_inst (.in1(cfblk130_out1),  // uint8
                                    .in2(cfblk116_out1),  // uint8
                                    .out1(cfblk104_out1)  // uint8
                                    );

  assign cfblk79_out1 = (cfblk104_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  DotProduct_block1 u_cfblk105_inst (.in1(cfblk114_out1),  // uint8
                                     .in2(cfblk46_out1),  // uint8
                                     .out1(cfblk105_out1)  // uint8
                                     );

  assign dtc_out_7 = cfblk105_out1;



  assign cfblk56_out1 = dtc_out_7;



  assign cfblk80_out1 = cfblk79_out1 - cfblk56_out1;



  DotProduct_block5 u_cfblk72_inst (.in1(cfblk80_out1),  // uint8
  ...
  assign cfblk77_out1 = cfblk72_out1 + cfblk77_const_val_1;



  always @(cfblk80_out1, cfblk96_out1) begin
    ...
    if (cfblk80_out1 == 8'b00000000) begin
      ...
      cfblk62_t_0_0 = {1'b0, cfblk96_out1};
      cfblk62_div_temp = cfblk62_t_0_0 / cfblk80_out1;
  ...
  always @(cfblk62_out1, cfblk77_out1) begin
    ...
    if (cfblk62_out1 == 8'b00000000) begin
      ...
      cfblk43_div_temp = cfblk43_t_0_0 / cfblk62_out1;
  ...
  assign cfblk18_out1 = cfblk57_out1 - cfblk43_out1;



  assign cfblk124 = cfblk18_out1;

  assign Hdl_out = cfblk2_out1;
