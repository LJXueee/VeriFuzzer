// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1606\sampleModel1606_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1606_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_35_out2;  // uint8
  ...
  assign cfblk59_out1 = cfblk134_out1[7:0];
  ...
  always @(cfblk156_out1, cfblk59_out1) begin
    ...
    if (cfblk59_out1 == 8'b00000000) begin
      ...
      cfblk118_t_0_0 = {1'b0, cfblk156_out1};
      cfblk118_div_temp = cfblk118_t_0_0 / cfblk59_out1;
  ...
  always @(cfblk52_out1, cfblk59_out1) begin
    ...
    if (cfblk59_out1 == 8'b00000000) begin
      ...
      cfblk18_div_temp = cfblk18_t_0_0 / cfblk59_out1;
  ...
  assign cfblk123_out1 = cfblk70_out1 + Mysubsystem_35_out1;
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk123_out1),  // uint8
                                   .Out1(Mysubsystem_35_out1),  // uint8
                                   .Out2(Mysubsystem_35_out2)  // uint8
                                   );
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.In1(cfblk55_out1),  // uint8
  ...
  assign cfblk159_reg_next[0] = Mysubsystem_30_out1;
  ...
  always @(Mysubsystem_35_out2, cfblk160_out1) begin
    cfblk108_div_temp = 9'b000000000;
    cfblk108_t_0_0 = 9'b000000000;
    if (Mysubsystem_35_out2 == 8'b00000000) begin
      cfblk108_out1 = 8'b11111111;
    end
    else begin
      cfblk108_t_0_0 = {1'b0, cfblk160_out1};
      cfblk108_div_temp = cfblk108_t_0_0 / Mysubsystem_35_out2;
