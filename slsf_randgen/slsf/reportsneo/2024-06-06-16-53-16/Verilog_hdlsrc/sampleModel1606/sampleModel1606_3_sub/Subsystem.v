// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1606\sampleModel1606_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1606_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_39_out1;  // uint16
  wire [15:0] Mysubsystem_39_out2;  // uint16
  ...
  reg [15:0] cfblk18_varargout_1;  // ufix16
  reg [15:0] cfblk18_div_temp;  // ufix16
  ...
  Mysubsystem_39 u_Mysubsystem_39 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_39_out1),  // uint16
                                   .Out2(Mysubsystem_39_out2)  // uint16
                                   );
  ...
  always @(Mysubsystem_39_out2, cfblk156_out1) begin
    cfblk118_div_temp = 16'b0000000000000000;
    if (Mysubsystem_39_out2 == 16'b0000000000000000) begin
      cfblk118_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk118_div_temp = cfblk156_out1 / Mysubsystem_39_out2;
  ...
  assign cfblk124_out1 = cfblk49_out1 + cfblk48_out1;
  ...
  assign cfblk49_out1 = cfblk45_out1 + cfblk49_const_val_1;
  ...
  assign cfblk146_reg_next[0] = cfblk49_out1;
  ...
  always @(Mysubsystem_39_out1, cfblk52_out1) begin
    cfblk18_div_temp = 16'b0000000000000000;
    if (Mysubsystem_39_out1 == 16'b0000000000000000) begin
      cfblk18_varargout_1 = 16'b1111111111111111;
    end
    else begin
      cfblk18_div_temp = cfblk52_out1 / Mysubsystem_39_out1;
      cfblk18_varargout_1 = cfblk18_div_temp;
    end
    if (cfblk18_varargout_1[15:8] != 8'b00000000) begin
      cfblk18_out1 = 8'b11111111;
    end
    else begin
      cfblk18_out1 = cfblk18_varargout_1[7:0];
    end
  end
  ...
  always @(cfblk100_out1, cfblk55_out1) begin
    ...
    if (cfblk55_out1 == 8'b00000000) begin
      ...
      cfblk72_t_0_0 = {1'b0, cfblk100_out1};
      cfblk72_div_temp = cfblk72_t_0_0 / cfblk55_out1;
  ...
  cfblk138 u_cfblk138 (.In1(cfblk87_out1),  // uint8
  ...
  assign cfblk160_reg_next[0] = cfblk138_out1;
  assign cfblk160_reg_next[1] = cfblk160_reg[0];



  always @(cfblk160_out1, cfblk1_out1) begin
    ...
    if (cfblk1_out1 == 8'b00000000) begin
      ...
      cfblk108_t_0_0 = {1'b0, cfblk160_out1};
  ...
  assign cfblk58_out1 = dtc_out_6;



  assign dtc_out_7 = cfblk58_out1;
  ...
  assign cfblk114_out1 = dtc_out_8;
  ...
  assign cfblk85_out1 = cfblk22_out1 + cfblk31_out1;
  ...
  assign cfblk39_out1 = dtc_out_10;
