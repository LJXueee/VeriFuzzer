// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2062\sampleModel2062_sub\Subsystem_tb.v
// Created: 2024-08-17 01:00:03
// 
...
module Subsystem_tb;
  ...
  assign Hdl_out_lastAddr = cfblk132_addr >= 4'b1010;
  ...
  assign cfblk132_active = cfblk132_addr != 4'b1010;
  ...
  assign cfblk132_enb = ce_out & cfblk132_active;
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        cfblk132_addr <= 4'b0000;
      end
      else begin
        if (cfblk132_enb) begin
          if (cfblk132_addr >= 4'b1010) begin
            cfblk132_addr <= 4'b0000;
          end
          else begin
            cfblk132_addr <= cfblk132_addr + 4'b0001;
          end
        end
      end
    end
  ...
  assign cfblk132_lastAddr = cfblk132_addr >= 4'b1010;
  ...
  assign cfblk132_expected_table_data[4] = 8'b00000001;
  assign cfblk132_expected_table_data[5] = 8'b00000001;
  assign cfblk132_expected_table_data[6] = 8'b00000001;
  assign cfblk132_expected_table_data[7] = 8'b00000001;
  assign cfblk132_expected_table_data[8] = 8'b00000001;
  assign cfblk132_expected_table_data[9] = 8'b00000001;
  assign cfblk132_expected_table_data[10] = 8'b00000001;
  assign cfblk132_expected_1 = cfblk132_expected_table_data[cfblk132_addr];
  ...
  assign Hdl_out_expected_1 = Hdl_out_expected_table_data[cfblk132_addr];
  ...
  assign testFailure = cfblk132_testFailure | Hdl_out_testFailure;
