// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1944\sampleModel1944_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1944_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [7:0] Mysubsystem_32_out1;  // int8
  wire signed [31:0] dtc_out_4;  // sfix32
  ...
  assign cfblk55_out1 = Mysubsystem_32_out2 + Mysubsystem_36_out1;
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.clk(clk),
                                   ...
                                   .Out1(Mysubsystem_32_out1),  // int8
                                   .Out2(Mysubsystem_32_out2)  // uint8
                                   );

  assign dtc_out_4 = {{24{Mysubsystem_32_out1[7]}}, Mysubsystem_32_out1};



  assign cfblk42_out1 = dtc_out_4[7:0];
  ...
  assign dtc_out_7 = cfblk143_out1;
