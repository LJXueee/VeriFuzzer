// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1400\sampleModel1400_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1400_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_8 u_Mysubsystem_8 (.clk(clk),
                                 ...
                                 .y(Mysubsystem_8_out3)  // uint8
                                 );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_8_out2),  // uint8
                                   .In2(Mysubsystem_8_out3),  // uint8
                                   .Out1(Mysubsystem_32_out1),  // uint8
                                   .Out2(Mysubsystem_32_out2),  // uint8
                                   .Out3(Mysubsystem_32_out3),  // uint8
                                   .Out4(Mysubsystem_32_out4)  // uint8
                                   );

  Mysubsystem_36 u_Mysubsystem_36 (.In1(Mysubsystem_32_out4),  // uint8
  ...
  Mysubsystem_5 u_Mysubsystem_5 (.clk(clk),
                                 ...
                                 .Out2(Mysubsystem_5_out2)  // uint16
                                 );

  assign cfblk204_out1 = Mysubsystem_5_out2[7:0];



  assign dtc_out = cfblk204_out1;
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.In1(Mysubsystem_32_out2),  // uint8
  ...
  assign cfblk112_out1 = Mysubsystem_8_out2 + cfblk112_const_val_1;
  ...
  assign cfblk38_out1 = (cfblk151_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  DotProduct u_cfblk103_inst (.in1(cfblk88_out1),  // uint8
  ...
  assign cfblk166_reg_next[0] = cfblk103_out1;
  assign cfblk166_reg_next[1] = cfblk166_reg[0];



  always @(cfblk29_out1, cfblk33_out1) begin
    ...
    if (cfblk29_out1 == 8'b00000000) begin
      ...
      cfblk121_div_temp = cfblk121_t_0_0 / cfblk29_out1;
  ...
  assign cfblk87_out1 = cfblk28_out1 - cfblk121_out1;
  ...
  assign cfblk168_reg_next[0] = cfblk87_out1;
  ...
  assign cfblk14_out1 = cfblk144_out1 + Mysubsystem_32_out4;
  ...
  DotProduct_block4 u_cfblk146_inst (.in1(Mysubsystem_5_out1),  // uint8
  ...
  assign cfblk100_out1 = Mysubsystem_32_out1 + cfblk70_out1;
  ...
  always @(cfblk166_out1, cfblk47_out1) begin
    ...
    if (cfblk166_out1 == 8'b00000000) begin
      ...
      cfblk126_t_0_0 = {1'b0, cfblk47_out1};
      cfblk126_div_temp = cfblk126_t_0_0 / cfblk166_out1;
  ...
  always @(Mysubsystem_36_out1, cfblk126_out1) begin
    ...
    if (cfblk126_out1 == 8'b00000000) begin
      ...
      cfblk77_t_0_0 = {1'b0, Mysubsystem_36_out1};
  ...
  assign cfblk140_out1 = Mysubsystem_32_out3 - cfblk157_out1;
