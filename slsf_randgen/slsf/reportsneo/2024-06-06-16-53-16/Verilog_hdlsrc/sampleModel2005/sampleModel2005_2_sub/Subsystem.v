// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2005\sampleModel2005_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2005_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_30 u_Mysubsystem_30 (.In3(cfblk138_out1),  // uint8
  ...
  assign cfblk164_reg_next[0] = Mysubsystem_30_out1;
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.In1(cfblk12_out1),  // uint8
                                   .Out1(Mysubsystem_32_out1)  // uint8
                                   );

  Mysubsystem_34 u_Mysubsystem_34 (.In1(cfblk14_out1),  // uint8
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.In2(cfblk6_out1),  // uint8
  ...
  assign cfblk182_reg_next[0] = Mysubsystem_41_out1;
  ...
  assign cfblk62_out1 = Mysubsystem_11_out1 + cfblk132_out1;
  ...
  assign Hdl_out = Mysubsystem_11_out1;
