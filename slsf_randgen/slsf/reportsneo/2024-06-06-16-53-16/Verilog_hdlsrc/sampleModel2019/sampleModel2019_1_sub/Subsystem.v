// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2019\sampleModel2019_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2019_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire Mysubsystem_43_out1;  // ufix1
  ...
  wire signed [2:0] cfblk50_sub_temp;  // sfix3
  wire signed [2:0] cfblk50_1;  // sfix3
  wire signed [2:0] cfblk50_2;  // sfix3
  ...
  Mysubsystem_43 u_Mysubsystem_43 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .U(Mysubsystem_18_out1),  // uint8
                                   .Out1(Mysubsystem_43_out1)  // ufix1
                                   );

  assign cfblk55_out1 = {7'b0, Mysubsystem_43_out1};
  ...
  assign cfblk136_out1 = Mysubsystem_24_out1 + cfblk136_const_val_1;
  ...
  assign cfblk98_1 = {16'b0, cfblk136_out1};
  assign cfblk98_2 = {24'b0, cfblk71_out1};
  ...
  assign cfblk50_1 = {2'b0, Mysubsystem_43_out1};
  assign cfblk50_2 = {2'b0, cfblk5_out1};
  assign cfblk50_sub_temp = cfblk50_1 - cfblk50_2;
  assign cfblk50_out1 = {{5{cfblk50_sub_temp[2]}}, cfblk50_sub_temp};
  ...
  assign dtc_out_10 = cfblk72_out1;
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.In1(cfblk20_out1),  // uint8
  ...
  assign cfblk164_reg_next[0] = Mysubsystem_41_out1;
  ...
  assign cfblk70_out1 = dtc_out_12;



  assign dtc_out_13 = cfblk70_out1;
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk131_out1),  // uint8
                                   .Out1(Mysubsystem_27_out1)  // uint8
                                   );

  assign cfblk76_out1 = cfblk55_out1 - Mysubsystem_27_out1;
