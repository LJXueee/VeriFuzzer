// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1802\sampleModel1802_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1802_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_43_out1;  // ufix64
  real Mysubsystem_43_out1_double;  // double
  ...
  Mysubsystem_43 u_Mysubsystem_43 (.Out1(Mysubsystem_43_out1)  // double
                                   );

  always @* Mysubsystem_43_out1_double = $bitstoreal(Mysubsystem_43_out1);

  assign switch_compare_1 = Mysubsystem_43_out1_double >= 0.0;
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk89_out1),  // uint8
                                   .Out1(Mysubsystem_32_out1)  // uint8
                                   );

  assign cfblk21_out1 = Mysubsystem_32_out1 + cfblk1_out1;
