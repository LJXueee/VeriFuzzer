// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1802\sampleModel1802_sub\Subsystem_tb.v
// Created: 2024-08-14 10:36:12
// 
...
module Subsystem_tb;
  ...
  assign Hdl_out_lastAddr = cfblk135_addr >= 4'b1010;
  ...
  assign cfblk138_lastAddr = cfblk135_addr >= 4'b1010;
  ...
  assign cfblk135_active = cfblk135_addr != 4'b1010;
  ...
  assign cfblk135_enb = ce_out & cfblk135_active;
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        cfblk135_addr <= 4'b0000;
      end
      else begin
        if (cfblk135_enb) begin
          if (cfblk135_addr >= 4'b1010) begin
            cfblk135_addr <= 4'b0000;
          end
          else begin
            cfblk135_addr <= cfblk135_addr + 4'b0001;
          end
        end
      end
    end
  ...
  assign cfblk135_lastAddr = cfblk135_addr >= 4'b1010;
  ...
  assign cfblk135_expected_table_data[2] = 8'b11111111;
  assign cfblk135_expected_table_data[3] = 8'b11111111;
  assign cfblk135_expected_table_data[4] = 8'b11111110;
  assign cfblk135_expected_table_data[5] = 8'b11111110;
  assign cfblk135_expected_table_data[6] = 8'b00000000;
  assign cfblk135_expected_table_data[7] = 8'b00001001;
  assign cfblk135_expected_table_data[8] = 8'b00100000;
  assign cfblk135_expected_table_data[9] = 8'b11111110;
  assign cfblk135_expected_table_data[10] = 8'b11111110;
  assign cfblk135_expected_1 = cfblk135_expected_table_data[cfblk135_addr];
  ...
  assign cfblk138_expected_table_data[0] = 8'b11111111;
  assign cfblk138_expected_table_data[1] = 8'b11111111;
  assign cfblk138_expected_table_data[2] = 8'b00000000;
  assign cfblk138_expected_table_data[3] = 8'b00000001;
  assign cfblk138_expected_table_data[4] = 8'b00000000;
  assign cfblk138_expected_table_data[5] = 8'b00000000;
  assign cfblk138_expected_table_data[6] = 8'b00000010;
  assign cfblk138_expected_table_data[7] = 8'b00001011;
  assign cfblk138_expected_table_data[8] = 8'b00100010;
  assign cfblk138_expected_table_data[9] = 8'b00111110;
  assign cfblk138_expected_table_data[10] = 8'b00000000;
  assign cfblk138_expected_1 = cfblk138_expected_table_data[cfblk135_addr];
  ...
  assign testFailure = Hdl_out_testFailure | (cfblk135_testFailure | cfblk138_testFailure);
