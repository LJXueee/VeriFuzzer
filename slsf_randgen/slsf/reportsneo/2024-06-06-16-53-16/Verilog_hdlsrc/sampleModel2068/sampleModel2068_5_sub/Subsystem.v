// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2068\sampleModel2068_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2068_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk12_out1 = cfblk14_out1 + cfblk12_const_val_1;
  ...
  assign cfblk37_out1 = dtc_out_1;



  assign cfblk83_out1 = cfblk37_out1 - cfblk42_out1;
  ...
  assign cfblk142_reg_next[0] = cfblk83_out1;
  ...
  always @(Mysubsystem_19_out2, cfblk81_out1) begin
    cfblk38_div_temp = 9'b000000000;
    cfblk38_t_0_0 = 9'b000000000;
    if (Mysubsystem_19_out2 == 8'b00000000) begin
      cfblk38_out1 = 8'b11111111;
    end
    else begin
      cfblk38_t_0_0 = {1'b0, cfblk81_out1};
      cfblk38_div_temp = cfblk38_t_0_0 / Mysubsystem_19_out2;
  ...
  assign dtc_out_8 = cfblk97_out1;



  assign cfblk71_out1 = dtc_out_8;



  assign dtc_out_9 = cfblk71_out1;
  ...
  assign cfblk15_out1 = dtc_out_10;
  ...
  assign dtc_out_12 = cfblk121_out1;
  ...
  assign dtc_out_13 = cfblk66_out1;



  assign cfblk51_out1 = dtc_out_13;



  assign dtc_out_14 = cfblk51_out1;



  assign cfblk42_out1 = dtc_out_14;
  ...
  DotProduct u_cfblk10_inst (.in1(Mysubsystem_19_out1),  // uint8
