// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1407\sampleModel1407_3_sub\Subsystem.v
// Created: 2024-08-12 01:58:04
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1407_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg [15:0] cfblk182_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk182_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk182_out1;  // ufix16_En7
  ...
  wire [31:0] cfblk147_add_cast;  // ufix32_En7
  wire [31:0] cfblk147_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk147_add_temp;  // ufix32_En7
  ...
  Mysubsystem_45 u_Mysubsystem_45 (.In1(cfblk42_out1),  // uint8
  ...
  assign cfblk171_reg_next[0] = Mysubsystem_45_out1;
  ...
  assign dtc_out_1 = cfblk150_out1;
  ...
  Mysubsystem_6 u_Mysubsystem_6 (.In1(cfblk27_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk182_process
      if (reset == 1'b1) begin
        cfblk182_reg[0] <= 16'b0000000000000000;
        cfblk182_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk182_reg_next[0] = Mysubsystem_6_out1;
  ...
  assign cfblk147_add_cast = {17'b0, {cfblk143_out1, 7'b0000000}};
  assign cfblk147_add_cast_1 = {16'b0, cfblk182_out1};
  assign cfblk147_add_temp = cfblk147_add_cast + cfblk147_add_cast_1;
  assign cfblk147_out1 = cfblk147_add_temp[14:7];
  ...
  assign dtc_out_5 = cfblk38_out1;



  assign cfblk10_out1 = dtc_out_5;
  ...
  assign cfblk140_out1 = cfblk154_out1 - cfblk91_out1;
  ...
  assign cfblk191_reg_next[0] = cfblk140_out1;
  ...
  cfblk1 u_cfblk1 (.clk(clk),
                   .reset(reset),
                   .enb(clk_enable),
                   .U(cfblk191_out1),  // uint8
                   .Y(cfblk1_out1)  // uint8
                   );

  always @(cfblk1_out1, cfblk44_out1) begin
    ...
    if (cfblk44_out1 == 8'b00000000) begin
      ...
      cfblk75_t_0_0 = {1'b0, cfblk1_out1};
      cfblk75_div_temp = cfblk75_t_0_0 / cfblk44_out1;
  ...
  assign dtc_out_7 = cfblk156_out1;
  ...
  assign dtc_out_8 = cfblk41_out1;



  assign cfblk9_out1 = dtc_out_8;
  ...
  assign dtc_out_9 = cfblk8_out1;



  assign cfblk16_out1 = dtc_out_9;



  assign dtc_out_10 = cfblk16_out1;



  assign cfblk92_out1 = dtc_out_10;
  ...
  assign dtc_out_11 = cfblk39_out1;



  assign cfblk42_out1 = dtc_out_11;
  ...
  assign cfblk35_out1 = dtc_out_12;
