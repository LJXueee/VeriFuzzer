// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1407\sampleModel1407_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1407_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  DotProduct_block6 u_cfblk73_inst (.in1(cfblk162_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk80_inst (.in1(cfblk181_out1),  // uint8
  ...
  Mysubsystem_46 u_Mysubsystem_46 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
  ...
  assign cfblk13_out1 = cfblk11_out1 + Mysubsystem_46_out1;
  ...
  assign cfblk172_reg_next[0] = Mysubsystem_19_out2;
  assign cfblk172_reg_next[1] = cfblk172_reg[0];



  DotProduct_block5 u_cfblk62_inst (.in1(cfblk124_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk78_inst (.in1(cfblk90_out1),  // uint8
  ...
  assign dtc_out_10 = cfblk156_out1;
  ...
  assign dtc_out_11 = cfblk41_out1;
  ...
  assign dtc_out_12 = cfblk60_out1;



  assign cfblk21_out1 = dtc_out_12;
  ...
  assign cfblk161_reg_next[0] = Mysubsystem_19_out1;
  assign cfblk161_reg_next[1] = cfblk161_reg[0];



  DotProduct_block4 u_cfblk32_inst (.in1(cfblk161_out1),  // uint8
                                    .in2(cfblk48_out1),  // uint8
                                    .out1(cfblk32_out1)  // uint8
                                    );

  assign cfblk146_out1 = cfblk32_out1 - cfblk123_out1;



  assign cfblk68_out1 = cfblk146_out1 + cfblk68_const_val_1;



  assign cfblk131_out1 = cfblk68_out1 - cfblk91_out1;



  assign cfblk7_out1 = cfblk131_out1 - cfblk41_out1;



  Mysubsystem_19 u_Mysubsystem_19 (.In1(cfblk7_out1),  // uint8
                                   .In2(cfblk70_out1),  // uint8
                                   .In3(cfblk73_out1),  // uint8
                                   .In4(cfblk132_out1),  // uint8
                                   .Out1(Mysubsystem_19_out1),  // uint8
                                   .Out2(Mysubsystem_19_out2)  // uint8
                                   );

  assign Hdl_out = Mysubsystem_19_out1;
