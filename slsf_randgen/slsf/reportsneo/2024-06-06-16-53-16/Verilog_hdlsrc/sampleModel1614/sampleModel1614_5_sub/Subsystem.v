// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1614\sampleModel1614_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1614_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk19_out1 = Mysubsystem_2_out1 + cfblk19_const_val_1;
  ...
  assign dtc_out_2 = cfblk117_out1;
  ...
  always @(cfblk146_out1, cfblk85_out1) begin
    ...
    if (cfblk85_out1 == 8'b00000000) begin
      ...
      cfblk107_t_0_0 = {1'b0, cfblk146_out1};
      cfblk107_div_temp = cfblk107_t_0_0 / cfblk85_out1;
  ...
  Mysubsystem_18 u_Mysubsystem_18 (.In1(cfblk72_out1),  // uint8
  ...
  assign cfblk178_reg_next[0] = Mysubsystem_18_out1;
  ...
  always @(Mysubsystem_2_out2, cfblk84_out1) begin
    cfblk134_div_temp = 9'b000000000;
    cfblk134_t_0_0 = 9'b000000000;
    if (Mysubsystem_2_out2 == 8'b00000000) begin
      cfblk134_out1 = 8'b11111111;
    end
    else begin
      cfblk134_t_0_0 = {1'b0, cfblk84_out1};
      cfblk134_div_temp = cfblk134_t_0_0 / Mysubsystem_2_out2;
  ...
  assign cfblk26_out1 = Mysubsystem_2_out2 - cfblk34_out1;
