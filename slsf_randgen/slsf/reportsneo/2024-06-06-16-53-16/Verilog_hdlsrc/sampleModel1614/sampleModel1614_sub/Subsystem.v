// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1614\sampleModel1614_sub\Subsystem.v
// Created: 2024-08-13 04:40:25
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1614_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  always @(cfblk107_out1, cfblk72_out1) begin
    ...
    if (cfblk107_out1 == 8'b00000000) begin
      ...
      cfblk50_t_0_0 = {1'b0, cfblk72_out1};
      cfblk50_div_temp = cfblk50_t_0_0 / cfblk107_out1;
  ...
  assign cfblk8_out1 = cfblk50_out1 + cfblk8_const_val_1;
  ...
  assign cfblk178_reg_next[0] = cfblk8_out1;
  ...
  assign dtc_out_3 = cfblk164_out1;
  ...
  assign dtc_out_4 = cfblk129_out1;



  assign cfblk80_out1 = dtc_out_4;
  ...
  assign dtc_out_5 = cfblk128_out1;



  assign cfblk79_out1 = dtc_out_5;
