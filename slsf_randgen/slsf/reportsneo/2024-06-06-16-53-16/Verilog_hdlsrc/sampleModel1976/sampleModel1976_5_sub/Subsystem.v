// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1976\sampleModel1976_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1976_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_24_out2;  // uint8
  ...
  assign cfblk191_reg_next[0] = Mysubsystem_5_out1;
  ...
  Mysubsystem_24 u_Mysubsystem_24 (.In1(cfblk70_out1),  // uint8
                                   ...
                                   .In3(cfblk101_out1),  // uint8
                                   .Out1(Mysubsystem_24_out1),  // uint8
                                   .Out2(Mysubsystem_24_out2)  // uint8
                                   );
  ...
  assign cfblk184_reg_next[0] = Mysubsystem_24_out2;
  ...
  assign cfblk188_reg_next[0] = Mysubsystem_1_out1;
  ...
  assign cfblk165_reg_next[0] = Mysubsystem_29_out2;
  assign cfblk165_reg_next[1] = cfblk165_reg[0];



  assign cfblk64_out1 = cfblk165_out1 + cfblk195_out1;
  ...
  assign cfblk104_out1 = cfblk35_out1 + cfblk195_out1;
  ...
  Mysubsystem_21 u_Mysubsystem_21 (.clk(clk),
                                   ...
                                   .Out1(Mysubsystem_21_out1)
                                   );

  Mysubsystem_39 u_Mysubsystem_39 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_21_out1),
                                   .In2(cfblk150_out1),  // uint8
                                   .Out1(Mysubsystem_39_out1)  // uint16
                                   );

  assign cfblk195_out1 = Mysubsystem_39_out1[7:0];



  assign cfblk141_out1 = cfblk153_out1 + cfblk195_out1;
  ...
  DotProduct_block u_cfblk134_inst (.in1(cfblk178_out1),  // uint8
                                    .in2(cfblk42_out1),  // uint8
                                    .out1(cfblk134_out1)  // uint8
                                    );

  always @(cfblk134_out1, cfblk195_out1) begin
    ...
    if (cfblk195_out1 == 8'b00000000) begin
      ...
      cfblk79_div_temp = cfblk79_t_0_0 / cfblk195_out1;
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk18_out1),  // uint8
                                   .In2(cfblk71_out1),  // uint8
                                   .In3(Mysubsystem_24_out1),  // uint8
                                   .cfblk152(Mysubsystem_29_out1),  // uint8
                                   .Out2(Mysubsystem_29_out2)  // uint8
                                   );

  assign cfblk152 = Mysubsystem_29_out1;
