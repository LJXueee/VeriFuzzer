// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1567\sampleModel1567_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1567_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_36_out1;  // ufix16_En7
  reg [15:0] cfblk175_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk175_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk175_out1;  // ufix16_En7
  ...
  wire signed [31:0] cfblk80_sub_cast;  // sfix32_En7
  wire signed [31:0] cfblk80_sub_cast_1;  // sfix32_En7
  wire signed [31:0] cfblk80_sub_temp;  // sfix32_En7
  ...
  assign cfblk108_out1 = Mysubsystem_41_out1 + cfblk108_const_val_1;
  ...
  Mysubsystem_36 u_Mysubsystem_36 (.In1(cfblk103_out1),  // uint8
                                   .In2(cfblk135_out1),  // uint8
                                   .Out1(Mysubsystem_36_out1)  // ufix16_En7
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk175_process
      if (reset == 1'b1) begin
        cfblk175_reg[0] <= 16'b0000000000000000;
        cfblk175_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk175_reg_next[0] = Mysubsystem_36_out1;
  ...
  assign cfblk141_1 = {16'b0, Mysubsystem_30_out1};
  ...
  assign cfblk135_out1 = dtc_out_6;



  assign dtc_out_7 = cfblk135_out1;
  ...
  assign cfblk55_out1 = dtc_out_10;
  ...
  assign cfblk80_sub_cast = {17'b0, {cfblk44_out1, 7'b0000000}};
  assign cfblk80_sub_cast_1 = {16'b0, cfblk175_out1};
  assign cfblk80_sub_temp = cfblk80_sub_cast - cfblk80_sub_cast_1;
  assign cfblk80_out1 = cfblk80_sub_temp[14:7];
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.In1(cfblk114_out1),  // uint8
                                   .cfblk146(Mysubsystem_32_out1)  // uint8
                                   );

  assign cfblk146 = Mysubsystem_32_out1;
