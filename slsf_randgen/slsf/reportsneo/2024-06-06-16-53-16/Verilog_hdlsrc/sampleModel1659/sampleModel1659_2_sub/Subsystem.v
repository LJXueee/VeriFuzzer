// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1659\sampleModel1659_2_sub\Subsystem.v
// Created: 2024-06-10 09:49:03
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1659_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_56_out1;  // uint8
  ...
  DotProduct_block3 u_cfblk75_inst (.in1(cfblk46_out1),  // uint8
  ...
  Mysubsystem_56 u_Mysubsystem_56 (.Out1(Mysubsystem_56_out1)  // uint8
                                   );
  ...
  DotProduct_block6 u_cfblk96_inst (.in1(cfblk126_out1),  // uint8
  ...
  assign cfblk10_out1 = Mysubsystem_56_out1 + cfblk9_out1;
  ...
  DotProduct_block4 u_cfblk80_inst (.in1(cfblk75_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk88_inst (.in1(cfblk147_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk126_inst (.in1(cfblk115_out1),  // uint8
                                     .in2(cfblk174_out1),  // uint8
                                     .out1(cfblk126_out1)  // uint8
                                     );

  DotProduct_block1 u_cfblk116_inst (.in1(cfblk126_out1),  // uint8
  ...
  assign cfblk38_out1 = cfblk116_out1 + cfblk38_const_val_1;
