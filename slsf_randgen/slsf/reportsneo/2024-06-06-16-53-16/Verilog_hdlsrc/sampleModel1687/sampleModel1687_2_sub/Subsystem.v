// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1687\sampleModel1687_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1687_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_18 u_Mysubsystem_18 (.Out1(Mysubsystem_18_out1),  // uint8
                                   .Out2(Mysubsystem_18_out2),  // uint8
                                   .Out3(Mysubsystem_18_out3)  // uint8
                                   );

  assign dtc_out = Mysubsystem_18_out1;
  ...
  assign cfblk31_out1 = (Mysubsystem_28_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk97_out1 = cfblk104_out1 + Mysubsystem_18_out3;
  ...
  assign cfblk26_out1 = cfblk116_out1 + Mysubsystem_18_out2;
  ...
  assign dtc_out_11 = cfblk20_out1;
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk126_out1),  // uint8
                                   .Out1(Mysubsystem_28_out1)  // uint8
                                   );

  assign Hdl_out = Mysubsystem_28_out1;
