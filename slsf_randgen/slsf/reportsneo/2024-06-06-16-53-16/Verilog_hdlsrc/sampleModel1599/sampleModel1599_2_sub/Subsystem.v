// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1599\sampleModel1599_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1599_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_45_out2;  // uint8
  ...
  Mysubsystem_47 u_Mysubsystem_47 (.Out1(Mysubsystem_47_out1)  // uint8
                                   );

  Mysubsystem_45 u_Mysubsystem_45 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_47_out1),  // uint8
                                   .In2(cfblk40_out1),  // uint8
                                   .Out1(Mysubsystem_45_out1),  // uint8
                                   .Out2(Mysubsystem_45_out2)  // uint8
                                   );

  assign cfblk40_out1 = (Mysubsystem_45_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk112_out1 = Mysubsystem_45_out2 + cfblk104_out1;
  ...
  Mysubsystem_10 u_Mysubsystem_10 (.In1(cfblk6_out1),  // uint8
                                   .In2(cfblk7_out1),  // uint8
                                   .In3(cfblk33_out1),  // uint8
                                   .In4(cfblk49_out1),  // uint8
  ...
  assign cfblk30_out1 = cfblk61_out1 + Mysubsystem_39_out1;
  ...
  assign cfblk75_out1 = dtc_out_8;



  assign Hdl_out = cfblk75_out1;
