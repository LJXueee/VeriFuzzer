// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1955\sampleModel1955_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1955_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_42 u_Mysubsystem_42 (.In1(cfblk154_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk59_inst (.in1(cfblk181_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk79_inst (.in1(cfblk178_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk16_inst (.in1(cfblk68_out1),  // uint8
  ...
  DotProduct_block10 u_cfblk99_inst (.in1(cfblk20_out1),  // uint8
  ...
  assign cfblk185_reg_next[0] = Mysubsystem_30_out1;
  ...
  DotProduct_block9 u_cfblk94_inst (.in1(cfblk175_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk62_inst (.in1(cfblk173_out1),  // uint8
                                    .in2(cfblk98_out1),  // uint8
                                    .out1(cfblk62_out1)  // uint8
                                    );

  DotProduct_block8 u_cfblk85_inst (.in1(cfblk62_out1),  // uint8
                                    .in2(cfblk190_out1),  // uint8
                                    .out1(cfblk85_out1)  // uint8
                                    );

  assign dtc_out_9 = cfblk85_out1;
  ...
  assign dtc_out_10 = cfblk6_out1;



  assign cfblk106_out1 = dtc_out_10;
  ...
  assign cfblk50_out1 = dtc_out_11;



  assign dtc_out_12 = cfblk50_out1;



  assign cfblk65_out1 = dtc_out_12;
  ...
  assign dtc_out_13 = cfblk13_out1;



  assign cfblk83_out1 = dtc_out_13;
  ...
  assign cfblk78_out1 = cfblk77_out1 + cfblk78_const_val_1;
  ...
  assign cfblk193_reg_next[0] = cfblk15_out1;
  ...
  assign dtc_out_14 = cfblk24_out1;



  assign cfblk135_out1 = dtc_out_14;



  assign dtc_out_15 = cfblk135_out1;



  assign cfblk73_out1 = dtc_out_15;



  assign dtc_out_16 = cfblk73_out1;



  assign cfblk82_out1 = dtc_out_16;
  ...
  assign dtc_out_17 = cfblk184_out1;



  assign cfblk92_out1 = dtc_out_17;



  assign cfblk53_out1 = cfblk24_out1 + cfblk103_out1;



  DotProduct_block3 u_cfblk152_inst (.in1(cfblk92_out1),  // uint8
  ...
  assign cfblk151_out1 = cfblk152_out1 + cfblk151_const_val_1;
