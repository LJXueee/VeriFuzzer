// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1971\sampleModel1971_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1971_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_35_out1;  // ufix16_En7
  ...
  wire [31:0] cfblk63_add_cast;  // ufix32_En7
  wire [31:0] cfblk63_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk63_add_temp;  // ufix32_En7
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.In1(cfblk110_out1),  // uint8
                                   .Out1(Mysubsystem_35_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk153_reg_next[0] = Mysubsystem_35_out1;
  ...
  assign cfblk133_reg_next[0] = cfblk68_out1;
  ...
  assign cfblk75_out1 = cfblk1_out1 - cfblk135_out1;



  assign cfblk63_add_cast = {17'b0, {cfblk75_out1, 7'b0000000}};
  assign cfblk63_add_cast_1 = {16'b0, cfblk153_out1};
  assign cfblk63_add_temp = cfblk63_add_cast + cfblk63_add_cast_1;
  assign cfblk63_out1 = cfblk63_add_temp[14:7];
  ...
  assign cfblk38_out1 = Mysubsystem_41_out1 + cfblk40_out1;
  ...
  DotProduct_block6 u_cfblk91_inst (.in1(Mysubsystem_41_out2),  // uint8
  ...
  assign cfblk114_out1 = dtc_out_6;
