// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1971\sampleModel1971_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1971_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] cfblk136_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk136_out1;  // ufix16_En7
  reg [7:0] cfblk74_out1;  // uint8
  reg [7:0] cfblk150_reg [0:1];  // ufix8 [2]
  wire [7:0] cfblk150_reg_next [0:1];  // ufix8 [2]
  wire [7:0] cfblk150_out1;  // uint8
  wire [7:0] Mysubsystem_28_out3;  // uint8
  ...
  wire [31:0] cfblk72_add_cast;  // ufix32_En7
  wire [31:0] cfblk72_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk72_add_temp;  // ufix32_En7
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.In1(Mysubsystem_28_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk136_process
      if (reset == 1'b1) begin
        cfblk136_reg[0] <= 16'b0000000000000000;
        cfblk136_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk136_reg_next[0] = Mysubsystem_35_out1;
  ...
  assign cfblk137_reg_next[0] = Mysubsystem_28_out3;
  ...
  assign cfblk104_out1 = dtc_out_2;
  ...
  assign cfblk72_add_cast = {17'b0, {cfblk114_out1, 7'b0000000}};
  assign cfblk72_add_cast_1 = {16'b0, cfblk136_out1};
  assign cfblk72_add_temp = cfblk72_add_cast + cfblk72_add_cast_1;
  assign cfblk72_out1 = cfblk72_add_temp[14:7];
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk41_out1),  // uint8
                                   .In2(cfblk35_out1),  // uint8
                                   .Out1(Mysubsystem_28_out1),  // uint8
                                   .cfblk119(Mysubsystem_28_out2),  // uint8
                                   .Out3(Mysubsystem_28_out3)  // uint8
                                   );

  assign cfblk119 = Mysubsystem_28_out2;

  assign Hdl_out = cfblk153_out1;
