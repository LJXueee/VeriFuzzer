// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1636\sampleModel1636_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1636_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk82_out1 = (Mysubsystem_41_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk113_out1),  // uint16
                                   .In2(cfblk122_out1),  // uint8
                                   .Out1(Mysubsystem_13_out1)  // uint8
                                   );

  Mysubsystem_31 u_Mysubsystem_31 (.In4(Mysubsystem_13_out1),  // uint8
  ...
  assign cfblk161_reg_next[0] = Mysubsystem_31_out1;
  ...
  assign dtc_out_4 = cfblk179_out1;
  ...
  assign dtc_out_7 = cfblk127_out1;



  assign cfblk70_out1 = dtc_out_7;
  ...
  assign dtc_out_8 = cfblk150_out1;
  ...
  assign cfblk78_out1 = cfblk65_out1 + cfblk82_out1;
