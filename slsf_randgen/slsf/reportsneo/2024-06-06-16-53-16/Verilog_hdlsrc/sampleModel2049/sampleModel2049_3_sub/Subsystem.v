// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2049\sampleModel2049_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel2049_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_19_out1;  // ufix16_En7
  ...
  DotProduct_block4 u_cfblk28_inst (.in1(cfblk29_out1),  // uint8
  ...
  always @(cfblk150_out1, cfblk50_out1) begin
    ...
    if (cfblk50_out1 == 8'b00000000) begin
      ...
      cfblk42_t_0_0 = {1'b0, cfblk150_out1};
      cfblk42_div_temp = cfblk42_t_0_0 / cfblk50_out1;
  ...
  DotProduct_block9 u_cfblk81_inst (.in1(cfblk42_out1),  // uint8
  ...
  assign cfblk60_out1 = cfblk58_out1 + cfblk81_out1;
  ...
  assign cfblk163_reg_next[0] = cfblk60_out1;
  ...
  DotProduct_block3 u_cfblk26_inst (.in1(cfblk62_out1),  // uint8
  ...
  Mysubsystem_32 u_Mysubsystem_32 (.In1(cfblk50_out1),  // uint8
                                   .Out1(Mysubsystem_32_out1)  // ufix16_En7
                                   );

  Mysubsystem_19 u_Mysubsystem_19 (.In1(Mysubsystem_32_out1),  // ufix16_En7
                                   .Out1(Mysubsystem_19_out1)  // ufix16_En7
                                   );
  ...
  assign cfblk162_reg_next[0] = Mysubsystem_19_out1;
  ...
  assign cfblk38_add_cast = {17'b0, {cfblk132_out1, 7'b0000000}};
  assign cfblk38_add_cast_1 = {16'b0, cfblk162_out1};
  assign cfblk38_add_temp = cfblk38_add_cast + cfblk38_add_cast_1;
  assign cfblk38_out1 = cfblk38_add_temp[14:7];
  ...
  assign cfblk76_out1 = cfblk155_out1 + cfblk76_const_val_1;
  ...
  assign cfblk161_reg_next[0] = cfblk76_out1;
  ...
  DotProduct_block1 u_cfblk127_inst (.in1(cfblk49_out1),  // uint8
                                     .in2(cfblk27_out1),  // uint8
                                     .out1(cfblk127_out1)  // uint8
                                     );

  DotProduct_block5 u_cfblk36_inst (.in1(cfblk127_out1),  // uint8
  ...
  assign cfblk111_out1 = dtc_out_6;
  ...
  assign dtc_out_8 = cfblk146_out1;



  assign cfblk107_out1 = dtc_out_8;
  ...
  DotProduct_block7 u_cfblk69_inst (.in1(cfblk27_out1),  // uint8
  ...
  DotProduct_block u_cfblk121_inst (.in1(cfblk102_out1),  // uint8
                                    .in2(cfblk172_out1),  // uint8
                                    .out1(cfblk121_out1)  // uint8
                                    );

  assign dtc_out_9 = cfblk63_out1;
  ...
  DotProduct_block8 u_cfblk72_inst (.in1(cfblk67_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk19_inst (.in1(cfblk15_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk63_inst (.in1(cfblk140_out1),  // uint8
  ...
  assign cfblk122_out1 = dtc_out_11;



  assign Hdl_out = cfblk122_out1;
