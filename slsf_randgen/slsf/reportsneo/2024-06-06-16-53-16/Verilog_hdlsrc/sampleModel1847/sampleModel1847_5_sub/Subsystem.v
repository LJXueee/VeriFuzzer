// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1847\sampleModel1847_5_sub\Subsystem.v
// Created: 2024-08-14 19:27:57
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1847_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] cfblk35_add_temp;  // ufix32
  wire [31:0] cfblk35_1;  // ufix32
  wire [31:0] cfblk35_2;  // ufix32
  ...
  assign cfblk49_out1 = (Mysubsystem_40_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.Out1(Mysubsystem_41_out1)  // uint8
                                   );

  assign dtc_out_1 = Mysubsystem_41_out1;
  ...
  assign cfblk41_out1 = Mysubsystem_41_out1 + cfblk35_out1;



  assign cfblk29_out1 = cfblk41_out1 + Mysubsystem_40_out1;
  ...
  DotProduct_block u_cfblk12_inst (.in1(cfblk185_out1),  // uint8
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.In2(cfblk114_out1),  // uint8
                                   .In4(cfblk43_out1),  // uint8
  ...
  assign cfblk184_reg_next[0] = Mysubsystem_31_out1;
  ...
  DotProduct_block2 u_cfblk144_inst (.in1(cfblk137_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk34_inst (.in1(cfblk173_out1),  // uint8
  ...
  DotProduct_block6 u_cfblk56_inst (.in1(cfblk113_out1),  // uint8
  ...
  DotProduct_block10 u_cfblk81_inst (.in1(cfblk183_out1),  // uint8
  ...
  assign cfblk150_out1 = Mysubsystem_40_out1 + cfblk10_out1;
  ...
  DotProduct_block1 u_cfblk133_inst (.in1(cfblk91_out1),  // uint8
  ...
  Mysubsystem_29 u_Mysubsystem_29 (.In1(cfblk134_out1),  // uint8
  ...
  assign cfblk177_reg_next[0] = Mysubsystem_29_out1;
  ...
  DotProduct_block7 u_cfblk58_inst (.in1(cfblk1_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk24_inst (.in1(cfblk82_out1),  // uint8
  ...
  assign cfblk35_1 = {24'b0, cfblk167_out1};
  assign cfblk35_2 = {16'b0, cfblk184_out1};
  assign cfblk35_add_temp = cfblk35_1 + cfblk35_2;
  assign cfblk35_out1 = cfblk35_add_temp[7:0];
  ...
  DotProduct_block8 u_cfblk7_inst (.in1(cfblk146_out1),  // uint8
  ...
  DotProduct_block11 u_cfblk87_inst (.in1(cfblk106_out1),  // uint8
                                     .in2(cfblk56_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk55_inst (.in1(cfblk35_out1),  // uint8
  ...
  assign cfblk97_out1 = cfblk55_out1 + cfblk97_const_val_1;



  Mysubsystem_33 u_Mysubsystem_33 (.u(cfblk97_out1),  // uint8
                                   .cfblk161(Mysubsystem_33_out1)  // uint8
                                   );

  assign cfblk161 = Mysubsystem_33_out1;
