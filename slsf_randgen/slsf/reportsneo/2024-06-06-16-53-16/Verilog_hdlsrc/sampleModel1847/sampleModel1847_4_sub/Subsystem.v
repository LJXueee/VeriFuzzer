// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1847\sampleModel1847_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1847_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_23_out3;  // uint8
  ...
  Mysubsystem_23 u_Mysubsystem_23 (.clk(clk),
                                   ...
                                   .Out3(Mysubsystem_23_out3)  // uint8
                                   );

  assign cfblk49_out1 = (Mysubsystem_23_out2 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);
  ...
  assign cfblk29_out1 = cfblk41_out1 + Mysubsystem_23_out1;
  ...
  DotProduct_block10 u_cfblk9_inst (.in1(cfblk43_out1),  // uint8
  ...
  Mysubsystem_37 u_Mysubsystem_37 (.In1(cfblk144_out1),  // uint8
                                   .Out1(Mysubsystem_37_out1)  // uint8
                                   );

  cfblk168 u_cfblk168 (.In1(Mysubsystem_37_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk56_inst (.in1(cfblk113_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk81_inst (.in1(cfblk183_out1),  // uint8
  ...
  assign cfblk150_out1 = Mysubsystem_23_out3 + cfblk10_out1;
  ...
  Mysubsystem_16 u_Mysubsystem_16 (.In1(cfblk134_out1),  // uint8
  ...
  assign cfblk177_reg_next[0] = Mysubsystem_16_out1;
  ...
  DotProduct_block6 u_cfblk58_inst (.in1(cfblk1_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk7_inst (.in1(cfblk146_out1),  // uint8
  ...
  DotProduct_block9 u_cfblk87_inst (.in1(cfblk106_out1),  // uint8
                                    .in2(cfblk56_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk55_inst (.in1(cfblk35_out1),  // uint8
                                    .in2(cfblk140_out1),  // uint8
                                    .out1(cfblk55_out1)  // uint8
                                    );

  Mysubsystem_21 u_Mysubsystem_21 (.In1(cfblk55_out1),  // uint8
                                   .cfblk161(Mysubsystem_21_out1)  // uint8
                                   );

  assign cfblk161 = Mysubsystem_21_out1;
