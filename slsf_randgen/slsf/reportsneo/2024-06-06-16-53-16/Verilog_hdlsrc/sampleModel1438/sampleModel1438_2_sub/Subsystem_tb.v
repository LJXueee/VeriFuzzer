// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1438\sampleModel1438_2_sub\Subsystem_tb.v
// Created: 2024-08-12 05:10:04
// 
...
module Subsystem_tb;
  ...
  assign Hdl_out_lastAddr = cfblk136_addr >= 4'b1010;
  ...
  assign cfblk136_active = cfblk136_addr != 4'b1010;
  ...
  assign cfblk136_enb = ce_out & cfblk136_active;
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        cfblk136_addr <= 4'b0000;
      end
      else begin
        if (cfblk136_enb) begin
          if (cfblk136_addr >= 4'b1010) begin
            cfblk136_addr <= 4'b0000;
          end
          else begin
            cfblk136_addr <= cfblk136_addr + 4'b0001;
          end
        end
      end
    end
  ...
  assign cfblk136_lastAddr = cfblk136_addr >= 4'b1010;
  ...
  assign cfblk136_expected_table_data[0] = 8'b11111111;
  assign cfblk136_expected_table_data[1] = 8'b11111111;
  assign cfblk136_expected_table_data[2] = 8'b11111111;
  assign cfblk136_expected_table_data[3] = 8'b00000000;
  assign cfblk136_expected_table_data[4] = 8'b00000010;
  assign cfblk136_expected_table_data[5] = 8'b00000010;
  assign cfblk136_expected_table_data[6] = 8'b00000010;
  assign cfblk136_expected_table_data[7] = 8'b00000010;
  assign cfblk136_expected_table_data[8] = 8'b00000010;
  assign cfblk136_expected_table_data[9] = 8'b00000010;
  assign cfblk136_expected_table_data[10] = 8'b00000010;
  assign cfblk136_expected_1 = cfblk136_expected_table_data[cfblk136_addr];
  ...
  assign Hdl_out_expected_1 = Hdl_out_expected_table_data[cfblk136_addr];
  ...
  assign testFailure = cfblk136_testFailure | Hdl_out_testFailure;
