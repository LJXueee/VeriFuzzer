// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1962\sampleModel1962_3_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1962_3_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  Mysubsystem_8 u_Mysubsystem_8 (.clk(clk),
                                 ...
                                 .y(Mysubsystem_8_out2),  // uint8
                                 .Out3(Mysubsystem_8_out3)  // uint8
                                 );
  ...
  Mysubsystem_5 u_Mysubsystem_5 (.In1(cfblk112_out1),  // uint8
  ...
  assign cfblk145_reg_next[0] = Mysubsystem_5_out1;
  ...
  assign cfblk154_reg_next[0] = Mysubsystem_25_out1;
  ...
  assign cfblk50_out1 = Mysubsystem_8_out1 + cfblk90_out1;
  ...
  assign cfblk85_out1 = dtc_out_2;



  assign dtc_out_3 = cfblk85_out1;
  ...
  assign cfblk108_out1 = cfblk33_out1 + Mysubsystem_8_out3;
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk12_out1),  // uint8
                                   .In2(cfblk27_out1),  // uint8
                                   .In3(cfblk33_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // uint8
                                   );

  assign Hdl_out = Mysubsystem_25_out1;
