// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1962\sampleModel1962_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1962_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [15:0] Mysubsystem_2_out1;  // int16
  reg signed [15:0] cfblk144_reg [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk144_reg_next [0:1];  // sfix16 [2]
  wire signed [15:0] cfblk144_out1;  // int16
  wire [7:0] cfblk75_out1;  // uint8
  wire signed [31:0] cfblk94_add_temp;  // sfix32
  wire signed [31:0] cfblk94_1;  // sfix32
  wire signed [31:0] cfblk94_2;  // sfix32
  ...
  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk128_out1),  // uint8
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_33_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // uint8
                                   );

  DotProduct_block1 u_cfblk14_inst (.in1(cfblk68_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk17_inst (.in1(cfblk131_out1),  // uint8
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.In1(cfblk60_out1),  // uint8
  ...
  assign cfblk147_reg_next[0] = Mysubsystem_31_out1;
  ...
  Mysubsystem_12 u_Mysubsystem_12 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(cfblk10_out1),  // uint8
                                   .In2(cfblk13_out1),  // uint8
                                   .In3(cfblk16_out1),  // uint8
  ...
  assign cfblk146_reg_next[0] = Mysubsystem_12_out1;
  ...
  Mysubsystem_2 u_Mysubsystem_2 (.In1(cfblk46_out1),  // uint8
                                 .Out1(Mysubsystem_2_out1)  // int16
                                 );

  always @(posedge clk or posedge reset)
    begin : cfblk144_process
      if (reset == 1'b1) begin
        cfblk144_reg[0] <= 16'sb0000000000000000;
        cfblk144_reg[1] <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk144_reg_next[0] = Mysubsystem_2_out1;
  assign cfblk144_reg_next[1] = cfblk144_reg[0];



  assign cfblk94_1 = {24'b0, cfblk75_out1};
  assign cfblk94_2 = {{16{cfblk144_out1[15]}}, cfblk144_out1};
  assign cfblk94_add_temp = cfblk94_1 + cfblk94_2;
  assign cfblk94_out1 = cfblk94_add_temp[7:0];
  ...
  DotProduct_block4 u_cfblk23_inst (.in1(cfblk133_out1),  // uint8
  ...
  DotProduct_block u_cfblk111_inst (.in1(cfblk48_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk15_inst (.in1(cfblk139_out1),  // uint8
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.In1(cfblk8_out1),  // uint8
                                   .In2(cfblk85_out1),  // uint8
                                   .In3(cfblk111_out1),  // uint8
                                   .In4(cfblk124_out1),  // uint8
  ...
  assign cfblk160_reg_next[0] = Mysubsystem_26_out1;
  assign cfblk160_reg_next[1] = cfblk160_reg[0];



  assign cfblk40_1 = {16'b0, cfblk160_out1};
  assign cfblk40_2 = {24'b0, cfblk39_out1};
