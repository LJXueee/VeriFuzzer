// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1475\sampleModel1475_5_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1475_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] Mysubsystem_28_out1;  // uint32
  reg [31:0] cfblk171_reg [0:1];  // ufix32 [2]
  wire [31:0] cfblk171_reg_next [0:1];  // ufix32 [2]
  wire [31:0] cfblk171_out1;  // uint32
  ...
  DotProduct_block4 u_cfblk123_inst (.in1(cfblk30_out1),  // uint8
  ...
  Mysubsystem_37 u_Mysubsystem_37 (.In1(Mysubsystem_18_out1),  // uint8
                                   .In2(cfblk92_out1),  // uint8
                                   .In3(cfblk91_out1),  // uint8
  ...
  assign cfblk155_reg_next[0] = Mysubsystem_37_out1;
  ...
  assign cfblk170_reg_next[0] = Mysubsystem_20_out1;
  ...
  DotProduct_block1 u_cfblk104_inst (.in1(cfblk92_out1),  // uint8
  ...
  Mysubsystem_20 u_Mysubsystem_20 (.In1(cfblk87_out1),  // uint8
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk103_out1),  // uint8
                                   .In2(Mysubsystem_20_out1),  // uint8
                                   .In3(cfblk141_out1),  // uint8
                                   .Out1(Mysubsystem_28_out1)  // uint32
                                   );

  always @(posedge clk or posedge reset)
    begin : cfblk171_process
      if (reset == 1'b1) begin
        cfblk171_reg[0] <= 32'b00000000000000000000000000000000;
        cfblk171_reg[1] <= 32'b00000000000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk171_reg_next[0] = Mysubsystem_28_out1;
  assign cfblk171_reg_next[1] = cfblk171_reg[0];



  assign cfblk80_1 = cfblk171_out1;
  assign cfblk80_2 = {24'b0, cfblk45_out1};
  ...
  DotProduct_block3 u_cfblk120_inst (.in1(cfblk73_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk12_inst (.in1(cfblk69_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk60_inst (.in1(cfblk114_out1),  // uint8
  ...
  assign dtc_out_5 = cfblk26_out1;



  assign cfblk87_out1 = dtc_out_5;
  ...
  DotProduct_block6 u_cfblk29_inst (.in1(cfblk168_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk36_inst (.in1(cfblk131_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk24_inst (.in1(cfblk84_out1),  // uint8
  ...
  Mysubsystem_8 u_Mysubsystem_8 (.In1(cfblk109_out1),  // uint8
                                 .In2(Mysubsystem_20_out1),  // uint8
                                 .Out1(Mysubsystem_8_out1)  // uint8
                                 );

  Mysubsystem_17 u_Mysubsystem_17 (.In1(cfblk5_out1),  // uint8
                                   .In2(cfblk22_out1),  // uint8
                                   .In3(Mysubsystem_8_out1),  // uint8
                                   .cfblk143(Mysubsystem_17_out1)  // uint8
                                   );

  assign cfblk143 = Mysubsystem_17_out1;
