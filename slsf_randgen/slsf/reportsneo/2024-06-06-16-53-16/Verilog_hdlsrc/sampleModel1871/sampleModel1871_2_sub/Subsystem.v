// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1871\sampleModel1871_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1871_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [7:0] Mysubsystem_2_out2;  // uint8
  ...
  wire [15:0] Mysubsystem_9_out2;  // ufix16_En7
  reg [15:0] cfblk138_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk138_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk138_out1;  // ufix16_En7
  wire [7:0] cfblk57_out1;  // uint8
  wire signed [31:0] cfblk121_sub_cast;  // sfix32_En7
  wire signed [31:0] cfblk121_sub_cast_1;  // sfix32_En7
  wire signed [31:0] cfblk121_sub_temp;  // sfix32_En7
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.In1(cfblk106_out1),  // uint8
                                   .Out1(Mysubsystem_26_out1)  // uint8
                                   );

  Mysubsystem_33 u_Mysubsystem_33 (.In1(cfblk27_out1),  // uint8
                                   .In2(cfblk68_out1),  // uint8
                                   .In3(cfblk22_out1),  // uint8
                                   .In4(cfblk94_out1),  // uint8
                                   .Out1(Mysubsystem_33_out1)  // uint8
                                   );

  Mysubsystem_2 u_Mysubsystem_2 (.In1(Mysubsystem_33_out1),  // uint8
                                 .In2(Mysubsystem_26_out1),  // uint8
                                 .Out2(Mysubsystem_2_out2)  // uint8
                                 );
  ...
  assign cfblk136_reg_next[0] = Mysubsystem_2_out2;
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.In2(cfblk102_out1),  // uint8
                                 .Out2(Mysubsystem_9_out2)  // ufix16_En7
                                 );

  always @(posedge clk or posedge reset)
    begin : cfblk138_process
      if (reset == 1'b1) begin
        cfblk138_reg[0] <= 16'b0000000000000000;
        cfblk138_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk138_reg_next[0] = Mysubsystem_9_out2;
  assign cfblk138_reg_next[1] = cfblk138_reg[0];



  assign cfblk121_sub_cast = {17'b0, {cfblk57_out1, 7'b0000000}};
  assign cfblk121_sub_cast_1 = {16'b0, cfblk138_out1};
  assign cfblk121_sub_temp = cfblk121_sub_cast - cfblk121_sub_cast_1;
  assign cfblk121_out1 = cfblk121_sub_temp[14:7];
