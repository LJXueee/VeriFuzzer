// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1838\sampleModel1838_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1838_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [63:0] Mysubsystem_35_out1;  // ufix64
  wire [63:0] Mysubsystem_34_out1;  // ufix64
  wire [63:0] Mysubsystem_32_out1;  // ufix64
  ...
  Mysubsystem_3 u_Mysubsystem_3 (.In1(cfblk24_out1),  // uint8
                                 .In2(cfblk2_out1),  // uint8
                                 .In3(cfblk12_out1),  // uint8
  ...
  assign cfblk141_reg_next[0] = Mysubsystem_3_out1;
  ...
  DotProduct_block6 u_cfblk82_inst (.in1(cfblk61_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk84_inst (.in1(cfblk115_out1),  // uint8
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.In1(cfblk21_out1),  // uint8
  ...
  Mysubsystem_5 u_Mysubsystem_5 (.clk(clk),
                                 .reset(reset),
                                 .enb(clk_enable),
                                 .In1(Mysubsystem_40_out1),  // uint8
                                 .In2(Mysubsystem_37_out1),  // uint8
                                 .Out1(Mysubsystem_5_out1)  // uint8
                                 );

  assign cfblk23_out1 = Mysubsystem_5_out1 + cfblk146_out1;
  ...
  DotProduct_block3 u_cfblk58_inst (.in1(cfblk105_out1),  // uint8
                                    .in2(cfblk149_out1),  // uint8
                                    .out1(cfblk58_out1)  // uint8
                                    );

  DotProduct_block1 u_cfblk14_inst (.in1(cfblk58_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk65_inst (.in1(cfblk114_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk42_inst (.in1(cfblk94_out1),  // uint8
  ...
  DotProduct_block5 u_cfblk79_inst (.in1(cfblk103_out1),  // uint8
  ...
  Mysubsystem_35 u_Mysubsystem_35 (.In1(Mysubsystem_31_out1),  // double
                                   .Out1(Mysubsystem_35_out1)  // double
                                   );

  Mysubsystem_34 u_Mysubsystem_34 (.In1(Mysubsystem_35_out1),  // double
                                   .Out1(Mysubsystem_34_out1)  // double
                                   );

  Mysubsystem_32 u_Mysubsystem_32 (.In1(Mysubsystem_34_out1),  // double
                                   .Out1(Mysubsystem_32_out1)  // double
                                   );

  Mysubsystem_31 u_Mysubsystem_31 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_32_out1),  // double
                                   .Out1(Mysubsystem_31_out1)  // double
                                   );

  always @* Mysubsystem_31_out1_double = $bitstoreal(Mysubsystem_31_out1);

  assign switch_compare_1 = Mysubsystem_31_out1_double >= 0.0;



  assign cfblk133_out1 = (switch_compare_1 == 1'b0 ? cfblk79_out1 :
              cfblk13_out1);



  always @(cfblk133_out1, cfblk78_out1) begin
    ...
    if (cfblk133_out1 == 8'b00000000) begin
      ...
      cfblk102_div_temp = cfblk102_t_0_0 / cfblk133_out1;
