// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1899\sampleModel1899_1_sub_sub\Subsystem_block.v
...
// Source Path: sampleModel1899_1_sub_sub/Subsystem/Subsystem
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Subsystem_block
  ...
  wire [7:0] Mysubsystem_31_out2;  // ufix8_En7
  ...
  assign cfblk128_out1 = dtc_out_2;
  ...
  assign cfblk25_out1 = Mysubsystem_31_out1 + cfblk27_out1;



  assign dtc_out_7 = cfblk25_out1;
  ...
  assign dtc_out_9 = cfblk38_out1;



  assign cfblk79_out1 = dtc_out_9;
  ...
  always @(Mysubsystem_35_out1, cfblk44_out1) begin
    ...
    if (cfblk44_out1 == 8'b00000000) begin
      ...
      cfblk15_t_0_0 = {1'b0, Mysubsystem_35_out1};
  ...
  Mysubsystem_31 u_Mysubsystem_31 (.clk(clk),
                                   .reset(reset),
                                   .enb(enb),
                                   .In1(cfblk15_out1),  // uint8
                                   .Out1(Mysubsystem_31_out1),  // uint8
                                   .Out2(Mysubsystem_31_out2)  // ufix8_En7
                                   );

  assign cfblk101_out1 = {7'b0, Mysubsystem_31_out2[7]};



  assign cfblk103_out1 = cfblk101_out1 - cfblk153_out1;
  ...
  assign cfblk17_out1 = dtc_out_11;
  ...
  assign dtc_out_12 = cfblk108_out1;



  assign cfblk12_out1 = dtc_out_12;
  ...
  always @(Mysubsystem_35_out1, cfblk64_out1) begin
    ...
    if (cfblk64_out1 == 8'b00000000) begin
      ...
      cfblk55_t_0_0 = {1'b0, Mysubsystem_35_out1};
  ...
  assign cfblk28_out1 = dtc_out_13;



  assign cfblk33_out1 = cfblk28_out1 + cfblk33_const_val_1;
  ...
  assign cfblk144_reg_next[0] = cfblk33_out1;
  assign cfblk144_reg_next[1] = cfblk144_reg[0];



  assign Hdl_out = cfblk144_out1;
