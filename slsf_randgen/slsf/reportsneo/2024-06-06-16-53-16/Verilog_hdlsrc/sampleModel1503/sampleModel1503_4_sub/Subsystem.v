// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1503\sampleModel1503_4_sub\Subsystem.v
// Created: 2024-06-10 05:21:07
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1503_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  DotProduct_block5 u_cfblk23_inst (.in1(cfblk104_out1),  // uint8
  ...
  DotProduct_block3 u_cfblk16_inst (.in1(cfblk88_out1),  // uint8
  ...
  DotProduct_block4 u_cfblk22_inst (.in1(cfblk8_out1),  // uint8
  ...
  DotProduct_block9 u_cfblk96_inst (.in1(cfblk156_out1),  // uint8
  ...
  assign cfblk3_out1 = {Mysubsystem_40_out1, cfblk48_out1};
  ...
  DotProduct_block6 u_cfblk27_inst (.in1(cfblk178_out1),  // uint8
  ...
  DotProduct_block8 u_cfblk67_inst (.in1(cfblk143_out1),  // uint8
  ...
  DotProduct_block7 u_cfblk34_inst (.in1(cfblk50_out1),  // uint8
  ...
  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk89_out1),  // uint8
                                   .cfblk139(Mysubsystem_28_out1)  // uint8
                                   );

  assign cfblk139 = Mysubsystem_28_out1;

  DotProduct_block2 u_cfblk14_inst (.in1(cfblk47_out1),  // uint8
                                    .in2(cfblk131_out1),  // uint8
                                    .out1(cfblk14_out1)  // uint8
                                    );

  assign cfblk18_out1 = (cfblk70_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  assign cfblk77_out1 = cfblk14_out1 + cfblk18_out1;
