// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1507\sampleModel1507_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1507_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] Mysubsystem_38_out1;  // ufix32_En15
  wire [15:0] Mysubsystem_30_out1;  // ufix16_En7
  wire [15:0] Mysubsystem_30_out2;  // ufix16_En7
  wire [15:0] Mysubsystem_6_out1;  // ufix16_En7
  wire [15:0] Mysubsystem_6_out2;  // ufix16_En7
  wire signed [15:0] cfblk54_out1;  // int16
  wire signed [31:0] cfblk123_add_cast;  // sfix32_En13
  wire signed [31:0] cfblk123_add_cast_1;  // sfix32_En13
  wire signed [31:0] cfblk123_add_temp;  // sfix32_En13
  wire [7:0] cfblk123_out1;  // uint8
  wire [7:0] cfblk137_out1;  // uint8
  wire signed [31:0] cfblk73_add_temp;  // sfix32
  wire signed [31:0] cfblk73_1;  // sfix32
  wire signed [31:0] cfblk73_2;  // sfix32
  ...
  wire [31:0] dtc_out_1;  // ufix32_En7
  ...
  wire [15:0] Mysubsystem_17_out2;  // uint16
  ...
  wire [31:0] cfblk58_add_cast;  // ufix32_En7
  wire [31:0] cfblk58_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk58_add_temp;  // ufix32_En7
  ...
  Mysubsystem_38 u_Mysubsystem_38 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_38_out1)  // ufix32_En15
                                   );

  Mysubsystem_30 u_Mysubsystem_30 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_30_out1),  // ufix16_En7
                                   .Out2(Mysubsystem_30_out2)  // ufix16_En7
                                   );

  Mysubsystem_6 u_Mysubsystem_6 (.In1(Mysubsystem_30_out1),  // ufix16_En7
                                 .Out1(Mysubsystem_6_out1),  // ufix16_En7
                                 .Out2(Mysubsystem_6_out2)  // ufix16_En7
                                 );

  assign cfblk54_out1 = (Mysubsystem_6_out1 > 16'b0000000000000000 ? 16'sb0000000000000001 :
              16'sb0000000000000000);



  assign cfblk123_add_cast = {2'b0, Mysubsystem_38_out1[31:2]};
  assign cfblk123_add_cast_1 = {{3{cfblk54_out1[15]}}, {cfblk54_out1, 13'b0000000000000}};
  assign cfblk123_add_temp = cfblk123_add_cast + cfblk123_add_cast_1;
  assign cfblk123_out1 = cfblk123_add_temp[20:13];
  ...
  assign cfblk73_1 = {24'b0, cfblk137_out1};
  assign cfblk73_2 = {{16{cfblk54_out1[15]}}, cfblk54_out1};
  assign cfblk73_add_temp = cfblk73_1 + cfblk73_2;
  assign cfblk73_out1 = cfblk73_add_temp[7:0];
  ...
  assign dtc_out_1 = {16'b0, Mysubsystem_6_out2};



  assign cfblk114_out1 = dtc_out_1[14:7];
  ...
  Mysubsystem_17 u_Mysubsystem_17 (.clk(clk),
                                   ...
                                   .Out2(Mysubsystem_17_out2)  // uint16
                                   );
  ...
  assign cfblk176_out1 = Mysubsystem_14_out1[14:7];
  ...
  assign cfblk103_1 = {16'b0, Mysubsystem_17_out2};
  ...
  assign cfblk58_add_cast = {16'b0, Mysubsystem_30_out2};
  assign cfblk58_add_cast_1 = {17'b0, {cfblk52_out1, 7'b0000000}};
  assign cfblk58_add_temp = cfblk58_add_cast + cfblk58_add_cast_1;
  assign cfblk58_out1 = cfblk58_add_temp[14:7];
