// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1507\sampleModel1507_4_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1507_4_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [15:0] Mysubsystem_19_out1;  // uint16
  ...
  Mysubsystem_19 u_Mysubsystem_19 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_19_out1)  // uint16
                                   );

  assign cfblk88_out1 = Mysubsystem_19_out1[7:0];
  ...
  assign cfblk107_out1 = Mysubsystem_38_out1 + cfblk107_const_val_1;



  assign cfblk96_y = {1'b0, cfblk107_out1};
  assign cfblk96_out1 = cfblk96_y[14:7];
  ...
  assign cfblk12_out1 = cfblk96_out1 + cfblk12_const_val_1;
  ...
  DotProduct_block7 u_cfblk57_inst (.in1(Mysubsystem_28_out1),  // uint8
  ...
  assign cfblk58_add_cast = {16'b0, cfblk107_out1};
  ...
  always @(Mysubsystem_28_out1, cfblk51_out1) begin
    cfblk22_div_temp = 9'b000000000;
    cfblk22_t_0_0 = 9'b000000000;
    if (Mysubsystem_28_out1 == 8'b00000000) begin
      cfblk22_out1 = 8'b11111111;
    end
    else begin
      cfblk22_t_0_0 = {1'b0, cfblk51_out1};
      cfblk22_div_temp = cfblk22_t_0_0 / Mysubsystem_28_out1;
