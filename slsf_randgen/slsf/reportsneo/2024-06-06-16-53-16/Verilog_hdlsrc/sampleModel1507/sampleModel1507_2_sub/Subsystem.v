// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1507\sampleModel1507_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1507_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire [31:0] Mysubsystem_40_out1;  // ufix32_En15
  ...
  reg [15:0] cfblk153_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk153_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk153_out1;  // ufix16_En7
  wire [7:0] cfblk27_out1;  // uint8
  wire [7:0] cfblk125_out1;  // uint8
  reg [7:0] cfblk22_out1;  // uint8
  wire [31:0] cfblk92_add_cast;  // ufix32_En7
  wire [31:0] cfblk92_add_cast_1;  // ufix32_En7
  wire [31:0] cfblk92_add_temp;  // ufix32_En7
  ...
  Mysubsystem_40 u_Mysubsystem_40 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .Out1(Mysubsystem_40_out1)  // ufix32_En15
                                   );
  ...
  assign cfblk123_add_cast = {1'b0, Mysubsystem_40_out1[31:1]};
  ...
  Mysubsystem_24 u_Mysubsystem_24 (.In1(cfblk48_out1),  // uint8
                                   .In2(Mysubsystem_32_out1),  // uint8
  ...
  assign cfblk165_reg_next[0] = Mysubsystem_24_out1;
  ...
  DotProduct_block8 u_cfblk57_inst (.in1(Mysubsystem_11_out1),  // uint8
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.In1(cfblk21_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk153_process
      if (reset == 1'b1) begin
        cfblk153_reg[0] <= 16'b0000000000000000;
        cfblk153_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk153_reg_next[0] = Mysubsystem_34_out1;
  ...
  always @(Mysubsystem_11_out1, cfblk51_out1) begin
    cfblk22_div_temp = 9'b000000000;
    cfblk22_t_0_0 = 9'b000000000;
    if (Mysubsystem_11_out1 == 8'b00000000) begin
      cfblk22_out1 = 8'b11111111;
    end
    else begin
      cfblk22_t_0_0 = {1'b0, cfblk51_out1};
      cfblk22_div_temp = cfblk22_t_0_0 / Mysubsystem_11_out1;
  ...
  assign cfblk92_add_cast = {17'b0, {cfblk22_out1, 7'b0000000}};
  assign cfblk92_add_cast_1 = {16'b0, cfblk153_out1};
  assign cfblk92_add_temp = cfblk92_add_cast + cfblk92_add_cast_1;
  assign cfblk92_out1 = cfblk92_add_temp[14:7];
