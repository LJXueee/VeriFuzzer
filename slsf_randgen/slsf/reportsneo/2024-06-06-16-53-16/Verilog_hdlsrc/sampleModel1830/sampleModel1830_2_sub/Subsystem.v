// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1830\sampleModel1830_2_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1830_2_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  reg [15:0] cfblk195_reg [0:1];  // ufix16 [2]
  wire [15:0] cfblk195_reg_next [0:1];  // ufix16_En7 [2]
  wire [15:0] cfblk195_out1;  // ufix16_En7
  ...
  assign dtc_out_1 = cfblk154_out1;
  ...
  assign dtc_out_2 = cfblk106_out1;



  assign cfblk77_out1 = dtc_out_2;
  ...
  assign cfblk191_reg_next[0] = Mysubsystem_30_out1;
  ...
  Mysubsystem_9 u_Mysubsystem_9 (.In1(cfblk137_out1),  // uint8
                                 .In2(cfblk127_out1),  // uint8
  ...
  assign cfblk172_reg_next[0] = Mysubsystem_9_out1;
  ...
  assign cfblk101_out1 = dtc_out_6;



  assign cfblk142_out1 = cfblk101_out1 + cfblk162_out1;
  ...
  Mysubsystem_20 u_Mysubsystem_20 (.In1(cfblk4_out1),  // uint8
                                   .In2(cfblk16_out1),  // uint8
                                   .In3(cfblk175_out1),  // uint8
                                   .Out1(Mysubsystem_20_out1)  // uint8
                                   );

  Mysubsystem_30 u_Mysubsystem_30 (.In1(Mysubsystem_41_out1),  // uint8
                                   .In2(Mysubsystem_20_out1),  // uint8
                                   .In3(cfblk153_out1),  // uint8
  ...
  always @(posedge clk or posedge reset)
    begin : cfblk195_process
      if (reset == 1'b1) begin
        cfblk195_reg[0] <= 16'b0000000000000000;
        cfblk195_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign cfblk195_reg_next[0] = Mysubsystem_30_out2;
  ...
  assign cfblk117_sub_cast = {17'b0, {cfblk90_out1, 7'b0000000}};
  assign cfblk117_sub_cast_1 = {16'b0, cfblk195_out1};
  ...
  Mysubsystem_41 u_Mysubsystem_41 (.In1(cfblk93_out1),  // uint8
  ...
  assign cfblk196_reg_next[0] = Mysubsystem_41_out2;
  ...
  assign cfblk148_out1 = cfblk162_out1 + cfblk163_out1;
