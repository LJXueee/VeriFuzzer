// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel2034\sampleModel2034_3_sub\Subsystem_tb.v
// Created: 2024-08-16 19:56:16
// 
...
module Subsystem_tb;
  ...
  assign Hdl_out_lastAddr = cfblk145_addr >= 4'b1010;
  ...
  assign cfblk145_active = cfblk145_addr != 4'b1010;
  ...
  assign cfblk145_enb = ce_out & cfblk145_active;
  ...
  always @(posedge clk or posedge reset)
    begin : c_2_process
      if (reset == 1'b1) begin
        cfblk145_addr <= 4'b0000;
      end
      else begin
        if (cfblk145_enb) begin
          if (cfblk145_addr >= 4'b1010) begin
            cfblk145_addr <= 4'b0000;
          end
          else begin
            cfblk145_addr <= cfblk145_addr + 4'b0001;
          end
        end
      end
    end
  ...
  assign cfblk145_lastAddr = cfblk145_addr >= 4'b1010;
  ...
  assign cfblk145_expected_table_data[2] = 8'b11111110;
  assign cfblk145_expected_table_data[3] = 8'b00000000;
  assign cfblk145_expected_table_data[4] = 8'b01111000;
  assign cfblk145_expected_table_data[5] = 8'b01010101;
  assign cfblk145_expected_table_data[6] = 8'b00100110;
  assign cfblk145_expected_table_data[7] = 8'b00011110;
  assign cfblk145_expected_table_data[8] = 8'b00011100;
  assign cfblk145_expected_table_data[9] = 8'b00011000;
  assign cfblk145_expected_table_data[10] = 8'b00010000;
  assign cfblk145_expected_1 = cfblk145_expected_table_data[cfblk145_addr];
  ...
  assign Hdl_out_expected_table_data[3] = 8'b01010100;
  assign Hdl_out_expected_table_data[4] = 8'b01000010;
  assign Hdl_out_expected_table_data[5] = 8'b00011110;
  assign Hdl_out_expected_table_data[6] = 8'b01000101;
  assign Hdl_out_expected_table_data[7] = 8'b01001000;
  assign Hdl_out_expected_table_data[8] = 8'b11111110;
  assign Hdl_out_expected_table_data[9] = 8'b00001100;
  assign Hdl_out_expected_table_data[10] = 8'b00000000;
  assign Hdl_out_expected_1 = Hdl_out_expected_table_data[cfblk145_addr];
  ...
  assign testFailure = cfblk145_testFailure | Hdl_out_testFailure;
