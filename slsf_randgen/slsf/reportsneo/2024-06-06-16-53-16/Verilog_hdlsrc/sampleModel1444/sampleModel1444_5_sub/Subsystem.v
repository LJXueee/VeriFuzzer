// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1444\sampleModel1444_5_sub\Subsystem.v
// Created: 2024-08-12 06:06:59
// 
...
// 
// Module: Subsystem
// Source Path: sampleModel1444_5_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire cfblk141_out1;
  wire signed [31:0] cfblk67_sub_temp;  // sfix32
  wire signed [31:0] cfblk67_1;  // sfix32
  wire signed [31:0] cfblk67_2;  // sfix32
  ...
  assign cfblk76_out1 = cfblk66_out1 + cfblk101_out1;



  always @(cfblk114_out1, cfblk76_out1) begin
    ...
    if (cfblk76_out1 == 8'b00000000) begin
      ...
      cfblk97_t_0_0 = {1'b0, cfblk114_out1};
  ...
  assign cfblk36_out1 = cfblk97_out1 - cfblk100_out1;



  assign cfblk17_out1 = cfblk36_out1 - cfblk31_out1;
  ...
  assign cfblk133_reg_next[0] = cfblk28_out1;
  ...
  DotProduct u_cfblk100_inst (.in1(cfblk139_out1),  // uint8
  ...
  DotProduct_block u_cfblk38_inst (.in1(cfblk46_out1),  // uint8
  ...
  Mysubsystem_13 u_Mysubsystem_13 (.In1(cfblk4_out1),  // uint8
  ...
  assign cfblk134_reg_next[0] = Mysubsystem_13_out1;
  ...
  assign cfblk141_reg_next[0] = Mysubsystem_22_out1;
  assign cfblk141_reg_next[1] = cfblk141_reg[0];



  assign cfblk67_1 = {31'b0, cfblk141_out1};
  assign cfblk67_2 = {24'b0, cfblk6_out1};
  assign cfblk67_sub_temp = cfblk67_1 - cfblk67_2;
  assign cfblk67_out1 = cfblk67_sub_temp[7:0];
  ...
  assign cfblk29_out1 = (cfblk52_out1 > 8'b00000000 ? 8'b00000001 :
              8'b00000000);



  DotProduct_block1 u_cfblk54_inst (.in1(cfblk29_out1),  // uint8
  ...
  assign cfblk147_reg_next[0] = cfblk54_out1;
  assign cfblk147_reg_next[1] = cfblk147_reg[0];



  assign cfblk18_out1 = cfblk147_out1 + cfblk3_out1;
  ...
  assign cfblk114_out1 = dtc_out_2;
