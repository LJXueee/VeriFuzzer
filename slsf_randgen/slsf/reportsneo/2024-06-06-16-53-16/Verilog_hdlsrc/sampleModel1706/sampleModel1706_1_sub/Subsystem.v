// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1706\sampleModel1706_1_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1706_1_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  wire signed [31:0] cfblk65_sub_temp;  // sfix32
  wire signed [31:0] cfblk65_1;  // sfix32
  wire signed [31:0] cfblk65_2;  // sfix32
  ...
  wire [15:0] Mysubsystem_34_out1;  // ufix16_En7
  ...
  assign cfblk113_out1 = dtc_out_2;
  ...
  Mysubsystem_26 u_Mysubsystem_26 (.In1(cfblk124_out1),  // uint8
  ...
  assign cfblk146_reg_next[0] = Mysubsystem_26_out1;
  assign cfblk146_reg_next[1] = cfblk146_reg[0];



  assign cfblk65_1 = {24'b0, cfblk119_out1};
  assign cfblk65_2 = {16'b0, cfblk146_out1};
  assign cfblk65_sub_temp = cfblk65_1 - cfblk65_2;
  assign cfblk65_out1 = cfblk65_sub_temp[7:0];



  Mysubsystem_28 u_Mysubsystem_28 (.In1(cfblk106_out1),  // uint8
  ...
  assign cfblk149_reg_next[0] = Mysubsystem_28_out1;
  ...
  DotProduct_block u_cfblk103_inst (.in1(cfblk108_out1),  // uint8
  ...
  DotProduct_block2 u_cfblk121_inst (.in1(cfblk131_out1),  // uint8
  ...
  Mysubsystem_34 u_Mysubsystem_34 (.In1(cfblk20_out1),  // uint8
                                   .In2(cfblk78_out1),  // uint8
                                   .Out1(Mysubsystem_34_out1)  // ufix16_En7
                                   );

  Mysubsystem_40 u_Mysubsystem_40 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_34_out1),  // ufix16_En7
  ...
  DotProduct_block1 u_cfblk107_inst (.in1(cfblk140_out1),  // uint8
  ...
  Mysubsystem_25 u_Mysubsystem_25 (.In1(cfblk37_out1),  // uint8
                                   .Out1(Mysubsystem_25_out1)  // uint8
                                   );

  Mysubsystem_1 u_Mysubsystem_1 (.In1(Mysubsystem_25_out1),  // uint8
  ...
  Mysubsystem_27 u_Mysubsystem_27 (.clk(clk),
                                   .reset(reset),
                                   .enb(clk_enable),
                                   .In1(Mysubsystem_1_out1),  // uint8
                                   .Out1(Mysubsystem_27_out1)  // uint8
                                   );

  assign cfblk26_out1 = Mysubsystem_27_out1 + cfblk84_out1;
  ...
  assign dtc_out_11 = cfblk11_out1;



  assign cfblk71_out1 = dtc_out_11;
