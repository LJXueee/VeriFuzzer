// -------------------------------------------------------------
// 
// File Name: D:\ljx\code\GUIDANCE-ljx3\slsf_randgen\slsf\reportsneo\2024-06-06-16-53-16\Verilog_hdlsrc\sampleModel1512\sampleModel1512_sub\Subsystem.v
...
// 
// Module: Subsystem
// Source Path: sampleModel1512_sub/Subsystem
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Subsystem
  ...
  assign cfblk178_reg_next[0] = cfblk143_out1;
  ...
  DotProduct_block u_cfblk112_inst (.in1(cfblk143_out1),  // uint8
  ...
  always @(cfblk108_out1, cfblk38_out1) begin
    ...
    if (cfblk108_out1 == 8'b00000000) begin
      ...
      cfblk134_t_0_0 = {1'b0, cfblk38_out1};
  ...
  always @(cfblk34_out1, cfblk36_out1) begin
    ...
    if (cfblk34_out1 == 8'b00000000) begin
      ...
      cfblk85_div_temp = cfblk85_t_0_0 / cfblk34_out1;
  ...
  assign cfblk123_out1 = dtc_out_7;
  ...
  assign cfblk119_1 = {16'b0, cfblk118_out1};
  ...
  assign cfblk67_out1 = cfblk131_out1 + cfblk155_out1;



  assign cfblk76_out1 = cfblk67_out1 + cfblk43_out1;
  ...
  assign cfblk30_out1 = cfblk15_out1 + cfblk111_out1;
  ...
  assign cfblk162_reg_next[0] = cfblk30_out1;
