...
def vivdao_syn(dir):
    cd_dir = 'cd ' + dir
    vivado_cmd_rtl = cd_dir + '\n' + '/doc2/Xilinx/Vivado/2023.2/bin/vivado -mode batch -source ' + dir + '/' + 'vivado_rtl2syn.tcl'
    print(vivado_cmd_rtl)
    ret = os.popen(vivado_cmd_rtl).read()
    print(ret)
def vivdao_simulation(dir):
    cd_dir = 'cd ' + dir
    vivado_cmd_sim = cd_dir + '\n' + '/doc2/Xilinx/Vivado/2023.2/bin/vivado -mode batch -source ' + dir + '/' + 'vivado_sim.tcl'
